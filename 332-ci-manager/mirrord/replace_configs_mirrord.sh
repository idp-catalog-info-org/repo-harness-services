...
CI_MANAGER_CONFIG=$HOME/.bazel_runner/.mirrord/harness-services/ci-manager
CONFIG_FILE=$CI_MANAGER_CONFIG/ci-manager-config.yml
REDISSON_CACHE_FILE=$CI_MANAGER_CONFIG/redisson-jcache.yaml
ENTERPRISE_REDISSON_CACHE_FILE=$CI_MANAGER_CONFIG/enterprise-redisson-jcache.yaml
