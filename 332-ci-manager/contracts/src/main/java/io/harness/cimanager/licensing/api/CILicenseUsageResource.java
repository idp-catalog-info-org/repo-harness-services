...
@Tag(name = "License Usage", description = "Contains APIs related to CI license usage.")
...
public interface CILicenseUsageResource {
  ...
  @GET
  @Path("/getCILicense")
  @ApiOperation(value = "Get CI License", nickname = "getCILicense")
  @Operation(operationId = "getCILicense", summary = "Get CI License",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "default", description = "Get CI License")
      })
  ResponseDTO<CILicense>
  getCILicense(@Parameter(description = ACCOUNT_PARAM_MESSAGE) @QueryParam(
      ACCOUNT_KEY) @AccountIdentifier String accountIdentifier);
