...
public class ServiceRequestDTO {
  @Schema(description = "Identifier of the Service Request.") @NotEmpty @EntityIdentifier String identifier;
  ...
  @Schema(description = "YAML for the Service Request") @NotEmpty String yaml;
  @Schema(description = "YAML version for the Service Request") @NotEmpty String harnessVersion;
}
