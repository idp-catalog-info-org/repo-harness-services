...
@Getter
@Builder
@FieldNameConstants(innerTypeName = "GitFindRequestKeys")
@Schema(
    name = "GitFindRequest", description = "Details to find Git Entity including: Git Sync Config Id and Branch Name")
@OwnedBy(DX)
@NoArgsConstructor
@AllArgsConstructor
@TargetModule(HarnessModule._878_NG_COMMON_UTILITIES)
public class GitFindRequestDTO {
