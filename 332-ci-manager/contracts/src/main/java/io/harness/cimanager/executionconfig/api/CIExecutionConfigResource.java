...
public interface CIExecutionConfigResource {
  ...
  ResponseDTO<CIExecutionImages>
  getDefaultConfig(@NotNull @QueryParam(NGCommonEntityConstants.ACCOUNT_KEY) String accountIdentifier,
      @NotNull @QueryParam(NGCommonEntityConstants.INFRA) Type infra);
}
