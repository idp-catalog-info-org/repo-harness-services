...
public class IntegrationStageConfigImpl implements IntegrationStageConfig {
  ...
  @ApiModelProperty(dataType = "io.harness.beans.yaml.extended.infrastrucutre.Platform")
  ...
  @JsonProperty("buildIntelligence")
  @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type", visible = true, defaultImpl = BuildIntelligence.class)
  private BuildIntelligence buildIntelligence;
