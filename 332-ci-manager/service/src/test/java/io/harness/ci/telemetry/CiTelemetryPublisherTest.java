...
public class CiTelemetryPublisherTest extends CategoryTest {
  ...
  public void testRecordTelemetry() throws Exception {
    long activeCommitters = 20L;
    long creditUsage = 500L;
    doReturn(activeCommitters).when(ciOverviewDashboardService).getActiveCommittersCount(any());
  ...
  @Owner(developers = JAMIE)
  @Category(UnitTests.class)
  public void testRecordTelemetryNoActiveCI() throws Exception {
  ...
  @Owner(developers = JAMIE)
  @Category(UnitTests.class)
  public void testRecordTelemetryNoActiveCIButHaveExecHistory() throws Exception {
    long activeCommitters = 20L;
    long creditUsage = 500L;
    doReturn(activeCommitters).when(ciOverviewDashboardService).getActiveCommittersCount(any());
    doReturn(creditUsage).when(ciOverviewDashboardService).getHostedCreditUsage(any(), anyLong(), anyLong());
  ...
  @Owner(developers = JAMIE)
  @Category(UnitTests.class)
  public void testRecordSkipTelemetry() throws Exception {
    long activeCommitters = 20L;
    long creditUsage = 500L;
    doReturn(activeCommitters).when(ciOverviewDashboardService).getActiveCommittersCount(any());
    doReturn(creditUsage).when(ciOverviewDashboardService).getHostedCreditUsage(any(), anyLong(), anyLong());
