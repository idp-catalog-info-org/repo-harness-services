  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.s3_upload_jexl_success.spec.execution.steps.upload.type",
            ...
            "pipeline.stages.s3_upload_jexl_success.spec.execution.steps.upload.nodeExecutionId",
            "pipeline.stages.s3_upload_jexl_success.spec.execution.steps.upload.log.url");
