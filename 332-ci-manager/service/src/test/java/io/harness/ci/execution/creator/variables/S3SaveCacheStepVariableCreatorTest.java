  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.s3_save_cache.spec.execution.steps.saveCacheTar.type",
            ...
            "pipeline.stages.s3_save_cache.spec.execution.steps.saveCacheTar.nodeExecutionId",
            "pipeline.stages.s3_save_cache.spec.execution.steps.saveCacheTar.log.url");
