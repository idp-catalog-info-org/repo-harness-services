  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.tags",
            ...
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.baseImageConnectorRefs",
            ...
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.envVariables",
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.registryRef",
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.envDockerSecrets",
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.spec.fileDockerSecrets");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.identifier",
            ...
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.nodeExecutionId",
            "pipeline.stages.docker_buildPush_success.spec.execution.steps.dockerBuildPush.log.url");
  }
}
