...
public class K8InitializeServiceUtilsTest extends CIExecutionTestBase {
  ...
  public void createServiceContainerDefinitions() {
    ...
    List<ContainerDefinitionInfo> serviceContainers = k8InitializeServiceUtils.createServiceContainerDefinitions(
        stageNode, portFinder, OSType.Linux, Ambiance.newBuilder().build());
