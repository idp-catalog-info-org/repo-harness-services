  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.spec.region",
            ...
            "pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.spec.envVariables",
            "pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.spec.envDockerSecrets",
            "pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.spec.fileDockerSecrets");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.type",
            ...
            "pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.nodeExecutionId",
            "pipeline.stages.ecr_build_push.spec.execution.steps.pushECR.log.url");
