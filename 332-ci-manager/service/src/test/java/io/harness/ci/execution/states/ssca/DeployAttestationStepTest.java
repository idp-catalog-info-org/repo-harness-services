...
public class DeployAttestationStepTest extends CIExecutionTestBase {
  @InjectMocks DeployAttestationStep deployAttestationStep;
  ...
  public void testHandleK8sAsyncResponse() {
    ...
    StepResponse stepResponse =
        deployAttestationStep.handleAsyncResponseInternal(ambiance, stepElementParameters, responseDataMap);
