  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.setupdb.spec.execution.steps.f.name",
            ...
            "pipeline.stages.setupdb.spec.execution.steps.f.spec.registryRef");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.setupdb.spec.execution.steps.f.identifier",
            ...
            "pipeline.stages.setupdb.spec.execution.steps.f.nodeExecutionId",
            "pipeline.stages.setupdb.spec.execution.steps.f.log.url");
    ...
    assertThat(fqnExtraPropertiesList1)
        .containsOnly("pipeline.stages.setupdb.spec.execution.steps.f.spec.resources",
            "pipeline.stages.setupdb.spec.execution.steps.f.spec.outputAlias",
            "pipeline.stages.setupdb.spec.execution.steps.f.spec.identities");
