...
public class SscaJunitAttestationStepTest extends CIExecutionTestBase {
  @InjectMocks SscaJunitAttestationStep sscaJunitAttestationStep;
  ...
  public void testHandleK8sAsyncResponse() {
    ...
    StepResponse stepResponse =
        sscaJunitAttestationStep.handleAsyncResponseInternal(ambiance, stepElementParameters, responseDataMap);
