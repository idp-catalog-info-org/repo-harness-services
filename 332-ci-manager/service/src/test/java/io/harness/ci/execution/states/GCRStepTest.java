...
public class GCRStepTest extends CIExecutionTestBase {
  ...
  public void setUp() {
    ...
    on(gcrStep).set("sscaLicenseHelper", sscaLicenseHelper);
    on(gcrStep).set("artifactDetailsService", artifactDetailsService);
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(
            PublishedImageArtifact.builder()
                ...
                .tag("1.0")
                .url("https://console.cloud.google.com/gcr/images/harness/US/harness/"
                    + "ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70/details")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                .build(),
            PublishedImageArtifact.builder()
                .imageName("harness/ci-automation")
                .tag("latest")
                .url("https://console.cloud.google.com/gcr/images/harness/US/harness/"
                    + "ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71/details")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71")
                .build());
  }
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(
            PublishedImageArtifact.builder()
                .imageName("harness/ci-automation")
                .tag("1.0")
                .url("https://console.cloud.google.com/gcr/images/harness/GLOBAL/harness/"
                    + "ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70/details")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                .build(),
            PublishedImageArtifact.builder()
  ...
  public void testPublishArtifactDetails() {
    ...
    gcrStep.handleArtifact(artifactMetadata, stepElementParameters, ambiance);
