  ...
  public void shouldValidateSupportedTypes() {
    assertThat(ciStageVariableCreator.getSupportedTypes())
        .isEqualTo(Collections.singletonMap(
            YAMLFieldNameConstants.STAGE, Set.of(StepSpecTypeConstants.CI_STAGE, StepSpecTypeConstants.UNIFIED_STAGE)));
  }
  ...
  public void shouldValidateVariableForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.spec.infrastructure.spec.runAsUser",
            ...
            "pipeline.stages.gcpBuildPush.timeout", "pipeline.stages.gcpBuildPush.spec.execution.version",
            "pipeline.stages.gcpBuildPush.spec.infrastructure.spec.podSpecOverlay");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.type", "pipeline.stages.gcpBuildPush.pipelineVariables",
            ...
            "pipeline.stages.gcpBuildPush.status", "pipeline.stages.gcpBuildPush.nodeExecutionId",
            "pipeline.stages.gcpBuildPush.sendGitStatus", "pipeline.stages.gcpBuildPush.runMode");
  }
}
