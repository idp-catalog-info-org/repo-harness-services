...
public class SecretVariableUtilsTest extends CIExecutionTestBase {
  ...
  public void testGetScopeObject() {
    Ambiance ambiance = Ambiance.newBuilder()
                            ...
                            .build();
    SecretUtils.SecretScopeObject secretScopeObject = secretUtils.getScopeObject(ambiance, "account.secret1");
    assertThat(secretScopeObject.accountId()).isEqualTo("accountId");
    assertThat(secretScopeObject.projectId()).isEqualTo(null);
    assertThat(secretScopeObject.orgId()).isEqualTo(null);
    assertThat(secretScopeObject.identifier()).isEqualTo("secret1");

    secretScopeObject = secretUtils.getScopeObject(ambiance, "org.secret2");
    assertThat(secretScopeObject.accountId()).isEqualTo("accountId");
    assertThat(secretScopeObject.orgId()).isEqualTo("orgIdentifier");
    assertThat(secretScopeObject.projectId()).isEqualTo(null);
    assertThat(secretScopeObject.identifier()).isEqualTo("secret2");

    secretScopeObject = secretUtils.getScopeObject(ambiance, "secret3");
    assertThat(secretScopeObject.accountId()).isEqualTo("accountId");
    assertThat(secretScopeObject.orgId()).isEqualTo("orgIdentifier");
    assertThat(secretScopeObject.projectId()).isEqualTo("projectIdentifier");
    assertThat(secretScopeObject.identifier()).isEqualTo("secret3");
  }
}
