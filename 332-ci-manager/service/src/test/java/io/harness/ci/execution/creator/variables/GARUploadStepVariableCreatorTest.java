  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.spec.buildArgs",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.spec.baseImageConnectorRefs",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.spec.envVariables",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.spec.envDockerSecrets",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.spec.fileDockerSecrets");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.type",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.nodeExecutionId",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGAR.log.url");
