...
public class GARStepTest extends CIExecutionTestBase {
  ...
  public void setUp() {
    ...
    on(garStep).set("sscaLicenseHelper", sscaLicenseHelper);
    on(garStep).set("artifactDetailsService", artifactDetailsService);
  ...
  public void shouldHandleArtifact() {
    ...
    ArtifactMetadata artifactMetadata =
        ArtifactMetadata.builder()
            ...
            .spec(DockerArtifactMetadata.builder()
                      ...
                      .build())
            .build();
    StepArtifacts stepArtifacts = garStep.handleArtifact(artifactMetadata, stepElementParameters, ambiance);
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(PublishedImageArtifact.builder()
                      ...
                      .tag("1.0")
                      .url("https://console.cloud.google.com/artifacts/docker/harness/us/harness/"
                          + "ci-automation/sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70?"
                          + "project=harness")
                      .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                      .build(),
            PublishedImageArtifact.builder()
                ...
                .tag("latest")
                .url("https://console.cloud.google.com/artifacts/docker/harness/us/harness/"
                    + "ci-automation/sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71?project="
                    + "harness")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71")
                .build());
  }
  ...
  public void shouldHandleArtifactWithGlobalURL() {
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(PublishedImageArtifact.builder()
                      .imageName("harness/ci-automation")
                      .tag("1.0")
                      .url("https://console.cloud.google.com/artifacts/docker/harness/GLOBAL/harness/"
                          + "ci-automation/sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70?"
                          + "project=harness")
                      .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                      .build(),
  ...
  public void shouldHandleArtifactWithProvenance() throws IOException {
    ...
    when(ciExecutionConfigService.getPluginVersionForK8(CIStepInfoType.GAR, "accountId"))
    ...
    when(ProvenanceStepGenerator.getAllowedTypesForProvenance())
        .thenReturn(List.of(CIStepInfoType.DOCKER, CIStepInfoType.GAR));
    StepArtifacts stepArtifacts = garStep.handleArtifact(artifactMetadata, stepElementParameters, ambiance);
    assertThat(stepArtifacts).isNotNull();
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(PublishedImageArtifact.builder()
  ...
  public void testPublishArtifactDetails() {
    ...
    garStep.handleArtifact(artifactMetadata, stepElementParameters, ambiance);
