  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.spec.buildArgs",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.spec.baseImageConnectorRefs",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.spec.envVariables",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.spec.envDockerSecrets",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.spec.fileDockerSecrets");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.type",
            ...
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.nodeExecutionId",
            "pipeline.stages.gcpBuildPush.spec.execution.steps.pushGCR.log.url");
