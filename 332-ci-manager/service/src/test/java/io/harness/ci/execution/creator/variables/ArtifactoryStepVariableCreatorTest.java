  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.artifactory_saas_upload_success.spec.execution.steps.uploadFile.spec.runAsUser",
            ...
            "pipeline.stages.artifactory_saas_upload_success.spec.execution.steps.uploadFile.spec.uploadAsFlat");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.artifactory_saas_upload_success.spec.execution.steps.uploadFile.type",
            ...
            "pipeline.stages.artifactory_saas_upload_success.spec.execution.steps.uploadFile.nodeExecutionId",
            "pipeline.stages.artifactory_saas_upload_success.spec.execution.steps.uploadFile.log.url");
