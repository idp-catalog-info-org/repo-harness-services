...
public class GithubApiTokenEvaluatorTest extends CategoryTest {
  ...
  public void testFunctorEvaluation() {
    ...
    githubApiTokenEvaluator.resolve(testObject, ngAccess, 1, false);
  ...
  public void testConnectorFetching() {
    ...
    Map<String, ConnectorDetails> connectorDetailsMap = githubApiTokenEvaluator.resolve(testObject, ngAccess, 1, false);
