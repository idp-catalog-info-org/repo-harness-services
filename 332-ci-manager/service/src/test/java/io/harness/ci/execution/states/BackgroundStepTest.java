...
public class BackgroundStepTest extends CIExecutionTestBase {
  ...
  private static final String callbackId2 = UUID.randomUUID().toString();
  ...
  @Mock RunnerV0YamlHelper runnerV0YamlHelper;
  ...
  @Before
  public void setUp() {
    on(backgroundStep).set("runnerCommonExecuteUtils", runnerCommonExecuteUtils);
    on(backgroundStep).set("commonAbstractStepUtils", commonAbstractStepUtils);
  ...
  public void shouldExecuteAsync() {
    ...
    String key = "accountId:accountId/orgId:orgId/projectId:projectId/pipelineId:pipelineId/runSequence:1/"
        + "level0:backgroundStepId_1";
  ...
  public void shouldExecuteAsyncVm() {
    ...
    when(executionSweepingOutputResolver.resolveOptional(
        ...
        .thenReturn(OptionalSweepingOutput.builder()
                        ...
                        .output(StageDetails.builder()
                                    .stageRuntimeID("test")
                                    .infrastructure(DockerInfraYaml.builder().build())
                                    .build())
                        .build());
    ...
    when(vmStepSerializer.serialize(any(), any(), any(), any(), any(), any(), any(), any(), any(), anyBoolean(), any()))
        .thenReturn(VmBackgroundStep.builder().envVariables(new HashMap<>()).build());
