  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.spec.bucket",
            ...
            "pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.spec.preserveMetadata",
            "pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.spec.sourcePaths",
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.type",
            ...
            "pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.nodeExecutionId",
            "pipeline.stages.gcs_restore_cache.spec.execution.steps.restoreCacheTar.log.url");
