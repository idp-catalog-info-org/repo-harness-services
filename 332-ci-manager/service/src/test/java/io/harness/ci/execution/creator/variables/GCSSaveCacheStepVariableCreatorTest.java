  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.gcs_save_cache.spec.execution.steps.saveCacheTar.type",
            ...
            "pipeline.stages.gcs_save_cache.spec.execution.steps.saveCacheTar.nodeExecutionId",
            "pipeline.stages.gcs_save_cache.spec.execution.steps.saveCacheTar.log.url");
