  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.download_plugin_success.spec.execution.steps.download.spec.reports",
            ...
            "pipeline.stages.download_plugin_success.spec.execution.steps.download.spec.registryRef");
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.download_plugin_success.spec.execution.steps.download.type",
            ...
            "pipeline.stages.download_plugin_success.spec.execution.steps.download.nodeExecutionId",
            "pipeline.stages.download_plugin_success.spec.execution.steps.download.log.url");
