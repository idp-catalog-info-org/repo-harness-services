...
public class CodebasePlanCreatorTest extends CategoryTest {
  ...
  public void shouldCreatePlanForCodeBase() {
    ...
    List<PlanNode> planNodeList = CodebasePlanCreator.buildCodebasePlanNodes(
        codeBaseFieldUuid, childNodeId, kryoSerializer, codeBase, executionSource, null);
  ...
  public void createPlanForCodeBaseTask() {
    PlanNode sync =
        CodebasePlanCreator.createPlanForCodeBaseTask(codeBase, executionSource, "SYNC", codeBaseFieldUuid, null);
    ...
    PlanNode task =
        CodebasePlanCreator.createPlanForCodeBaseTask(codeBase, executionSource, "TASK", codeBaseFieldUuid, null);
