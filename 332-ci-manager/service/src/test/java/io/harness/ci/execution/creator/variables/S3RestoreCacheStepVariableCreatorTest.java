  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnPropertiesList)
        .containsOnly("pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.spec.runAsUser",
            ...
            "pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.spec.preserveMetadata",
            ...
            "pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.spec.sourcePaths",
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.type",
            ...
            "pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.nodeExecutionId",
            "pipeline.stages.s3_restore_cache.spec.execution.steps.restoreCacheTar.log.url");
