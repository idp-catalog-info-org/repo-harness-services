...
public class MatrixConfigurationServiceTest {
  ...
  @InjectMocks MatrixConfigServiceHelper matrixConfigServiceHelper = new MatrixConfigServiceHelper();
  MatrixConfigService matrixConfigService = new MatrixConfigService(matrixConfigServiceHelper);
  ...
  public void testExpandJsonNodeFromClassFirst() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-1.yaml", 0, 2, expectedStepIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-1.yaml", 0, 2, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassSecond() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-2.yaml", 4, 18, expectedStepIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-2.yaml", 4, 18, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassThird() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-3.yaml", 0, 0, 6, expectedStepIdentifiers, false);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-3.yaml", 0, 0, 6, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassFourth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-2.yaml", 2, 3, expectedStepIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-2.yaml", 2, 3, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassSixth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-2.yaml", 0, 0, 12, expectedStepIdentifiers, false);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-2.yaml", 0, 0, 12, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassSeventh() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-3.yaml", 0, 1, 4, expectedStepIdentifiers, false);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-3.yaml", 0, 1, 4, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassEighth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-3.yaml", 1, 4, expectedStepIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-3.yaml", 1, 4, expectedStepIdentifiers, false);
  }
  ...
  @Category(UnitTests.class)
  public void testExpandJsonNodeNinth() throws IOException {
    List<String> expectedStepIdentifiers = Arrays.asList("InnerRun_inting");
    ...
    Ambiance ambiance = getAmbianceForTesting();
    Optional<Integer> maxExpansion = Optional.of(10000);
    StrategyInfo strategyInfo = matrixConfigService.expandJsonNode(
        strategyConfig, parallelStepYamlField.getNode().getCurrJsonNode(), maxExpansion, ambiance);
    assertThat(strategyInfo).isNotNull();
    assertThat(strategyInfo.getExpandedJsonNodes().size()).isEqualTo(1);
    List<String> stepIdentifiers = strategyInfo.getExpandedJsonNodes()
                                       .stream()
  ...
  @Category(UnitTests.class)
  public void testExpandJsonNodeNinthRemovedAxes() throws IOException {
    when(featureFlagService.isEnabled(eq(FeatureName.CI_REMOVE_MATRIX_AXES), any())).thenReturn(true);
    List<String> expectedStepIdentifiers = Arrays.asList("InnerRun_inting");
    ...
    List<String> stepIdentifiers = strategyInfo.getExpandedJsonNodes()
                                       ...
                                       .collect(Collectors.toList());
    assertThat(expectedStepIdentifiers.equals(stepIdentifiers)).isEqualTo(true);
    assertThat(testMatrixAxesRemoved(strategyInfo)).isTrue();
  }
  ...
  public void testExpandJsonNodeFromClassTenth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-4.yaml", 0, 24, expectedIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-4.yaml", 0, 24, expectedIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassEleventh() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-4.yaml", 2, 1, 9, expectedStepIdentifiers, false);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-4.yaml", 2, 1, 9, expectedStepIdentifiers, false);
  }
  ...
  public void testExpandJsonNodeFromClassTwelfth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-4.yaml", 1, 9, expectedStepIdentifiers, true);
    testExpandJsonNodeCommon("matrix-loop-pipeline-4.yaml", 1, 9, expectedStepIdentifiers, true);
  }
  ...
  public void testExpandJsonNodeFromClassThirteenth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-4.yaml", 3, 0, 36, expectedStepIdentifiers, true);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-4.yaml", 3, 0, 36, expectedStepIdentifiers, true);
  }
  ...
  public void testExpandJsonNodeFromClassFourteenth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommonForParallelStep(
        "matrix-loop-pipeline-4.yaml", 3, 1, 12, expectedStepIdentifiers, true);
    testExpandJsonNodeCommonForParallelStep("matrix-loop-pipeline-4.yaml", 3, 1, 12, expectedStepIdentifiers, true);
  }
  ...
  public void testExpandJsonNodeFromClassFifteenth() throws IOException {
    ...
    testExpandJsonNodeFromClassCommon("matrix-loop-pipeline-4.yaml", 4, 21, expectedStepIdentifiers, false);
    testExpandJsonNodeCommon("matrix-loop-pipeline-4.yaml", 4, 21, expectedStepIdentifiers, false);
  }

  private void testExpandJsonNodeFromClassCommon(String yamlFile, int stepYamlNodeIndex, int sizeForAssertionCheck,
      List<String> expectedStepIdentifiers, boolean axesRemoved) throws IOException {
    ClassLoader classLoader = this.getClass().getClassLoader();
  ...
  private void testExpandJsonNodeCommon(String yamlFile, int stepYamlNodeIndex, int sizeForAssertionCheck,
      List<String> expectedStepIdentifiers, boolean axesRemoved) throws IOException {
    ClassLoader classLoader = this.getClass().getClassLoader();
    final URL testFile = classLoader.getResource(yamlFile);
    assertThat(testFile).isNotNull();
    ...
    Optional<Integer> maxExpansion = Optional.of(10000);
    StrategyInfo strategyInfo = matrixConfigService.expandJsonNode(
        strategyConfig, stepYamlField.getNode().getCurrJsonNode(), maxExpansion, ambiance);
    assertThat(strategyInfo).isNotNull();
    assertThat(strategyInfo.getExpandedJsonNodes().size()).isEqualTo(sizeForAssertionCheck);
    List<String> stepIdentifiers = strategyInfo.getExpandedJsonNodes()
                                       .stream()
  ...
  private void testExpandJsonNodeFromClassCommonForParallelStep(String yamlFile, int stepYamlNodeIndex,
      ...
      boolean axesRemoved) throws IOException {
    ClassLoader classLoader = this.getClass().getClassLoader();
    final URL testFile = classLoader.getResource(yamlFile);
    assertThat(testFile).isNotNull();
    String pipelineYaml = Resources.toString(testFile, Charsets.UTF_8);
  ...
  // This method checks if the matrix axes have been removed from the expanded JSON nodes.
  // Only maxConcurrency and nodeName can be present
  private boolean testMatrixAxesRemoved(StrategyInfo strategyInfo) {
    List<JsonNode> jsonNodes = strategyInfo.getExpandedJsonNodes();
    for (JsonNode jsonNode : jsonNodes) {
      if (jsonNode.has("strategy") && jsonNode.get("strategy").has("matrix")) {
        ObjectNode matrix = (ObjectNode) jsonNode.get("strategy").get("matrix");

        Iterator<String> fieldNames = matrix.fieldNames();
        while (fieldNames.hasNext()) {
          String field = fieldNames.next();
          if (!field.equals("maxConcurrency") && !field.equals("nodeName") && !field.equals("__uuid")) {
            return false;
          }
        }
      }
  ...
  private void testExpandJsonNodeCommonForParallelStep(String yamlFile, int stepYamlNodeIndex,
      int parallelStepYamlNodeIndex, int sizeForAssertionCheck, List<String> expectedStepIdentifiers,
      boolean axesRemoved) throws IOException {
    ClassLoader classLoader = this.getClass().getClassLoader();
    final URL testFile = classLoader.getResource(yamlFile);
