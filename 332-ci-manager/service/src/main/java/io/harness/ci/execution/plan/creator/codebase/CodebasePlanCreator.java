...
public class CodebasePlanCreator {
  public static List<PlanNode> createPlanForCodeBase(YamlField ciCodeBaseField, String childNodeId,
    ...
    return buildCodebasePlanNodes(codeBaseNodeUUID, childNodeId, kryoSerializer, ciCodeBase, executionSource, null);
  }
  ...
  public static List<PlanNode> buildCodebasePlanNodes(String ciCodeBaseFieldUuid, String childNodeId,
      ...
      Boolean writeToPipelineScope) {
    List<PlanNode> planNodeList = new ArrayList<>();
    PlanNode codeBaseDelegateTask = createPlanForCodeBaseTask(
        ciCodeBase, executionSource, OrchestrationFacilitatorType.TASK, ciCodeBaseFieldUuid, writeToPipelineScope);
    planNodeList.add(codeBaseDelegateTask);
    PlanNode codeBaseSyncTask = createPlanForCodeBaseTask(
        ciCodeBase, executionSource, OrchestrationFacilitatorType.SYNC, ciCodeBaseFieldUuid, writeToPipelineScope);
  ...
  @NotNull
  @VisibleForTesting
  static PlanNode createPlanForCodeBaseTask(CodeBase ciCodeBase, ExecutionSource executionSource,
      String facilitatorType, String codeBaseId, Boolean writeToPipelineScope) {
    CodeBaseTaskStepParameters codeBaseTaskStepParameters = CodeBaseTaskStepParameters.builder()
                                                                .connectorRef(ciCodeBase.getConnectorRef())
                                                                .repoName(ciCodeBase.getRepoName())
                                                                .executionSource(executionSource)
                                                                .writeToPipelineScope(writeToPipelineScope)
                                                                .build();
