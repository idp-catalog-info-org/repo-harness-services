...
public class RunTestStepV2VariableCreator extends GenericStepVariableCreator<RunTestStepV2Node> {
  @Override
  ...
  public YamlExtraProperties getStepExtraProperties(
      String fqnPrefix, String localNamePrefix, RunTestStepV2Node config) {
    ...
    if (config.getRunTestStepV2Info().getOutputVariables().getValue() != null) {
      List<NGVariable> outputNGVariables = config.getRunTestStepV2Info().getOutputVariables().getValue();
