...
public interface CIBuildEnforcer {
  default boolean shouldQueue(String accountID, Infrastructure infrastructure, String moduleType) {
    return shouldQueue(accountID, infrastructure, moduleType, null);
  }
  ...
  default boolean shouldRun(String accountID, Infrastructure infrastructure, String moduleType) {
