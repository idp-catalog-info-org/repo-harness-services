...
package io.harness.ci.execution.execution.metadata;
...
public class CIExecutionMetadata {
  ...
  String queueId;
  String queueTopic;
  String queueSubtopic;
  String status;
  Infrastructure.Type infraType;
  Long capacityTaskProcessedTime;
  Boolean capacityTaskInProgress;
  Long concurrencyQueueProcessedTime;
  @Builder.Default
  @FdTtlIndex
