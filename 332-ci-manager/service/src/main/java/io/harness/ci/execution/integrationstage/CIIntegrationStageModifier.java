...
public class CIIntegrationStageModifier implements StageExecutionModifier {
  ...
  public ExecutionElementConfig modifyExecutionPlan(ExecutionElementConfig execution, IntegrationStageNode stageNode,
    ...
    boolean flexibleTemplateEnabled = InjectUtils.IsFlexibleTemplatesEnabled(context);
    ...
    return ExecutionElementConfig.builder()
        ...
        .steps(ciStepGroupUtils.createExecutionWrapperWithInitializeStep(stageNode, ciExecutionArgs, ciCodeBase,
            infrastructure, context.getAccountIdentifier(), context.getOrgIdentifier(), context.getProjectIdentifier(),
            flexibleTemplateEnabled))
        .build();
  }
}
