...
public class AiVerifyStepVariableCreator extends GenericStepVariableCreator<AiVerifyStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Sets.newHashSet("AiVerify");
  }
  ...
  @Override
  public YamlExtraProperties getStepExtraProperties(String fqnPrefix, String localNamePrefix, AiVerifyStepNode config) {
