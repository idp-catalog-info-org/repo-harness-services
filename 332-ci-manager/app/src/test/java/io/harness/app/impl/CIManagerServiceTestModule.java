...
import io.harness.cvng.client.HealthSourceResourceClient;
...
public class CIManagerServiceTestModule extends AbstractModule {
  ...
  @Named("base")
  public String base() {
    return ciManagerConfiguration.getBase();
  }
  ...
  protected void configure() {
    ...
    bind(ProcessExecutor.class).toInstance(new BashProcessExecutor());
    ...
    bind(HealthSourceResourceClient.class).toInstance(mock(HealthSourceResourceClient.class));
    ...
    bind(io.harness.ci.execution.aitestautomation.AiTestAutomationCIService.class)
        .toInstance(mock(io.harness.ci.execution.aitestautomation.AiTestAutomationCIService.class));
    ...
    install(new OidcResourceClientModule(
        secretConnectorServiceConfig, secretConnectorServiceSecret, serviceId, ClientMode.PRIVILEGED));
