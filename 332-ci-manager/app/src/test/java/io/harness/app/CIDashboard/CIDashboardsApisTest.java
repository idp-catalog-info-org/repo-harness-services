...
public class CIDashboardsApisTest extends CategoryTest {
  ...
  @Mock CIScopeInfoHelper scopeInfoHelper;
  ...
  public void testGetDashboardBuildFailureInfo() {
    String queryRequired =
        ...
        + "author_avatar, startts, trigger_type, endts, status, id  from pipeline_execution_summary_ci where "
        + "accountid='acc' and orgidentifier='org' and projectidentifier='pro' and status in "
        + "('FAILED','ABORTED','EXPIRED','IGNOREFAILED','ERRORED') ORDER BY startts DESC LIMIT 5;";
    ...
    doReturn(buildFailureInfos)
        .when(ciOverviewDashboardServiceImpl)
        .queryCalculatorBuildFailureInfo("acc", "org", "pro", 5, 15, 35);

    assertThat(buildFailureInfos)
        .isEqualTo(ciOverviewDashboardServiceImpl.getDashboardBuildFailureInfo("acc", "org", "pro", 5, 15, 35));
  }
  ...
  public void testGetDashboardBuildActiveInfo() {
    String queryRequired =
        ...
        + "moduleinfo_repository, startts, status, trigger_type, id   from pipeline_execution_summary_ci where "
        + "accountid='acc' and orgidentifier='org' and projectidentifier='pro' and status IN "
        + "('RUNNING','ASYNCWAITING','TASKWAITING','TIMEDWAITING','PAUSED','PAUSING') ORDER BY startts DESC LIMIT 5;";
    ...
    doReturn(buildActiveInfos)
        .when(ciOverviewDashboardServiceImpl)
        .queryCalculatorBuildActiveInfo("acc", "org", "pro", 5, 15, 35);

    assertThat(buildActiveInfos)
        .isEqualTo(ciOverviewDashboardServiceImpl.getDashboardBuildActiveInfo("acc", "org", "pro", 5, 15, 35));
  }
  ...
  public void testGetCIUsage() {
    ...
    doReturn(activeCommitters).when(ciOverviewDashboardServiceImpl).getActiveCommitters(accountId, timestamp);
  ...
  public void testGetActiveCommitters() throws SQLException {
    ...
    assertThat(usage).isEqualTo(ciOverviewDashboardServiceImpl.getActiveCommitters("accountId", 0L));
  }
  ...
  public void testGetActiveCommittersCount() throws SQLException {
    ...
    assertThat(expectedResult).isEqualTo(ciOverviewDashboardServiceImpl.getActiveCommittersCount("accountId"));
  }
