...
import io.harness.runner.plugin.PluginConfigClient;
...
public class CIManagerRule implements MethodRule, InjectorRuleMixin, MongoRuleMixin {
  ...
  public List<Module> modules(List<Annotation> annotations) {
    ...
    modules.add(new ProviderModule() {
      ...
      String getHarnessArtifactRegistryUrl() {
      ...
      @Provides
      @Singleton
      PluginConfigClient getPluginConfigClient() {
        return mock(PluginConfigClient.class);
      }
    });
    ...
    CIManagerConfiguration configuration =
        CIManagerConfiguration.builder()
            ...
            .cacheServiceConfig(
                CacheServiceConfig.builder().baseUrl("http://localhost-inc:8082").globalToken("global-token").build())
            .stoServiceConfig(STOServiceConfig.builder()
                                  ...
                                  .build())
            .qwietServiceConfig(
                QwietServiceConfig.builder().baseUrl("http://localhost-inc:4000").globalToken("global-token").build())
            .iacmServiceConfig(
            ...
            .sscaServiceConfig(
                SSCAServiceConfig.builder()
                    ...
                    .build())
            .harnessFulcioServiceConfig(
                HarnessFulcioServiceConfig.builder()
                    .httpClientConfig(ServiceHttpClientConfig.builder().baseUrl("http://localhost:8187").build())
                    .build())
