...
import io.harness.pms.serializer.kryo.serializers.InputsMetadataInfoKryoSerializer;
...
public class OrchestrationBeansKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(InputsMetadataInfo.class, InputsMetadataInfoKryoSerializer.getInstance(), 2632);
  }
}
