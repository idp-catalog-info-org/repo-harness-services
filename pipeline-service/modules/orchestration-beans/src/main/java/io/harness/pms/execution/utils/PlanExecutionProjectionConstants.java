...
public final class PlanExecutionProjectionConstants {
  ...
  public static final Set<String> fieldsForPostProdRollbackOptimized = Sets.newHashSet(
      String.format("%s.%s", PlanExecutionMetadataKeys.postExecutionRollbackInfos, "postExecutionRollbackStageId"));
}
