...
public class PlanExecution implements PersistentRegularIterable, UuidAccess, PmsNodeExecution {
  ...
  public static class PlanExecutionKeys {
    ...
    public static final String triggerType = PlanExecutionKeys.metadata + "."
        + "triggerInfo"
        + "."
        + "triggerType";
  }
  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList
        ...
        .add(SortCompoundMongoIndex.builder()
                 ...
                 .build())
        // PlanExecutionMonitorService - used for aggregation command to extract observability data
        .add(CompoundMongoIndex.builder()
                 .name("status_accountId")
                 .field(PlanExecutionKeys.status)
                 .field(PlanExecutionKeys.accountId)
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("endTs_idx")
                 .field(PlanExecutionKeys.endTs)
                 .ascSortField(PlanExecutionKeys.endTs)
                 .build())
        .add(CompoundMongoIndex.builder()
                 .name("accountId_priorityType_status_idx")
                 .field(PlanExecutionKeys.accountId)
                 .field(PlanExecutionKeys.priorityType)
                 .field(PlanExecutionKeys.status)
                 .build())
        .build();
  }
