  ...
  public void testCreateVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.Service_Now_Import_Set_Identifier.spec.execution.steps.app.identifier",
            ...
            "pipeline.stages.Service_Now_Import_Set_Identifier.spec.execution.steps.app.nodeExecutionId",
            "pipeline.stages.Service_Now_Import_Set_Identifier.spec.execution.steps.app.log.url");
    ...
    assertYamlProperties(outputProperties.get(3),
        "pipeline.stages.Service_Now_Import_Set_Identifier.spec.execution.steps.app.output.transformMapOutcomes[0]."
            + "transformMap",
