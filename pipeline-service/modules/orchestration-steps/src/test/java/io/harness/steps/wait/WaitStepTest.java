...
public class WaitStepTest extends OrchestrationStepsTestBase {
  ...
  public void setup() {
    ...
    stepElementParameters = StepElementParameters.builder().identifier("stepId").spec(waitStepParameters).build();
  }
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    StepElementParameters stepElementParameters = StepElementParameters.builder().spec(waitStepParameters).build();

    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        waitStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(waitStep.STEP_TYPE.getType());
  }
}
