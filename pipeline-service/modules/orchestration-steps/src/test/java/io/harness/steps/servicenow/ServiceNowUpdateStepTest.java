...
public class ServiceNowUpdateStepTest extends CategoryTest {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepElementParameters stepElementParameters = getStepSingleElementParameters();

    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        serviceNowUpdateStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(serviceNowUpdateStep.STEP_TYPE.getType());
  }
}
