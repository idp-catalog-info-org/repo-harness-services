...
public class PolicyStepTest extends CategoryTest {
  ...
  public void testExecuteSyncWithEvaluationSuccess() throws IOException {
    ...
    verify(stepsInstrumentationHelper).publishStepEvent(any(), captor.capture());
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO = captor.getValue();
  ...
  public void testGetStepParametersClass() {
    assertThat(policyStep.getStepParametersClass()).isEqualTo(StepBaseParameters.class);
  }
}
