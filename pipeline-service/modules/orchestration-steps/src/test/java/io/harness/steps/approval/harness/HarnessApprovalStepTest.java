...
public class HarnessApprovalStepTest {
  ...
  public void testExecuteAsyncAfterRbacWithEmptyUserGroup() {
    ...
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("All the provided user groups and/or service accounts are empty");
    }
  }
  ...
  public void testExecuteAsyncAfterRbacWithNoUserGroup() {
    ...
    try {
      ...
      assertThat(e.getMessage())
          .isEqualTo("At least 1 valid user group is required in [incorrectUserGroup], Please check scope of the user "
              + "group's provided");
    }
  }
