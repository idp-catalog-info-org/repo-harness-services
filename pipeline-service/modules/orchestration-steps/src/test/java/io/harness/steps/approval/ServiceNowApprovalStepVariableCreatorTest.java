  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.stage1.spec.execution.steps.servicenow_approval.identifier",
            ...
            "pipeline.stages.stage1.spec.execution.steps.servicenow_approval.nodeExecutionId",
            "pipeline.stages.stage1.spec.execution.steps.servicenow_approval.log.url");
