...
public class NodeExecutionMetadataDeleteObserverTest extends CategoryTest {
  ...
  public void shouldTestNodesDelete() {
    ...
    when(eventListenerStepInstanceService.isNodeExecutionOfEventListenerStepType(any())).thenReturn(false);
    ...
    verify(eventListenerStepInstanceService, times(1)).deleteByNodeExecutionIds(any());
  }
