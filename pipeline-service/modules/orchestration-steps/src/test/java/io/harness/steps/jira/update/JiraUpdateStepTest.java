...
public class JiraUpdateStepTest extends OrchestrationStepsTestBase {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        jiraUpdateStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(jiraUpdateStep.STEP_TYPE.getType());
  }
}