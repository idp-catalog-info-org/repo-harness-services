...
public class ServiceNowImportSetStepTest extends CategoryTest {
  ...
  public void testHandleTaskResultWithSecurityContext() throws Exception {
    ...
    assertThat(serviceNowImportSetStep.handleTaskResultWithSecurityContext(
                   getAmbiance(), getStepElementParameters(CONNECTOR, STAGING_TABLE_NAME, null), () -> taskResponse))
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepElementParameters stepElementParameters = getStepElementParameters(CONNECTOR, STAGING_TABLE_NAME, null);

    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        serviceNowImportSetStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(serviceNowImportSetStep.STEP_TYPE.getType());
  }
