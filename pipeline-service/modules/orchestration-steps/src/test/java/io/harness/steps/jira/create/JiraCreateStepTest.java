...
public class JiraCreateStepTest extends OrchestrationStepsTestBase {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        jiraCreateStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(jiraCreateStep.STEP_TYPE.getType());
  }
}