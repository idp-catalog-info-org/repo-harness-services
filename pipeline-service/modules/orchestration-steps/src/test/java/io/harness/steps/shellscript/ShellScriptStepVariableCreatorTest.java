  ...
  public void createVariablesForParentNode() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.stages.stage1.spec.execution.steps.shellScriptStep.identifier",
            ...
            "pipeline.stages.stage1.spec.execution.steps.shellScriptStep.nodeExecutionId",
            "pipeline.stages.stage1.spec.execution.steps.shellScriptStep.log.url");
    ...
    assertThat(fqnOutputPropertiesList)
        .containsOnly("pipeline.stages.stage1.spec.execution.steps.shellScriptStep.output.exitCode",
            "pipeline.stages.stage1.spec.execution.steps.shellScriptStep.output.outputVariables.o1");
  }
}
