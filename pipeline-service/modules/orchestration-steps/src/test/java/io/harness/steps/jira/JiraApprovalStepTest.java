...
public class JiraApprovalStepTest extends CategoryTest {
  ...
  public void testGetStepExecutionTelemetryEventDTO() {
    ...
    StepExecutionTelemetryEventDTO stepExecutionTelemetryEventDTO =
        jiraApprovalStep.getStepExecutionTelemetryEventDTO(ambiance, stepElementParameters);

    assertThat(stepExecutionTelemetryEventDTO.getStepType()).isEqualTo(jiraApprovalStep.STEP_TYPE.getType());
  }
