...
public class PipelineVariableCreatorTest extends CategoryTest {
  ...
  public void createVariablesForParentNodesV2() throws IOException {
    ...
    assertThat(fqnExtraPropertiesList)
        .containsOnly("pipeline.identifier", "pipeline.sequenceId", "pipeline.executionId", "pipeline.startTs",
            ...
            "pipeline.executionUrl", "pipeline.executionMode", "pipeline.storeType", "pipeline.selectedStages",
            "pipeline.branch", "pipeline.repo", "inputSet.details[0].name", "inputSet.details[0].identifier",
            "inputSet.details[0].description", "inputSet.details[0].inputSetType", "inputSet.details[0].tags",
            "inputSet.details[0].orgIdentifier", "inputSet.details[0].projectIdentifier",
            "inputSet.details[0].pipelineIdentifier");
  }
  ...
  public void testGetPipelineExtraProperties() {
    ...
    assertEquals(yamlExtraProperties.getPropertiesList().size(), 27);
