...
public class OrchestrationStepsModuleTest extends CategoryTest {
  ...
  @Before
  public void setUp() {
    orchestrationStepsModule = OrchestrationStepsModule.getInstance(config, HarnessCodeServiceConfig.builder().build());
  }
  @Test
  @Owner(developers = SHALINI)
  @Category(UnitTests.class)
  public void testGetInstance() {
    assertThat(OrchestrationStepsModule.getInstance(
                   OrchestrationStepConfig.builder().build(), HarnessCodeServiceConfig.builder().build()))
