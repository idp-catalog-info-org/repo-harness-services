...
@OwnedBy(PIPELINE)
@Slf4j
public class ResourceRestraintStep implements SyncExecutable<StepBaseParameters>, AsyncExecutable<StepBaseParameters> {
  ...
  public StepResponse executeSync(Ambiance ambiance, StepBaseParameters stepElementParameters,
    ...
    IResourceRestraintSpecParameters specParameters =
        ResourceRestraintUtils.getIResourceRestraintSpecParameters(stepElementParameters);
  ...
  @Override
  public AsyncExecutableResponse executeAsync(Ambiance ambiance, StepBaseParameters stepElementParameters,
      StepInputPackage inputPackage, PassThroughData passThroughData) {
