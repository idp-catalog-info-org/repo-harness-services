...
public class BarrierWithinStrategyExpander implements BarrierExpandObserver {
  ...
  public void onInitializeRequest(BarrierExpandRequest barrierExpandRequest) {
    ...
    expand(barrierExpandRequest, planExecutionId, strategySetupId);

    // Expand Matrix for Barriers Across Chained Pipelines
    if (EmptyPredicate.isNotEmpty(barrierExpandRequest.getParentPlanExecutionId())) {
      expand(barrierExpandRequest, barrierExpandRequest.getParentPlanExecutionId(), strategySetupId);
    }
  }

  private void expand(BarrierExpandRequest barrierExpandRequest, String planExecutionId, String strategySetupId) {
    try {
