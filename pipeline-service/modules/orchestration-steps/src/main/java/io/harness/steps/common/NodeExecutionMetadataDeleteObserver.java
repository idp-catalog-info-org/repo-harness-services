...
public class NodeExecutionMetadataDeleteObserver implements NodeExecutionDeleteObserver {
  ...
  public void onNodesDelete(List<NodeExecution> nodeExecutionsToDelete) {
    ...
    Set<String> eventListenerStepNodeExecutionIds = new HashSet<>();
    ...
    for (NodeExecution nodeExecution : nodeExecutionsToDelete) {
      ...
      if (eventListenerStepInstanceService.isNodeExecutionOfEventListenerStepType(nodeExecution)) {
        eventListenerStepNodeExecutionIds.add(nodeExecution.getUuid());
      }
    }
    ...
    // Delete the event listener step instances for given nodeExecutionIds
    eventListenerStepInstanceService.deleteByNodeExecutionIds(eventListenerStepNodeExecutionIds);
  }
}
