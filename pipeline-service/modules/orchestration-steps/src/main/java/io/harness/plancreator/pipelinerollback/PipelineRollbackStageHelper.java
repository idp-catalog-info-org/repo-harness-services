...
public class PipelineRollbackStageHelper {
  ...
  public void addPipelineRollbackStageDependencyV1(String prbStageUuid, JsonNode prbStageJsonNode,
      LinkedHashMap<String, PlanCreationResponse> planCreationResponseMap, YamlField stagesField,
    ...
    planCreationResponseMap.put(prbStageUuid,
        PlanCreationResponse.builder()
            .dependencies(Dependencies.newBuilder().putDependencies(prbStageUuid, prbStageYamlPath).build())
            .yamlUpdates(yamlUpdates)
            .build());
  }

  public JsonNode buildPipelineRollbackStageJsonNode() {
  ...
  public JsonNode buildPipelineRollbackStageJsonNodeV1() {
    String stageInnerYAML = "name: " + PIPELINE_ROLLBACK_STAGE_NAME + "\n"
        + "identifier: prb-" + generateUuid() + "\n"
        + "type: PipelineRollback\n"
        + "spec: {}\n";
    YamlField prbStageYamlField;
