...
public class BarrierPositionInfo {
  ...
  public static class BarrierPosition {
    ...
    /*
     [isDummyPositionForChildPipeline & parentPipelineStageNodeId] Fields are added for Supporting Barriers across
     Pipeline Chaining, for Creating Dummy Entries from Pipeline Stage Plan Creator, this entries are later removed in
     BarrierStepPlanCreator for Child Pipeline.
    */
    Boolean isDummyPositionForChildPipeline;
