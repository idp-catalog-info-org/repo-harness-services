...
package io.harness.steps.approval.step.servicenow.v1.step;
...
public class ServiceNowApprovalStep extends PipelineAsyncExecutable {
  public static final StepType STEP_TYPE = StepSpecTypeConstantsV1.SERVICE_NOW_APPROVAL_STEP_TYPE;

  @Inject io.harness.steps.approval.step.servicenow.step.ServiceNowApprovalStep serviceNowApprovalStep;
  ...
  public StepResponse handleAsyncResponseInternal(
    ...
    return serviceNowApprovalStep.handleAsyncResponseInternal(ambiance, stepParameters, responseDataMap);
  }

  @Override
  public AsyncExecutableResponse executeAsyncAfterRbac(
      Ambiance ambiance, StepBaseParameters stepParameters, StepInputPackage inputPackage) {
    return serviceNowApprovalStep.executeAsyncAfterRbac(ambiance, stepParameters, inputPackage);
  }
  ...
  public void handleAbort(Ambiance ambiance, StepBaseParameters stepParameters,
    ...
    serviceNowApprovalStep.handleAbort(ambiance, stepParameters, executableResponse, userMarked);
  }

  @Override
  public void handleExpire(
      Ambiance ambiance, StepBaseParameters stepParameters, AsyncExecutableResponse executableResponse) {
    serviceNowApprovalStep.handleExpire(ambiance, stepParameters, executableResponse);
  }
}
