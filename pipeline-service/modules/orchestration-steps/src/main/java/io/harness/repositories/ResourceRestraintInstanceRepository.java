...
@OwnedBy(CDC)
@HarnessRepo
public interface ResourceRestraintInstanceRepository
    extends CrudRepository<ResourceRestraintInstance, String>, ResourceRestraintInstanceCustomRepository {
  ...
  List<ResourceRestraintInstance> findAllByReleaseEntityIdAndFqnAndStateIn(
      String releaseEntityId, String fqn, EnumSet<Consumer.State> states);
}
