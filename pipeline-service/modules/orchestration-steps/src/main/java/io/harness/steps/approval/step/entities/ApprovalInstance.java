...
@Persistent
public abstract class ApprovalInstance implements PersistentEntity, PersistentRegularIterable, UniqueIdAware {
  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        ...
        .add(SortCompoundMongoIndex.builder()
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("accountId_parentUniqueId_pipelineIdentifier_approvalKey_status_isAutoRejectEnabled_createdAt")
                 .field(ApprovalInstanceKeys.accountId)
                 .field(ApprovalInstanceKeys.parentUniqueId)
  ...
  // Timestamp when a manual refresh was last triggered
  Long lastManualRunTimestamp;
  ...
  protected void updateFromStepParameters(Ambiance ambiance, StepBaseParameters stepParameters) {
    ...
    setHarnessVersion(stepParameters.getSpec().getVersion());
  }
  ...
  /**
   * Sets the next iterations list for this approval instance.
   * This is used by subclasses that implement polling mechanisms.
   */
  public void setNextIterations(List<Long> nextIterations) {
    // Base implementation does nothing
    // Subclass that uses nextIterations should override this method
  }
  ...
  public String getHarnessVersion() {
    if (EmptyPredicate.isEmpty(harnessVersion)) {
