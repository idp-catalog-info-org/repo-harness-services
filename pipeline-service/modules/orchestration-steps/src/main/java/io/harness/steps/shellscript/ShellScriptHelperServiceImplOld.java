...
public class ShellScriptHelperServiceImplOld implements ShellScriptHelperServiceOld {
  ...
  @Inject private OutputAliasHelper outputAliasHelper;
  ...
  public ShellScriptBaseOutcome prepareShellScriptOutcome(
    ...
    return ShellScriptHelperServiceOld.getShellScriptOutcome(resolvedOutputVariables, HarnessYamlVersion.V0, null);
  }
  ...
  public void exportOutputVariablesUsingAlias(@Nonnull Ambiance ambiance,
    ...
    exportOutputVariablesUsingAlias(
        ambiance, shellScriptStepParameters.getOutputAlias(), shellScriptOutcome.getOutputVariables());
  }
  ...
  public void exportOutputVariablesUsingAlias(
    ...
    outputAliasHelper.exportOutputVariablesUsingAlias(ambiance, outputAlias, outputVariables);
  }
}
