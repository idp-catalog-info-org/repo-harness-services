...
public class UnifiedQueueStepNode extends UnifiedPmsAbstractStepNode {
  @JsonProperty(YAMLFieldNameConstants.QUEUE_V1) UnifiedQueueStepInfo unifiedQueueStepInfo;
  @Override
