...
public interface BarrierService {
  ...
  void updatePosition(BarrierPositionInfo.BarrierPosition.BarrierPositionType positionType, String positionSetupId,
      String positionExecutionId, String stageExecutionId, String stepGroupExecutionId,
      List<BarrierExecutionInstance> barrierExecutionInstances, boolean optimizationFFEnabled,
  ...
  List<BarrierExecutionInstance> findByPosition(String planExecutionId,
  ...
  void upsertBarrierExecutionInstance(String setupId, String barrierId, String barrierName, String planExecutionId,
  ...
  boolean atomicallyRemoveDummyBarrierPosition(
