...
import io.harness.ssca.beans.orchestration.OrchestrationStepEnvVariables;
import io.harness.ssca.beans.orchestration.OrchestrationStepSecretVariables;
...
public class SscaOrchestrationPluginHelper {
  ...
  public static Map<String, SecretNGVariable> getSscaOrchestrationSecretVars(
    ...
    if (stepInfo.getAttestation() != null
        && (AttestationType.COSIGN.equals(stepInfo.getAttestation().getType())
            || AttestationType.KEYBASED.equals(stepInfo.getAttestation().getType()))) {
