...
public final class BarrierExecutionInstance implements PersistentEntity, UuidAware, PersistentRegularIterable {
  ...
  public static class BarrierExecutionInstanceKeys {
    ...
    public static final String isDummyPositionForChildPipeline = BarrierPositionKeys.isDummyPositionForChildPipeline;

    public static final String parentPipelineStageNodeId = BarrierPositionKeys.parentPipelineStageNodeId;
