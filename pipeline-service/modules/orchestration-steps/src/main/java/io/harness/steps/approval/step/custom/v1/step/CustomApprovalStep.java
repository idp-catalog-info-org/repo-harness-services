...
package io.harness.steps.approval.step.custom.v1.step;
...
public class CustomApprovalStep extends PipelineAsyncExecutable {
  public static final StepType STEP_TYPE = StepSpecTypeConstantsV1.CUSTOM_APPROVAL_STEP_TYPE;

  @Inject io.harness.steps.approval.step.custom.CustomApprovalStep customApprovalStep;
  ...
  public StepResponse handleAsyncResponseInternal(
    ...
    return customApprovalStep.handleAsyncResponseInternal(ambiance, stepParameters, responseDataMap);
  }

  @Override
  public AsyncExecutableResponse executeAsyncAfterRbac(
      Ambiance ambiance, StepBaseParameters stepParameters, StepInputPackage inputPackage) {
    return customApprovalStep.executeAsyncAfterRbac(ambiance, stepParameters, inputPackage);
  }
  ...
  public void handleAbort(Ambiance ambiance, StepBaseParameters stepParameters,
    ...
    customApprovalStep.handleAbort(ambiance, stepParameters, executableResponse, userMarked);
  }
  ...
  public void handleExpire(
    ...
    customApprovalStep.handleExpire(ambiance, stepParameters, executableResponse);
  }
}
