...
import io.harness.plancreator.steps.internal.StepParametersUtils;
  ...
  public PlanNode createPlanForParentNode(PlanCreationContext ctx, T stageNode, List<String> childrenNodeIds) {
    ...
    PlanNodeBuilder planNodeBuilder =
        PlanNode.builder()
            ...
            .whenCondition(RunInfoUtils.getWhenConditionForStage(ctx, stageNode.getWhen()))
            .facilitatorObtainment(
                FacilitatorObtainment.newBuilder()
                    .setType(FacilitatorType.newBuilder().setType(OrchestrationFacilitatorType.CHILD).build())
                    .build())
            .adviserObtainments(getAdviserObtainmentFromMetaData(ctx.getCurrentField(), ctx.getDependency(), ctx));
