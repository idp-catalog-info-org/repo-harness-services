...
public class FmeFeatureFlagNotFoundException extends WingsException {
  private static final String MESSAGE_KEY = "message";
  private static final String FLAG_NAME_KEY = "flagName";
  private static final String ENVIRONMENT_KEY = "environment";
  private static final String ERROR_MESSAGE = "Feature flag '%s' not found in environment '%s'";

  public FmeFeatureFlagNotFoundException(String flagName, String environment) {
