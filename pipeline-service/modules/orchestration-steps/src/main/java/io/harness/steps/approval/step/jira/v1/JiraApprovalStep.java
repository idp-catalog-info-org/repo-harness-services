...
public class JiraApprovalStep extends PipelineAsyncExecutable {
  ...
  @Inject io.harness.steps.approval.step.jira.step.JiraApprovalStep jiraApprovalStep;
  ...
  public void handleExpire(
    ...
    jiraApprovalStep.handleExpire(ambiance, stepParameters, executableResponse);
  }
}
