...
public interface ResourceRestraintInstanceService {
  ...
  ResourceRestraintInstance findByReleaseEntityIdAndFqn(String releaseEntityId, String fqn);
  ...
  void updateBlockedConstraints(ResourceRestraintInstance instance);

  Stream<ResourceRestraintInstance> getAllByRestraintIdAndResourceUnitAndStates(
