...
@OwnedBy(PIPELINE)
public class OPAEvaluationAggregatorStepInfoVisitorHelperTest extends CategoryTest {
  @Mock private ValidationVisitor validationVisitor;

  private OPAEvaluationAggregatorStepInfoVisitorHelper visitorHelper;

  @Before
  public void setUp() {
    MockitoAnnotations.openMocks(this);
    visitorHelper = new OPAEvaluationAggregatorStepInfoVisitorHelper();
  }
  ...
  public void testCreateDummyVisitableElement() {
    OPAEvaluationAggregatorStepInfo originalElement =
    ...
    assertThat(dummyElement).isInstanceOf(OPAEvaluationAggregatorStepInfo.class);
    OPAEvaluationAggregatorStepInfo dummyStepInfo = (OPAEvaluationAggregatorStepInfo) dummyElement;
    assertThat(dummyStepInfo.getEvaluationId()).isNull(); // Dummy element has null values
  }
