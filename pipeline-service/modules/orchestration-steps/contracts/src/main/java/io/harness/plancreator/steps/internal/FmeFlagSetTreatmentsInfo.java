...
import io.harness.steps.fme.FmeFlagSetTreatmentsParameters;
...
@TypeAlias("fmeFlagSetTreatmentsInfo")
@RecasterAlias("io.harness.plancreator.steps.internal.FmeFlagSetTreatmentsInfo")
public class FmeFlagSetTreatmentsInfo implements PMSStepInfo, Visitable {
  ...
  public StepType getStepType() {
    return StepSpecTypeConstants.FME_FLAG_SET_TREATMENTS_STEP_TYPE;
  }
  ...
  public SpecParameters getSpecParameters() {
    return FmeFlagSetTreatmentsParameters.builder()
