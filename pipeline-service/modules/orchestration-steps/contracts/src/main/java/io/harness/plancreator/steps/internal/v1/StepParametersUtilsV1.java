...
public class StepParametersUtilsV1 {
  public StepElementParametersV1Builder getStepParameters(PmsAbstractStepNodeV1 stepElementConfig) {
    ...
    stepBuilder.description(stepElementConfig.getDesc());
    stepBuilder.onFailure(stepElementConfig.getFailure() != null ? stepElementConfig.getFailure().getValue() : null);
    ...
    stepBuilder.delegate(stepElementConfig.getDelegate());
