...
public abstract class HarnessApprovalBaseOutcome implements Outcome {
  public abstract List<HarnessApprovalBaseActivityDTO> getApprovalActivities();
  public abstract Map<String, String> getApproverInputs();
}
