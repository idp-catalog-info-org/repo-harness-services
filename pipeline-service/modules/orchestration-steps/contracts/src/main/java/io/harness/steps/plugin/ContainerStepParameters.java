...
public class ContainerStepParameters extends ContainerBaseStepInfo implements SpecParameters {
  ...
  public ContainerStepParameters(ParameterField<String> image, ParameterField<String> connectorRef,
      ParameterField<String> registryRef, ParameterField<ImagePullPolicy> imagePullPolicy,
      ParameterField<List<TaskSelectorYaml>> delegateSelectors, ParameterField<List<String>> entrypoint) {
    super(image, connectorRef, registryRef, imagePullPolicy, delegateSelectors, entrypoint);
  }
