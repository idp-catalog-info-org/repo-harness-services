...
@TypeAlias("opaEvaluationStepParameters")
@RecasterAlias("io.harness.steps.opa.OPAEvaluationStepParameters")
public class OPAEvaluationStepParameters extends OPAEvaluationBaseStepInfo implements SpecParameters, StepParameters {
  ParameterField<String> policySetId;
  ...
  public OPAEvaluationStepParameters(ParameterField<List<TaskSelectorYaml>> delegateSelectors,
