...
@OwnedBy(FME)
@RecasterAlias("io.harness.steps.fme.FmeSetDefaultTreatmentInstruction")
public class FmeSetDefaultTreatmentInstruction extends FmeDefinitionInstruction {
  @NotNull
  ...
  public FmeInstructionType getType() {
    return FmeInstructionType.SetDefaultTreatment;
  }
}
