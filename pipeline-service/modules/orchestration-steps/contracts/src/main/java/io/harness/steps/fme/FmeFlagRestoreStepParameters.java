...
@Value
@Builder
@TypeAlias("fmeFlagRestoreParameters")
@RecasterAlias("io.harness.steps.fme.FmeFlagRestoreStepParameters")
public class FmeFlagRestoreStepParameters implements SpecParameters {
  String type = "FmeFlagRestore";
