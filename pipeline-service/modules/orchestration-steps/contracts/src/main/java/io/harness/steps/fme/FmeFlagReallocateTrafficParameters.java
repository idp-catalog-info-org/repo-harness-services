...
@Value
@Builder
@TypeAlias("FmeFlagReallocateTrafficParameters")
@RecasterAlias("io.harness.steps.fme.FmeFlagReallocateTrafficParameters")
public class FmeFlagReallocateTrafficParameters implements SpecParameters {
  String type = "FmeFlagReallocateTraffic";
