...
@Value
@Builder
@TypeAlias("fmeFlagSetTargetsParameters")
@RecasterAlias("io.harness.steps.fme.FmeFlagSetTargetsParameters")
public class FmeFlagSetTargetsParameters implements SpecParameters {
  String type = "FmeFlagSetIndividualTargets";
  ...
  @ApiModelProperty(required = true, value = "List of treatments with targets and segments to set")
  @NotNull
