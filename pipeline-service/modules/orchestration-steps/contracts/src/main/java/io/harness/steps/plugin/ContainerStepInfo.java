...
public class ContainerStepInfo extends ContainerBaseStepInfo
    implements PMSStepInfo, Visitable, WithConnectorRef, SpecParameters, ContainerStepSpec {
  ...
  public ContainerStepInfo(String uuid, String identifier, String name, int retry,
      ...
      ParameterField<String> registryRef, ParameterField<String> uses, ParameterField<List<String>> entrypoint,
