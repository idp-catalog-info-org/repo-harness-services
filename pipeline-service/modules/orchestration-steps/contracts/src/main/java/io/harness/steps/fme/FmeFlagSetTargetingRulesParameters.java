...
@Value
@Builder
@TypeAlias("FmeFlagSetTargetingRulesParameters")
@RecasterAlias("io.harness.steps.fme.FmeFlagSetTargetingRulesParameters")
public class FmeFlagSetTargetingRulesParameters implements SpecParameters {
  String type = "FmeFlagSetTargetingRules";
