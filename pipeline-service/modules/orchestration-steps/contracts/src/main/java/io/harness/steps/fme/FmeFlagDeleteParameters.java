...
@Value
@Builder
@TypeAlias("FmeFlagDeleteParameters")
@RecasterAlias("io.harness.steps.fme.FmeFlagDeleteParameters")
public class FmeFlagDeleteParameters implements SpecParameters {
  String type = "FmeFlagDelete";
