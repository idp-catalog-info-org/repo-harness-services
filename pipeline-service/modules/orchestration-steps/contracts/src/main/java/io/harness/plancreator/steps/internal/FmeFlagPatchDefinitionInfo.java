...
import io.harness.steps.fme.FmeFlagPatchDefinitionParameters;
...
@TypeAlias("fmeFlagPatchDefinitionInfo")
@RecasterAlias("io.harness.plancreator.steps.internal.FmeFlagPatchDefinitionInfo")
public class FmeFlagPatchDefinitionInfo implements PMSStepInfo, Visitable {
  ...
  public StepType getStepType() {
    return StepSpecTypeConstants.FME_FLAG_PATCH_DEFINITION_STEP_TYPE;
  }
  ...
  public SpecParameters getSpecParameters() {
    return FmeFlagPatchDefinitionParameters.builder()
        .flagName(flagName)
