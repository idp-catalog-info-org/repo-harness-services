...
@OwnedBy(FME)
@RecasterAlias("io.harness.steps.fme.FmeSetLimitExposureInstruction")
public class FmeSetLimitExposureInstruction extends FmeDefinitionInstruction {
  @NotNull
  @YamlSchemaTypes(value = {runtime, expression})
  @ApiModelProperty(dataType = SwaggerConstants.INTEGER_CLASSPATH)
  ParameterField<Integer> value;

  @Override
  public FmeInstructionType getType() {
    return FmeInstructionType.SetLimitExposure;
  }
}
