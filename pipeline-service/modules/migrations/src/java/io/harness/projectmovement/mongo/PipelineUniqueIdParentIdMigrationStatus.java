...
@Data
@Builder
@FieldNameConstants(innerTypeName = "PipelineUniqueIdParentIdMigrationStatusKeys")
@StoreIn(DbAliases.PMS)
@Entity(value = "uniqueIdParentIdMigrationStatus", noClassnameStored = true)
@Document("uniqueIdParentIdMigrationStatus")
@TypeAlias("pipelineUniqueIdParentIdMigrationStatus")
public class PipelineUniqueIdParentIdMigrationStatus implements PersistentEntity {
