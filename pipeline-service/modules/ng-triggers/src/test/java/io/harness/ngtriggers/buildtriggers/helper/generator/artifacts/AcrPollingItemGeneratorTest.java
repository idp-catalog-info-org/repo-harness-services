...
public class AcrPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testAcrPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_acr, false);
    ...
    PollingItem pollingItem = acrPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
