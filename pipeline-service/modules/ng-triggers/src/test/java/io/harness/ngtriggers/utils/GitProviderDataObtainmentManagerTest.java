        ...
        FilterRequestData.builder()
            .webhookPayloadData(
                WebhookPayloadData.builder()
                    ...
                    .build())
            .build();
    doNothing().when(awsCodeCommitDataObtainer).acquireProviderData(any(), any(), any(), anyBoolean());
    gitProviderDataObtainmentManager.acquireProviderData(filterRequestData, Collections.emptyList(), null, false);
    verify(awsCodeCommitDataObtainer, times(1)).acquireProviderData(filterRequestData, triggers, null, false);
  }
        ...
        FilterRequestData.builder()
            .webhookPayloadData(
                WebhookPayloadData.builder()
                    ...
                    .build())
            .build();
    doNothing().when(scmDataObtainer).acquireProviderData(any(), any(), any(), anyBoolean());
    gitProviderDataObtainmentManager.acquireProviderData(filterRequestData, Collections.emptyList(), null, false);
    verify(scmDataObtainer, times(1)).acquireProviderData(filterRequestData, triggers, null, false);
  }
}
