...
public class JenkinsPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testJenkinsPollingItemGeneration_pipelineContainsFixedValuesExceptTest() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_jenkins, false);
    ...
    PollingItem pollingItem = jenkinsPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
