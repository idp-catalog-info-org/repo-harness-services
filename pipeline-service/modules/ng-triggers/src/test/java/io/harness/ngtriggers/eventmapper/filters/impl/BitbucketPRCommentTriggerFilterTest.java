...
public class BitbucketPRCommentTriggerFilterTest extends CategoryTest {
  ...
  public void applyFilterTest_v2() throws Exception {
    ...
    doReturn(Collections.singletonList(details1))
        .when(payloadConditionsTriggerFilter)
        .applyFilterV2(Collections.singletonList(details1), filterRequestData);
    var remainingList =
        bitbucketPRCommentTriggerFilter.applyFilterV2(Collections.singletonList(details1), filterRequestData);
    assertThat(remainingList).isNotEmpty();
    assertThat(remainingList.get(0)).isEqualTo(details1);
  }
  ...
  @Owner(developers = LUCAS_SALES)
  @Category(UnitTests.class)
  public void applyFilterExceptionTest_v2() {
    Map<String, String> metadata = new HashMap<>();
    metadata.put("key1", "value1");
    metadata.put("key2", "value1value2");
    Long createdAt = 12L;
