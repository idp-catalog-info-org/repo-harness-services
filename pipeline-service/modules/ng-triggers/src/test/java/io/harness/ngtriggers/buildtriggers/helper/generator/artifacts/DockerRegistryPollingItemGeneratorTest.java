...
public class DockerRegistryPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testEcrPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails = ngTriggerElementMapper.toTriggerDetails(
        "acc", "org", "proj", null, ngTriggerYaml_artifact_dockerregistry, false);
    ...
    PollingItem pollingItem = dockerRegistryPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
  ...
  public void testPollingItemGenerationForMultiRegionArtifactTrigger() throws Exception {
    TriggerDetails triggerDetails = ngTriggerElementMapper.toTriggerDetails(
        "acc", "org", "proj", null, ngTriggerYaml_multi_region_artifact_dockerregistry, true);
    ...
    PollingItem pollingItem1 =
        dockerRegistryPollingItemGenerator.generatePollingItem(buildTriggerOpsDataList.get(0), null, false);
    ...
    PollingItem pollingItem2 =
        dockerRegistryPollingItemGenerator.generatePollingItem(buildTriggerOpsDataList.get(1), null, false);
