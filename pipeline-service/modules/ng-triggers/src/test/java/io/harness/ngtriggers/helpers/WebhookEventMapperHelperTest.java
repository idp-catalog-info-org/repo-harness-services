...
import io.harness.ngtriggers.eventmapper.impl.HarnessRegistryWebhookEventToTriggerMapper;
...
public class WebhookEventMapperHelperTest extends CategoryTest {
  ...
  @Mock private HarnessRegistryWebhookEventToTriggerMapper harnessRegistryWebhookEventToTriggerMapper;
  ...
  @Category(UnitTests.class)
  public void testHarnessArtifactRegistryWebhook() {
    TriggerMappingRequestData triggerMappingRequestData =
        TriggerMappingRequestData.builder()
            .triggerWebhookEvent(TriggerWebhookEvent.builder().sourceRepoType(HARNESS_ARTIFACT_REGISTRY.name()).build())
            .build();
    doReturn(null).when(harnessRegistryWebhookEventToTriggerMapper).mapWebhookEventToTriggers(any());
    webhookEventMapperHelper.mapWebhookEventToTriggers(triggerMappingRequestData);
    verify(harnessRegistryWebhookEventToTriggerMapper, times(1)).mapWebhookEventToTriggers(any());
  }
}
