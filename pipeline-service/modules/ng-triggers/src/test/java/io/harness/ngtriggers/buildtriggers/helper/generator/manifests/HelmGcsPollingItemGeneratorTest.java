...
public class HelmGcsPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testHelmGcsPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ng_trigger_manifest_helm_gcs, false);
    ...
    PollingItem pollingItem = gcsHelmPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
  ...
  @Category(UnitTests.class)
  public void testHelmGcsPollingItemGenerationWithHelmV4() throws Exception {
    String triggerYaml = ng_trigger_manifest_helm_gcs.replace("helmVersion: V3", "helmVersion: V4");
    TriggerDetails triggerDetails =
    ...
    assertThat(pollingItem.getPollingPayloadData().getGcsHelmPayload().getHelmVersion().name()).isEqualTo("V4");
  }
}
