...
import static io.harness.ngtriggers.beans.source.artifact.store.BuildStoreType.GCS;
import static io.harness.ngtriggers.beans.source.artifact.store.BuildStoreType.HTTP;
import static io.harness.ngtriggers.beans.source.artifact.store.BuildStoreType.S3;
...
import io.harness.ngtriggers.beans.source.webhook.ScheduledTriggerSpec;
...
import io.harness.ngtriggers.beans.source.webhook.v2.github.event.GithubMergeQueueSpec;
...
import io.harness.ngtriggers.beans.source.webhook.v2.harness.event.HarnessMergeQueueSpec;
...
public class NGTriggerElementMapperV2Test extends CategoryTest {
  ...
  private String ngTriggerYaml_harness_merge_queue;
  private String ngTriggerYaml_github_merge_queue;
  ...
  public void setUp() throws IOException {
    ...
    ngTriggerYaml_harness_merge_queue =
        Resources.toString(Objects.requireNonNull(classLoader.getResource("ng-trigger-harness-merge-queue-v2.yaml")),
            StandardCharsets.UTF_8);
    ngTriggerYaml_github_merge_queue =
        Resources.toString(Objects.requireNonNull(classLoader.getResource("ng-trigger-github-merge-queue-v2.yaml")),
            StandardCharsets.UTF_8);
  ...
  @Category(UnitTests.class)
  public void testHarnessMergeQueue() throws Exception {
    NGTriggerConfigV2 config = ngTriggerElementMapper.toTriggerConfigV2(ngTriggerYaml_harness_merge_queue);

    WebhookTriggerConfigV2 webhookConfig = (WebhookTriggerConfigV2) config.getSource().getSpec();
    assertThat(webhookConfig.getType()).isEqualTo(WebhookTriggerType.HARNESS);

    HarnessSpec harnessSpec = (HarnessSpec) webhookConfig.getSpec();
    assertThat(harnessSpec.getType()).isEqualTo(HarnessTriggerEvent.MERGE_QUEUE);
    assertThat(HarnessMergeQueueSpec.class.isAssignableFrom(harnessSpec.getSpec().getClass())).isTrue();
    assertThat(harnessSpec.fetchGitAware().fetchRepoName()).isEqualTo("myrepo");
    assertThat(harnessSpec.fetchGitAware().fetchEvent()).isEqualTo(HarnessTriggerEvent.MERGE_QUEUE);
    assertThat(harnessSpec.fetchGitAware().fetchActions()).isEmpty();
    assertThat(harnessSpec.fetchGitAware().fetchAutoAbortPreviousExecutions()).isFalse();
  }

  @Test
  @Owner(developers = MEET)
  @Category(UnitTests.class)
  public void testGithubMergeQueue() throws Exception {
    NGTriggerConfigV2 config = ngTriggerElementMapper.toTriggerConfigV2(ngTriggerYaml_github_merge_queue);

    WebhookTriggerConfigV2 webhookConfig = (WebhookTriggerConfigV2) config.getSource().getSpec();
    assertThat(webhookConfig.getType()).isEqualTo(WebhookTriggerType.GITHUB);

    GithubSpec githubSpec = (GithubSpec) webhookConfig.getSpec();
    assertThat(githubSpec.getType()).isEqualTo(GithubTriggerEvent.MERGE_QUEUE);
    assertThat(GithubMergeQueueSpec.class.isAssignableFrom(githubSpec.getSpec().getClass())).isTrue();
    assertThat(githubSpec.fetchGitAware().fetchConnectorRef()).isEqualTo(CONN);
    assertThat(githubSpec.fetchGitAware().fetchRepoName()).isEqualTo("myrepo");
    assertThat(githubSpec.fetchGitAware().fetchEvent()).isEqualTo(GithubTriggerEvent.MERGE_QUEUE);
    assertThat(githubSpec.fetchGitAware().fetchActions()).isEmpty();
  ...
  public void testGenerateNgTriggerConfigV2Yaml() throws IOException {
    ...
    assertThatThrownBy(() -> ngTriggerElementMapper.generateNgTriggerConfigV2Yaml(ngTriggerEntity, true, null, false))
    ...
    assertThat(ngTriggerElementMapper.generateNgTriggerConfigV2Yaml(ngTriggerEntity, true, null, false))
  ...
  public void testToNGTriggerWebhookEvent() {
    ...
    headerConfig = HeaderConfig.builder()
                       .key("X-Harness-Artifact-Registry-Trigger")
                       .values(Collections.singletonList("testvalues"))
                       .build();
    headerConfigs.add(headerConfig);
    when(webhookEventPayloadParser.containsHeaderKey(any(), eq(X_HARNESS_ARTIFACT_REGISTRY_TRIGGER))).thenReturn(true);
    actualTriggerWebhookEvent =
        ngTriggerElementMapper.toNGTriggerWebhookEvent("account", "org", "project", "payload", headerConfigs, null)
            .build();
    assertThat(actualTriggerWebhookEvent.getSourceRepoType())
        .isEqualTo(String.valueOf(WebhookTriggerType.HARNESS_ARTIFACT_REGISTRY));

    when(webhookEventPayloadParser.containsHeaderKey(any(), eq(X_HARNESS_ARTIFACT_REGISTRY_TRIGGER))).thenReturn(false);
  ...
  public void testToTriggerDetails() throws IOException {
    ...
    NGTriggerEntity ngTriggerEntity = NGTriggerEntity.builder()
                                          ...
                                          .withServiceV2(true)
                                          .pollInterval("")
                                          .stagesToExecuteV2(ParameterField.createValueField(null))
    ...
    NGTriggerConfigV2 ngTriggerConfigV2 =
        NGTriggerConfigV2.builder()
            ...
            .inputYaml(inputYaml + "\n")
            .inputSetRefs(ParameterField.createValueField(null))
            .inputSetBranchName(ParameterField.createValueField(null))
            .identifier("first_trigger")
            .name("first trigger")
            .enabled(true)
            .stagesToExecute(ParameterField.createValueField(null))
    ...
    assertThat(ngTriggerElementMapper.toTriggerDetails("account", "org", "project", null, ngCustomTriggerYaml2, true))
  ...
  public void testToMetadataMultiRegionArtifact() {
    ...
    NGTriggerMetadata ngTriggerMetadata =
        ngTriggerElementMapper.toMetadata(ngTriggerSourceV2, "account", "org", "project");
  ...
  @Category(UnitTests.class)
  public void testToMetadataHarnessArtifactRegistry() {
    ArtifactTypeSpecWrapper artifactTypeSpecWrapper = new ArtifactTypeSpecWrapper();
    artifactTypeSpecWrapper.setSpec(DockerRegistrySpec.builder().build());
    NGTriggerSourceV2 ngTriggerSourceV2 =
        NGTriggerSourceV2.builder()
            .type(WEBHOOK)
            .spec(WebhookTriggerConfigV2.builder()
                      .type(HARNESS_ARTIFACT_REGISTRY)
                      .spec(HarnessArtifactRegistrySpec.builder()
                                .type(HarTriggerEvent.ARTIFACT)
                                .spec(HarArtifactEventSpec.builder()
                                          .actions(Arrays.asList(HarArtifactAction.CREATION))
    ...
    NGTriggerMetadata ngTriggerMetadata =
        ngTriggerElementMapper.toMetadata(ngTriggerSourceV2, "account", "org", "project");
    assertThat(ngTriggerMetadata.getWebhook()).isNotNull();
    assertThat(ngTriggerMetadata.getWebhook().getType()).isEqualTo("HARNESS_ARTIFACT_REGISTRY");
    assertThat(ngTriggerMetadata.getWebhook().getHarMetadata()).isNotNull();
    assertThat(ngTriggerMetadata.getWebhook().getHarMetadata().getRegistryName()).isEqualTo("registryName");
    assertThat(ngTriggerMetadata.getWebhook().getHarMetadata().getActions().get(0))
        .isEqualTo(HarArtifactAction.CREATION);
  }
  ...
  public void testCopyEntityFieldsOutsideOfYml() {
    ...
    ngTriggerElementMapper.copyEntityFieldsOutsideOfYml(existingEntity, newEntity, null, false);
    ...
    assertThatThrownBy(
        () -> ngTriggerElementMapper.copyEntityFieldsOutsideOfYml(finalExistingEntity, finalNewEntity, null, false))
        .isInstanceOf(InvalidRequestException.class)
  ...
  public void testTriggerEntityCronHasNextIterations() {
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "orgId", "projId", null, ngTriggerYaml_cron, false)
            .getNgTriggerEntity();
  ...
  public void testToResponseDTO() {
    ...
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_gitlab_pr, false)
            .getNgTriggerEntity();
    NGTriggerResponseDTO responseDTO = ngTriggerElementMapper.toResponseDTO(ngTriggerEntity, null, false);
    ...
    assertThat(responseDTO.getWebhookUrl()).isEqualTo("https://app.harness.io/ng/api/webhook?accountIdentifier=accId");
  }
  ...
  public void testToErrorDTO() {
    ...
    NGTriggerResponseDTO errorDTO = ngTriggerElementMapper.toErrorDTO(exception, null, false);
  ...
  public void testToResponseDTOGitPolling() {
    ...
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_gitpolling, false)
            .getNgTriggerEntity();
    NGTriggerResponseDTO responseDTO = ngTriggerElementMapper.toResponseDTO(ngTriggerEntity, null, false);
    assertThat(responseDTO.getAccountIdentifier()).isEqualTo(ngTriggerEntity.getAccountId());
    assertThat(responseDTO.getTargetIdentifier()).isEqualTo(ngTriggerEntity.getTargetIdentifier());
    ...
    assertThat(responseDTO.getWebhookUrl()).isNull();
  }
  ...
  public void testGetWebhookUrl() {
    ...
    NGTriggerDetailsResponseDTO ngTriggerDetailsResponseDTO =
        ngTriggerElementMapper.toNGTriggerDetailsResponseDTO(ngTriggerEntity, false, true, false, true, null, false);
    ...
    // baseUrl: "https://app.harness.io/pipeline/api/"
    ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "orgId", "projId", null, ngTriggerYaml_gitlab_pr, false)
            .getNgTriggerEntity();
    ngTriggerDetailsResponseDTO =
        ngTriggerElementMapper.toNGTriggerDetailsResponseDTO(ngTriggerEntity, false, true, true, true, null, false);
    assertThat(ngTriggerDetailsResponseDTO.getWebhookUrl())
        .isEqualTo("https://app.harness.io/ng/api/webhook?accountIdentifier=accId");
    ...
    ngTriggerEntity = ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_custom, false)
                          .getNgTriggerEntity();
    ngTriggerDetailsResponseDTO =
        ngTriggerElementMapper.toNGTriggerDetailsResponseDTO(ngTriggerEntity, false, true, true, true, null, false);
    // baseUrl: "https://app.harness.io/pipeline/api"
    assertThat(ngTriggerDetailsResponseDTO.getWebhookUrl())
        .isEqualTo("https://app.harness.io/pipeline/api/webhook/custom/"
            + "v2?accountIdentifier=accId&orgIdentifier=org&projectIdentifier=proj&pipelineIdentifier=pipeline&"
            + "triggerIdentifier=first_trigger");
  ...
  public void testGetV3WebhookUrl() {
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_custom, false)
            .getNgTriggerEntity();
    ...
    // baseUrl: "https://app.harness.io/pipeline/api"
    assertThat(ngTriggerDetailsResponseDTO.getWebhookUrl())
        .isEqualTo("https://app.harness.io/pipeline/api/webhook/custom/webhookToken/"
            + "v3?accountIdentifier=accId&orgIdentifier=org&projectIdentifier=proj&pipelineIdentifier=pipeline&"
            + "triggerIdentifier=first_trigger");
  }
  ...
  public void testGetWebhookCurl() throws IOException {
    ...
    ngTriggerEntity.setCustomWebhookToken("webhookToken");
    NGTriggerDetailsResponseDTO ngTriggerDetailsResponseDTO =
        ngTriggerElementMapper.toNGTriggerDetailsResponseDTO(ngTriggerEntity, false, true, true, false, null, false);
    // baseUrl: "https://app.harness.io/pipeline/api"
    assertThat(ngTriggerDetailsResponseDTO.getWebhookCurlCommand())
        .isEqualTo("curl -X POST -H 'content-type: application/json' --url "
            + "'https://app.harness.io/pipeline/api/webhook/custom/webhookToken/"
            + "v3?accountIdentifier=accId&orgIdentifier=org&projectIdentifier=proj&pipelineIdentifier=pipeline&"
            + "triggerIdentifier=first_trigger' -d '{\"sample_key\": \"sample_value\"}'");
    ngTriggerDetailsResponseDTO =
        ngTriggerElementMapper.toNGTriggerDetailsResponseDTO(ngTriggerEntity, false, true, true, true, null, false);
    // baseUrl: "https://app.harness.io/pipeline/api"
    assertThat(ngTriggerDetailsResponseDTO.getWebhookCurlCommand())
        .isEqualTo("curl -X POST -H 'content-type: application/json' -H 'X-Api-Key: sample_api_key' --url "
            + "'https://app.harness.io/pipeline/api/webhook/custom/webhookToken/"
            + "v3?accountIdentifier=accId&orgIdentifier=org&projectIdentifier=proj&pipelineIdentifier=pipeline&"
            + "triggerIdentifier=first_trigger' -d '{\"sample_key\": \"sample_value\"}'");
  }
  ...
  public void testArtifactTriggerToResponseDTO() {
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_artifact_gcr, false)
            .getNgTriggerEntity();
    NGTriggerResponseDTO responseDTO = ngTriggerElementMapper.toResponseDTO(ngTriggerEntity, null, false);
    assertThat(responseDTO.getYaml()).isEqualTo(ngTriggerEntity.getYaml());
    assertThat(responseDTO.getType()).isEqualTo(ngTriggerEntity.getType());
  ...
  public void testManifestTriggerToResponseDTO() {
    NGTriggerEntity ngTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_manifest, false)
            .getNgTriggerEntity();
    NGTriggerResponseDTO responseDTO = ngTriggerElementMapper.toResponseDTO(ngTriggerEntity, null, false);
    assertThat(responseDTO.getYaml()).isEqualTo(ngTriggerEntity.getYaml());
    assertThat(responseDTO.getType()).isEqualTo(ngTriggerEntity.getType());
  ...
  public void testCopyFieldsForMultiArtifactTrigger() {
    ...
    NGTriggerEntity existingNgTriggerEntity =
        ngTriggerElementMapper.toTriggerDetails("accId", "org", "proj", null, ngTriggerYaml_multi_region_artifact, true)
            .getNgTriggerEntity();
    ...
    ngTriggerElementMapper.copyEntityFieldsOutsideOfYml(existingNgTriggerEntity, newNgTriggerEntity, null, false);
  ...
  @Category(UnitTests.class)
  public void testGenerateWebhookUrl() throws IOException {
    NGTriggerEntity ngTriggerEntity =
        NGTriggerEntity.builder()
            .accountId("account")
            .orgIdentifier("org")
                ...
                NGTriggerMetadata.builder()
                    .webhook(
                        WebhookMetadata.builder()
                            .custom(
                                CustomMetadata.builder().customAuthTokenType("123").customAuthTokenType("234").build())
                            .build())
                    .build())
            .build();
    when(webhookConfigProvider.getCustomApiBaseUrl()).thenReturn("http://localhost:8181");

    String result = ngTriggerElementMapper.generateWebhookUrl(ngTriggerEntity, null, false);
    assertThat(result).isEqualTo("http://localhost:8181/webhook/custom/"
        + "v2?accountIdentifier=account&orgIdentifier=org&projectIdentifier=project&"
        + "pipelineIdentifier=pipeline3&triggerIdentifier=id1");
  }
}
