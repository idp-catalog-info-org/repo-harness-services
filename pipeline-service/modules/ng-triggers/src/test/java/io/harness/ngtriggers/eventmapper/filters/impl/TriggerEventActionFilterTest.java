...
public class TriggerEventActionFilterTest extends CategoryTest {
  ...
  public void setUp() throws IOException {
    initMocks(this);
    doReturn(emptyMap()).when(scopeResolutionHelper).getScopeInfos(anyString(), anyList());
  }
  ...
  public void applyFilterTest() {
    ...
    // No payload match
    doReturn(ngTriggerConfigV2).when(ngTriggerElementMapper).toTriggerConfigV2(triggerEntityGithub, null, true);
  ...
  public void applyFilterTest_Harness_PR() {
    ...
    // No payload match
    doReturn(ngTriggerConfigV2).when(ngTriggerElementMapper).toTriggerConfigV2(triggerEntityHarness, null, true);
    WebhookEventMappingResponse webhookEventMappingResponse = filter.applyFilter(
        FilterRequestData.builder()
