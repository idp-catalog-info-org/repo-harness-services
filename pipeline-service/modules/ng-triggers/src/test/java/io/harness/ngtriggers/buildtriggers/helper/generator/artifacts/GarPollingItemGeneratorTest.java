...
public class GarPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testGcrPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_gar, false);
    ...
    PollingItem pollingItem = garPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
