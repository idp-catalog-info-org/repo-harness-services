...
public class TriggerFunctorTest extends CategoryTest {
  private String bigPayload = "{\n"
      ...
      + " \"Message\" : "
      + "\"{\\\"Records\\\":[{\\\"awsRegion\\\":\\\"eu-central-1\\\",\\\"codecommit\\\":{\\\"references\\\":[{"
      + "\\\"commit\\\":\\\"f3c8a35a6e83e9ab85c05845c6731c7990de8672\\\",\\\"ref\\\":\\\"refs/heads/"
      + "main\\\"}]},\\\"customData\\\":null,\\\"eventId\\\":\\\"58939308-51e9-4dad-abd5-97c8dabe3815\\\","
      + "\\\"eventName\\\":\\\"ReferenceChanges\\\",\\\"eventPartNumber\\\":1,\\\"eventSource\\\":\\\"aws:"
      + "codecommit\\\",\\\"eventSourceARN\\\":\\\"arn:aws:codecommit:eu-central-1:448640225317:test\\\","
      + "\\\"eventTime\\\":\\\"2021-03-23T20:42:23.131+0000\\\",\\\"eventTotalParts\\\":1,"
      + "\\\"eventTriggerConfigId\\\":\\\"96765393-40e7-4f49-aed7-64c9ba599195\\\",\\\"eventTriggerName\\\":"
      + "\\\"push\\\",\\\"eventVersion\\\":\\\"1.0\\\",\\\"userIdentityARN\\\":\\\"arn:aws:iam::448640225317:user/"
      + "vault-okta-aleksandar.radisavljevic@harness.io-a1616531435-217\\\"}]}\",\n"
      + " \"Timestamp\" : \"2021-03-23T20:42:23.163Z\",\n"
      + " \"SignatureVersion\" : \"1\",\n"
      + " \"Signature\" : "
      + "\"qWIfB0MLIwWfGGEe+JgloCOL47LdizJU7Y9ETbz6jIeH/"
      + "NNkyBYtzys18Q0TyJOsKzagddG1wqeS0K5n0Ewz2ZZys5nQNt3EAgagW8SrajWnToSuhFhAvJxxBhBsnHAoU7pV+"
      + "4cZIWLKhF8ro4otm9xuDxnLD2sWTR8+xXzVdJJGDhcbxnykNJZ05O6kV/"
      + "TEeCSCUBdQkhVZmyKM8XrN39QMnC8zZkFXXE9ssy51zVuH7IpSsq44pmEZQYA5lFXVHyu7p5fjih3Et03/"
      + "IJg5i77zCjGRbjeRcER1JPlL74d+0U5jfINDRYSfc/gDBKQ3/zArLF12REO1orivX76NIQ==\","
      + " \"SigningCertURL\" : "
      + "\"https://sns.eu-central-1.amazonaws.com/SimpleNotificationService-010a507c1833636cd94bdb98bd93083a.pem\",\n"
      + " \"UnsubscribeURL\" : "
  ...
  public void testGetMetadataWebhook() {
    ...
    when(metadataService.findByPlanExecutionId(any(), any()))
        .thenReturn(Optional.of(PlanExecutionMetadata.builder()
                                    ...
                                    .build()));
    when(planExecutionService.getWithFieldsIncluded("", Set.of(PlanExecutionKeys.triggerHeader)))
        .thenReturn(PlanExecution.builder().triggerHeader(headerConfigs).build());
    ...
    assertThat(expressionEvaluator.renderExpression("<+trigger.header>"))
        .isEqualTo("{\"X-GitHub-Delivery\":\"c4186fb6-1d22-11ee-8736-3f7c21bf83f1\",\"Accept\":\"*/"
            + "*\",\"X-GitHub-Hook-ID\":\"402904149\",\"User-Agent\":\"GitHub-Hookshot/703fc34,GitHub-Hookshot/"
            + "703fc35\",\"Host\":\"localhost:1010\",\"X-GitHub-Hook-Installation-Target-ID\":\"587948287\","
            + "\"Accept-Encoding\":\"gzip,deflate,br\",\"X-GitHub-Event\":\"push\",\"X-Hub-Signature\":\"sha1="
            + "3e2d63c23863baa66f030c789537a6275744b3c7\",\"X-Hub-Signature-256\":\"sha256="
            + "3213c8dee847243acbdb71096223f6737d98c9d72ca7ae2b24cacc0f468fa0cb\",\"X-GitHub-Hook-Installation-"
            + "Target-Type\":\"repository\",\"content-type\":\"application/json\"}");
  ...
  public void testExpressionEvaluatorForEmptyTriggerPayload() {
    ...
    PlanExecutionMetadataService metadataService = mock(PlanExecutionMetadataServiceImpl.class);
    PlanExecutionService planExecutionService = mock(PlanExecutionServiceImpl.class);
    when(metadataService.findByPlanExecutionId(any(), any()))
        .thenReturn(Optional.of(
  ...
  public static class SampleEvaluator extends EngineExpressionEvaluator {
    ...
    protected void initialize() {
      ...
      addToContext(EngineExpressionEvaluator.ENABLED_FEATURE_FLAGS_KEY,
          EngineExpressionEvaluator.CDS_DISABLE_FALLBACK_EXPRESSION_ENGINE);
      super.initialize();
    }
  }
}
