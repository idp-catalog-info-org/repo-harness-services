...
public class S3PollingItemGeneratorTest extends CategoryTest {
  ...
  public void testS3PollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_s3, false);
    ...
    PollingItem pollingItem = s3PollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
