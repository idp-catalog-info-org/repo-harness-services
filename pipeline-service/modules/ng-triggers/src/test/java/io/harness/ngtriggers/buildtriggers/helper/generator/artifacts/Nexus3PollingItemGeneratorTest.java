...
public class Nexus3PollingItemGeneratorTest extends CategoryTest {
  ...
  public void testNexus3PollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_gcs, false);
    ...
    PollingItem pollingItem = nexus3PollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
