...
public class TriggerReferenceHelperTest extends CategoryTest {
  ...
  public void testGetReferences() {
    NGTriggerConfigV2 ngTriggerConfigV2 =
        NGTriggerConfigV2.builder()
            ...
            .inputSetRefs(ParameterField.createValueField(Collections.singletonList(inputSetId)))
    ...
    assertThat(triggerReferenceHelper.getReferences(accountId, ngTriggerConfigV2, null, false))
        .isEqualTo(entityDetailProtoDTOList);
  }
  ...
  public void testGetReferencesForCustomTrigger() {
    ...
    List<EntityDetailProtoDTO> resultRntityDetailProtoDTOList =
        triggerReferenceHelper.getReferences(accountId, ngTriggerConfigV2, null, false);
    ...
    NGTriggerConfigV2 ngTriggerConfigV2 =
        NGTriggerConfigV2.builder()
            ...
            .source(NGTriggerSourceV2.builder()
                        ...
                        .build())
            .build();
    List<EntityDetailProtoDTO> inputSetDetails = triggerReferenceHelper.getReferredInputSetRefsDetails(
        ngTriggerConfigV2, accountId, Collections.singletonList(inputSetId), null, false);
    ...
    NGTriggerConfigV2 ngTriggerConfigV2 =
        NGTriggerConfigV2.builder()
            ...
            .source(NGTriggerSourceV2.builder()
                        ...
                        .build())
            .build();
    EntityDetailProtoDTO secretDetail =
        triggerReferenceHelper.getReferredSecretDetails(ngTriggerConfigV2, accountId, null, false);
  ...
  public void testGetReferredConnectorDetails() {
    ...
    EntityDetailProtoDTO connectorDetails =
        triggerReferenceHelper.getReferredConnectorDetails(ngTriggerConfigV2, accountId, connectorId, null, false);
