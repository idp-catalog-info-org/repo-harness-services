  ...
  public TriggerWebhookEvent getTriggerWehookEventForAwsCodeCommitPush() {
    return TriggerWebhookEvent.builder()
        .payload("{\n"
            ...
            + "\\\"commit\\\":\\\"f70e8226cac251f6116315984b6e9ed7098ce586\\\",\\\"ref\\\":\\\"refs/heads/"
            + "main\\\"}]},\\\"customData\\\":null,\\\"eventId\\\":\\\"6363f269-6070-4999-9b55-52c4e40d74b0\\\","
            + "\\\"eventName\\\":\\\"ReferenceChanges\\\",\\\"eventPartNumber\\\":1,\\\"eventSource\\\":\\\"aws:"
            + "codecommit\\\",\\\"eventSourceARN\\\":\\\"arn:aws:codecommit:eu-central-1:44864EXAMPLE:test\\\","
            + "\\\"eventTime\\\":\\\"2021-03-21T09:22:37.156+0000\\\",\\\"eventTotalParts\\\":1,"
            + "\\\"eventTriggerConfigId\\\":\\\"e15f4b05-bec2-47f8-9505-c10df79f4c42\\\",\\\"eventTriggerName\\\":"
            + "\\\"push\\\",\\\"eventVersion\\\":\\\"1.0\\\",\\\"userIdentityARN\\\":\\\"arn:aws:iam::44864EXAMPLE:"
            + "user/vault-okta-username.lastname@gitmail.io-a1616318518-9029\\\"}]}\",\n"
            + "  \"Timestamp\" : \"2021-03-21T09:22:37.198Z\",\n"
            + "  \"SignatureVersion\" : \"1\",\n"
            + "  \"Signature\" : "
            + "\"DnmP7IBvzHPEqm8054phY6aQztpvTktsBNTLqOeX1j48t65vFKxpyrhFvOKDh6vispOFZO+"
            + "RgJjTvG7vq9LEEMtns56sLoNcZUYtyydRQC3KQdQjzFhPx+M/oZX81WxWc3gIUVNVteIF4izObmi9NUrU1ioiW+D/"
            + "IBFVVbzW7Yw3TJT8SeF6verQdImDBuQ7izPVEPzz1RsZH/"
            + "9DN8iQg5F5rMnQwADZzjNLLQ+hpbh0Addy40x89TMzjSYXYLSOS24hxxpnftWP9LTrZVlekwMz+"
            + "NqFMhX6mzKWXI80mYnRqaCwDdy7ZaEskJvW+9gByl05MH++b6ZJGdIhmgyVMw==\",\n"
            + "  \"SigningCertURL\" : "
            + "\"https://sns.eu-central-1.amazonaws.com/"
            + "SimpleNotificationService-010a507c1833636cd94bdb98bd93083a.pem\",\n"
            + "  \"UnsubscribeURL\" : "
            + "\"https://sns.eu-central-1.amazonaws.com/"
            + "?Action=Unsubscribe&SubscriptionArn=arn:aws:sns:eu-central-1:44864EXAMPLE:aws_cc_push_trigger:"
            + "05b595dd-06fb-4002-b409-80a7a7bbfda6\"\n"
            + "}")
        .headers(
