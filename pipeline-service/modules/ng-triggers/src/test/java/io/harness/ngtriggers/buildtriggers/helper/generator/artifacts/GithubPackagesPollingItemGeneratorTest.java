...
public class GithubPackagesPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testGithubPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_github, false);
    ...
    PollingItem pollingItem = githubPackagesPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
