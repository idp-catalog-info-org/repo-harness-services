...
public class HelmS3PollingItemGeneratorTest extends CategoryTest {
  ...
  public void testHelmS3PollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ng_trigger_manifest_helm_s3, false);
    ...
    PollingItem pollingItem = s3HelmPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
  ...
  @Category(UnitTests.class)
  public void testHelmS3PollingItemGenerationWithHelmV4() throws Exception {
    String triggerYaml = ng_trigger_manifest_helm_s3.replace("helmVersion: V3", "helmVersion: V4");
    TriggerDetails triggerDetails =
    ...
    assertThat(pollingItem.getPollingPayloadData().getS3HelmPayload().getHelmVersion().name()).isEqualTo("V4");
  }
}
