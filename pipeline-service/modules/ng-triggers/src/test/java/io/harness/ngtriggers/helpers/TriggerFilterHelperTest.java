...
public class TriggerFilterHelperTest extends CategoryTest {
  ...
  @Mock HarWebhookFilter harWebhookFilter;
  ...
  public void testCreateCriteriaForGetList() {
    ...
    assertThat(TriggerFilterHelper
                   .createCriteriaForGetList(
                       "acc", "org", "proj", "pipeline", NGTriggerType.WEBHOOK, null, "", null, null, null, false)
                   .toString())
    ...
    Criteria criteria = TriggerFilterHelper.createCriteriaForGetList(
        "acc", "org", "proj", "pipeline", null, null, "", ngTriggersFilterPropertiesDTO, null, null, false);
    assertEquals(criteria.getCriteriaObject().toString(),
        "Document{{accountId=acc, orgIdentifier=org, projectIdentifier=proj, targetIdentifier=pipeline, "
            + "$and=[Document{{$or=[Document{{name=name}}]}}]}}");
    ...
    assertThatThrownBy(()
                           -> TriggerFilterHelper.createCriteriaForGetList("acc", "org", "proj", "pipeline", null, null,
                               "abc", finalNgTriggersFilterPropertiesDTO, null, null, false))
    ...
    assertThat(criteria2.getCriteriaObject().toString())
        .isEqualTo("Document{{accountId=acc, orgIdentifier=org, projectIdentifier=proj, targetIdentifier=pipeline, "
            + "identifier=Document{{$in=[identifier]}}}}");
    ...
    Criteria criteria3 = TriggerFilterHelper.createCriteriaForGetList(
        "acc", "org", "proj", "pipeline", null, null, null, ngTriggersFilterPropertiesDTO, null, null, false);
    assertEquals(criteria3.getCriteriaObject().toString(),
        "Document{{accountId=acc, orgIdentifier=org, projectIdentifier=proj, targetIdentifier=pipeline, "
            + "type=Document{{$in=[WEBHOOK]}}}}");
  }
  ...
  public void testCreateCriteriaForCustomWebhookTriggerGetList() {
    ...
    TriggerWebhookEvent triggerWebhookEvent = TriggerWebhookEvent.builder()
                                                  ...
                                                  .build();
    assertThat(TriggerFilterHelper.createCriteriaForCustomWebhookTriggerGetList(triggerWebhookEvent, null, true, false)
                   .toString())
        .isEqualTo(expected.toString());
  }
  ...
  public void testCreateCriteriaFormWebhookTriggerGetListByRepoType() {
    ...
    assertThat(TriggerFilterHelper.createCriteriaFormWebhookTriggerGetListByRepoType(triggerWebhookEvent, null, true)
                   .toString())
        .isEqualTo(expected.toString());
  }
  ...
  public void testGetUpdateOperations() {
    ...
    expected.set(NGTriggerEntityKeys.pipelineBranchName, null);
    expected.set(NGTriggerEntityKeys.harnessVersion, "0");
    expected.set(NGTriggerEntityKeys.executorInfo, null);
    ...
    expected.set(NGTriggerEntityKeys.cronAndSemantics, true);
    expected.set(NGTriggerEntityKeys.isUnifiedPipelineFlow, false);
  ...
  public void testCreateCriteriaForTriggerEventCountLastNDays() {
    ...
    assertThat(
        TriggerFilterHelper
            .createCriteriaForTriggerEventCountLastNDays("acc", "org", "proj", "trigger", "pipeline", 1l, null, false)
            .toString())
        .isEqualTo(expected.toString());
  }
                ...
                ParseWebhookResponse.newBuilder()
                    .setComment(
                        IssueCommentHook.newBuilder()
                            ...
                            .build())
                    .build())
            .originalEvent(originalEventBuilder.sourceRepoType(HARNESS_ARTIFACT_REGISTRY.name()).build())
            .build());
    assertThat(webhookTriggerFilters).isNotNull();
    assertThat(webhookTriggerFilters)
        .containsExactlyInAnyOrder(harWebhookFilter, sourceRepoTypeTriggerFilter, payloadConditionsTriggerFilter,
            headerTriggerFilter, jexlConditionsTriggerFilter);
  }
