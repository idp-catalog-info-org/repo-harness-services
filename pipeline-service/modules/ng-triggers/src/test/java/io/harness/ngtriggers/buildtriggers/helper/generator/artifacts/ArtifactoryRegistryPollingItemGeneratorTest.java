...
public class ArtifactoryRegistryPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testArtifactoryGenericPollingItemGeneration_pipelineContainsFixedValuesExceptArtifactoryPath()
    ...
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_artifactory, false);
    ...
    PollingItem pollingItem =
        artifactoryRegistryPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
  ...
  testArtifactoryGenericPollingItemGenerationArtifactFilter_pipelineContainsFixedValuesExceptArtifactoryPath()
    ...
    TriggerDetails triggerDetails = ngTriggerElementMapper.toTriggerDetails(
        "acc", "org", "proj", null, ngTriggerYaml_artifact_artifactFilter_artifactory, false);
    triggerDetails.getNgTriggerEntity().getMetadata().getBuildMetadata().setPollingConfig(
        PollingConfig.builder().signature("sig1").build());
    BuildTriggerOpsData buildTriggerOpsData = buildTriggerHelper.generateBuildTriggerOpsDataForArtifact(
  ...
  public void testArtifactoryDockerPollingItemGeneration_pipelineContainsFixedValuesExceptArtifactoryPath()
      throws Exception {
    TriggerDetails triggerDetails = ngTriggerElementMapper.toTriggerDetails(
        "acc", "org", "proj", null, ngTriggerYaml_artifact_artifactory_docker, false);
    triggerDetails.getNgTriggerEntity().getMetadata().getBuildMetadata().setPollingConfig(
        PollingConfig.builder().signature("sig1").build());
    BuildTriggerOpsData buildTriggerOpsData = buildTriggerHelper.generateBuildTriggerOpsDataForArtifact(
