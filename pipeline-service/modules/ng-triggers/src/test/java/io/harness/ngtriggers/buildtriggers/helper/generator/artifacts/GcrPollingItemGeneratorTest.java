...
public class GcrPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testGcrPollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_gcr, false);
    ...
    PollingItem pollingItem = gcrPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
