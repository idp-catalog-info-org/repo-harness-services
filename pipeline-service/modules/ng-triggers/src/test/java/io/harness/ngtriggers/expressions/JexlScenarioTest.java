...
public class JexlScenarioTest extends CategoryTest {
  ...
  public void testSimplePayload() {
    assertThat(
        WebhookTriggerFilterUtils.checkIfJexlConditionsMatch(
            getTriggerExpressionEvaluator(null, emptyList(), smallPayload), "<+trigger.payload.arr>.contains(\"abc\")"))
        .isTrue();
  }
  ...
  public void testSimpleNegative() {
    assertThat(WebhookTriggerFilterUtils.checkIfJexlConditionsMatch(
                   getTriggerExpressionEvaluator(null, emptyList(), smallPayload), "false"))
        .isFalse();
  }
  ...
  public void testJexlAnd() {
    assertThat(WebhookTriggerFilterUtils.checkIfJexlConditionsMatch(
                   getTriggerExpressionEvaluator(null, emptyList(), bigPayload),
  ...
  private TriggerExpressionEvaluator getTriggerExpressionEvaluator(
      ParseWebhookResponse parseWebhookResponse, List<HeaderConfig> headerConfigs, String payload) {
    return WebhookTriggerFilterUtils.generatorPMSExpressionEvaluator(parseWebhookResponse, headerConfigs, payload);
  }
