...
public class BambooPollingItemGeneratorTest extends CategoryTest {
  ...
  public void testBambooPollingItemGeneration_pipelineContainsFixedValuesExceptTest() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_bamboo, false);
    ...
    PollingItem pollingItem = bambooPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
