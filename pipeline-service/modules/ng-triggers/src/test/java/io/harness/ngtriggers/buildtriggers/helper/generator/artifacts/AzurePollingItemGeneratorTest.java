...
public class AzurePollingItemGeneratorTest extends CategoryTest {
  ...
  public void testAzurePollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_ami, false);
    ...
    PollingItem pollingItem = azureArtifactsPollingItemGenerator.generatePollingItem(buildTriggerOpsData, null, false);
