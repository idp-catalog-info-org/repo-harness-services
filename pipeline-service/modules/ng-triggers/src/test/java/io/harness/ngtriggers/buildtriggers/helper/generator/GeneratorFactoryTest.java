...
public class GeneratorFactoryTest extends CategoryTest {
  ...
  public void setUp() throws IOException {
    ...
    generatorFactory = new GeneratorFactory(buildTriggerHelper, httpHelmPollingItemGenerator,
        ...
        gceImagePollingItemGenerator, googleCloudStoragePollingItemGenerator, bambooPollingItemGenerator);
  ...
  public void testGCEImagePollingItemGeneration_pipelineContainsFixedValuesExceptTag() throws Exception {
    assertType("gce_pipeline_artifact_snippet_runtime_all.yaml", "ng-trigger-artifact-gce.yaml",
        GCEImagePollingItemGenerator.class);
  }
  ...
  public void testMultiRegionDockerRegistryPollingItemGeneration_pipelineContainsFixedValuesExceptTag()
    ...
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, triggerYaml, true);
  ...
  private void assertType(String pipelinePath, String triggerYmlPath, Class expectedGeneratorClass) throws Exception {
    ...
    TriggerDetails triggerDetails =
        ngTriggerElementMapper.toTriggerDetails("acc", "org", "proj", null, ngTriggerYaml_artifact_ecr, false);
