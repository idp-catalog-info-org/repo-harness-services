...
public class TriggerUpdateEvent implements Event {
  ...
  public ResourceScope getResourceScope() {
    if (newTriggerEntity.getUniqueId() != null) {
      return new ProjectScope(accountIdentifier, orgIdentifier, projectIdentifier, newTriggerEntity.getUniqueId());
    }
  ...
  public Resource getResource() {
    ...
    return Resource.builder()
        ...
        .labels(labels)
        .uniqueId(newTriggerEntity.getUniqueId())
        .build();
  }
