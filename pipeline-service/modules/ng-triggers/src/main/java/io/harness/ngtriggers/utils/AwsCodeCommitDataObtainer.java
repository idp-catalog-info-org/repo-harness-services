...
public class AwsCodeCommitDataObtainer implements GitProviderBaseDataObtainer {
  ...
  @VisibleForTesting
  AwsCodeCommitApiTaskResponse buildAndExecuteAwsCodeCommitDelegateTask(WebhookPayloadData webhookPayloadData,
      TriggerDetails details, String connectorIdentifier, ScopeInfo scopeInfo, boolean isParentIdQueryingEnabled) {
