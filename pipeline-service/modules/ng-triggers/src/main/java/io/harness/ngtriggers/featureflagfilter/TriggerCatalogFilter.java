...
import static io.harness.beans.FeatureName.CDS_EVENT_BRIDGE_WEBHOOK;
import static io.harness.beans.FeatureName.CODE_ENABLED;
import static io.harness.beans.FeatureName.HAR_TRIGGERS;
import static io.harness.beans.FeatureName.NG_SVC_ENV_REDESIGN;
import static io.harness.beans.FeatureName.SYSTEM_EVENTS_TRIGGERS;
...
public class TriggerCatalogFilter {
  ...
  public TriggerCatalogFilter() {
    ...
    enumTypeFeatureFlagMap.put(CDS_EVENT_BRIDGE_WEBHOOK, Sets.newHashSet(TriggerCatalogType.EVENT_BRIDGE));
    enumTypeFeatureFlagMap.put(HAR_TRIGGERS, Sets.newHashSet(TriggerCatalogType.HARNESS_ARTIFACT_REGISTRY));
    enumTypeFeatureFlagMap.put(SYSTEM_EVENTS_TRIGGERS, Sets.newHashSet(TriggerCatalogType.SYSTEM_EVENT));
  }
