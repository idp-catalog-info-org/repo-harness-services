...
public interface NGTriggerRepositoryCustom {
  ...
  TriggerUpdateCount toggleTriggerInBulk(
  ...
  List<TriggerCountWithAccountAndTriggerTypeResult> aggregateActiveTriggersCountPerAccountByTriggerType();

  List<String> findAllAccountIdsWithTriggers();

  List<OrphanScanGroupResult> aggregateForOrphanScan();
