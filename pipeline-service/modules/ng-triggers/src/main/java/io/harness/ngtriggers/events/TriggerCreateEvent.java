...
public class TriggerCreateEvent implements Event {
  ...
  public ResourceScope getResourceScope() {
    if (triggerEntity.getUniqueId() != null) {
      return new ProjectScope(accountIdentifier, orgIdentifier, projectIdentifier, triggerEntity.getUniqueId());
    }
  ...
  public Resource getResource() {
    ...
    return Resource.builder()
        ...
        .labels(labels)
        .uniqueId(triggerEntity.getUniqueId())
        .build();
  }
