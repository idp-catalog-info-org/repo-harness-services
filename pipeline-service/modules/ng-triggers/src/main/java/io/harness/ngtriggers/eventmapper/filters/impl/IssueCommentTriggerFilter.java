...
public class IssueCommentTriggerFilter implements TriggerFilter {
  ...
  public TriggerEventResponse getFailureResponse(FilterRequestData filterRequestData) {
    // todo: check if message is proper
    return TriggerEventResponseHelper.toResponse(NO_MATCHING_TRIGGER_FOR_PAYLOAD_CONDITIONS,
        ...
        "Failed to update Webhook payload with PR Details: ", null);
  }
  ...
  public List<TriggerDetails> applyFilterV2(
    ...
    try {
      ...
      log.error("Failed while updating Webhook payload with PR details for IssueComment event.");
      throw e;
    }
