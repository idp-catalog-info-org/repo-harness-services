...
public abstract class SCMFilePathEvaluator {
  ...
  public abstract List<TriggerFilepathResponse> execute(FilterRequestData filterRequestData,
  ...
  public ScmPathFilterEvaluationTaskParams getScmPathFilterEvaluationTaskParams(FilterRequestData filterRequestData,
    ...
    setWebhookMetadataInParamsBuilder(paramsBuilder, filterRequestData);
  ...
  private void setWebhookMetadataInParamsBuilder(
      ScmPathFilterEvaluationTaskParamsBuilder paramsBuilder, FilterRequestData filterRequestData) {
