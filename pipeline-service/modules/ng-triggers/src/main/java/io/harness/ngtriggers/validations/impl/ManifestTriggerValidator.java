...
public class ManifestTriggerValidator implements TriggerValidator {
  ...
  public ValidationResult validate(
    ...
    try {
      ...
      validateBasedOnManifestType(buildTriggerOpsData, scopeInfo, isParentIdQueryingEnabled);
    } catch (Exception e) {
  ...
  @VisibleForTesting
  void validateBasedOnManifestType(
    ...
    if (HELM_MANIFEST.getValue().equals(typeFromTrigger)) {
      validateForHelmChart(buildTriggerOpsData, scopeInfo, isParentIdQueryingEnabled);
    }
  }

  @VisibleForTesting
  void validateForHelmChart(
      BuildTriggerOpsData buildTriggerOpsData, ScopeInfo scopeInfo, boolean isParentIdQueryingEnabled) {
    ...
    validateRuntimeInputsForHelmChart(buildTriggerOpsData, scopeInfo, isParentIdQueryingEnabled);
  }

  @VisibleForTesting
  void validateRuntimeInputsForHelmChart(
      BuildTriggerOpsData buildTriggerOpsData, ScopeInfo scopeInfo, boolean isParentIdQueryingEnabled) {
