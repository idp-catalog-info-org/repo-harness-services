...
public class HeaderTriggerFilter implements TriggerFilter {
  ...
  public TriggerEventResponse getFailureResponse(FilterRequestData filterRequestData) {
    return TriggerEventResponseHelper.toResponse(NO_MATCHING_TRIGGER_FOR_HEADER_CONDITIONS,
  ...
  public List<TriggerDetails> applyFilterV2(
    ...
    TriggerExpressionEvaluator triggerExpressionEvaluator = WebhookTriggerFilterUtils.generatorPMSExpressionEvaluator(
        null, filterRequestData.getWebhookPayloadData().getOriginalEvent().getHeaders(), "{}");
  ...
  boolean checkTriggerEligibility(
    ...
    return WebhookTriggerFilterUtils.checkIfCustomHeaderConditionsMatch(
        triggerExpressionEvaluator, WebhookConfigHelper.retrieveHeaderConditions(webhookTriggerConfigV1));
  }
}
