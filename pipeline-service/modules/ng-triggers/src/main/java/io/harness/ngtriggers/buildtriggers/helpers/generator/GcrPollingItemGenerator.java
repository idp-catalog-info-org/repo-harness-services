...
public class GcrPollingItemGenerator implements PollingItemGenerator {
  ...
  public PollingItem generatePollingItem(
    ...
    if (HarnessYamlVersion.isV1(ngTriggerEntity.getHarnessVersion())) {
      ...
      registryHostnameKey = "spec.registryHostname";
    ...
    String registryHostname = buildTriggerHelper.validateAndFetchFromJsonNode(buildTriggerOpsData, registryHostnameKey);
    return builder
