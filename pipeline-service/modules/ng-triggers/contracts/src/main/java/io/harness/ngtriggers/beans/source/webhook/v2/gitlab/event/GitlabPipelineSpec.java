...
import static io.harness.ngtriggers.beans.source.webhook.v2.gitlab.event.GitlabTriggerEvent.PIPELINE_HOOK;
...
@OwnedBy(PIPELINE)
public class GitlabPipelineSpec implements GitlabEventSpec {
  String connectorRef;
  String repoName;
