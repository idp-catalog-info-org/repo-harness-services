...
public interface Constants {
  ...
  String PR = "PR";
  String PUSH = "PUSH";
  String MERGE_QUEUE = "MERGE_QUEUE";
  ...
  String EVENT_RELAY_WEBHOOK = "EventRelay";
  String HARNESS_ARTIFACT_REGISTRY = "HarnessArtifactRegistry";
  String SYSTEM_EVENTS_WEBHOOK = "SystemEvents";
  ...
  String TAG_EVENT_TYPE = "Tag";
  String PIPELINE_HOOK_EVENT_TYPE = "PipelineHook";
  String PR_COMMENT_EVENT_TYPE = "PRComment";
  String BRANCH_EVENT_TYPE = "Branch";
  String MERGE_QUEUE_EVENT_TYPE = "MergeQueue";
  ...
  String SYSTEM_EVENT_TYPE_KEY = "systemEventType";
  String SYSTEM_EVENT_SOURCE_PIPELINE_KEY = "sourcePipelineIdentifier";
  ...
  String TRIGGER_PAYLOAD_HEAD_COMMIT = "<+trigger.payload.head_commit>";
  ...
  String HARNESS_LOWER_CASE = "harness";
  ...
  String ENFORCE_EXECUTOR_IDENTITY_FOR_TRIGGERS = "enforce_executor_identity_for_triggers";
  String ENFORCE_EXECUTOR_IDENTITY_TRUE_VALUE = "true";
  String EXECUTOR_TYPE_USER = "USER";
  String EXECUTOR_TYPE_SERVICE_ACCOUNT = "SERVICE_ACCOUNT";
  ...
  String API_SAMPLE_TRIGGER_YAML = "trigger:\n"
      ...
      + "              spec:\n"
      + "                branch: main";
  String HAR_ARTIFACT_TRIGGER_TYPE = "Artifact";
  String PULL_REQUEST_REVIEW_TYPE = "PullRequestReview";
}
