...
import static io.harness.ngtriggers.beans.source.v1.constants.YamlSimplConstants.MR_COMMENT_EVENT_TYPE;
import static io.harness.ngtriggers.beans.source.v1.constants.YamlSimplConstants.MR_EVENT_TYPE;
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = GitlabPRSpec.class, name = MR_EVENT_TYPE)
