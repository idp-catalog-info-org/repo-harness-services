...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = GithubPushSpec.class, name = PUSH_EVENT_TYPE),
      ...
      @JsonSubTypes.Type(value = GithubCreateSpec.class, name = CREATE_EVENT_TYPE),
      @JsonSubTypes.Type(value = GithubPullRequestReviewSpec.class, name = PULL_REQUEST_REVIEW_TYPE),
      @JsonSubTypes.Type(value = GithubMergeQueueSpec.class, name = MERGE_QUEUE_EVENT_TYPE)
})
@OwnedBy(PIPELINE)
