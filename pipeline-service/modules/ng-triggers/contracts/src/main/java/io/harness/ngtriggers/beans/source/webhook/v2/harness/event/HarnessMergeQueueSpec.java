...
import static io.harness.ngtriggers.beans.source.webhook.v2.harness.event.HarnessTriggerEvent.MERGE_QUEUE;
...
@OwnedBy(PIPELINE)
public class HarnessMergeQueueSpec implements HarnessEventSpec {
  String repoName;
