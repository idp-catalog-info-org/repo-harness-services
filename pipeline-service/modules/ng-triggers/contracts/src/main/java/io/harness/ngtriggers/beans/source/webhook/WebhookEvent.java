...
public enum WebhookEvent {
  ...
  @JsonProperty("Pipeline Hook") PIPELINE_HOOK,
  @JsonProperty("PullRequestsReview") PULL_REQUEST_REVIEW,
  @JsonProperty("Merge Queue") MERGE_QUEUE;

  public static final Set<WebhookEvent> githubEvents =
      EnumSet.of(PULL_REQUEST, PUSH, ISSUE_COMMENT, RELEASE, PULL_REQUEST_REVIEW, MERGE_QUEUE);
  public static final Set<WebhookEvent> gitlabEvents = EnumSet.of(PUSH, MERGE_REQUEST, MR_COMMENT, PIPELINE_HOOK);
  ...
  public static final Set<WebhookEvent> harnessScmEvents = EnumSet.of(PUSH, PR_COMMENT, ISSUE_COMMENT, MERGE_QUEUE);
}
