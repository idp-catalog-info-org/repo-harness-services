...
public enum TriggerCatalogType implements EntitySubtype {
  ...
  @JsonProperty(EVENT_RELAY_WEBHOOK) EVENT_BRIDGE(EVENT_RELAY_WEBHOOK, NGTriggerType.WEBHOOK),
  @JsonProperty(Constants.HARNESS_ARTIFACT_REGISTRY)
  HARNESS_ARTIFACT_REGISTRY(Constants.HARNESS_ARTIFACT_REGISTRY, NGTriggerType.WEBHOOK),
  @JsonProperty(SYSTEM_EVENTS_WEBHOOK) SYSTEM_EVENT(SYSTEM_EVENTS_WEBHOOK, NGTriggerType.SYSTEM_EVENT),
  ...
  @JsonProperty(Constants.GCE_IMAGE) GCE_IMAGE(Constants.GCE_IMAGE, NGTriggerType.ARTIFACT),
