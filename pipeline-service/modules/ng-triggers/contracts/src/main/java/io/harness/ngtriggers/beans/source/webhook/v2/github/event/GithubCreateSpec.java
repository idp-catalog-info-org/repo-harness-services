...
import static io.harness.ngtriggers.beans.source.webhook.v2.github.event.GithubTriggerEvent.CREATE;
...
@OwnedBy(PIPELINE)
public class GithubCreateSpec implements GithubEventSpec {
  String connectorRef;
  String repoName;
