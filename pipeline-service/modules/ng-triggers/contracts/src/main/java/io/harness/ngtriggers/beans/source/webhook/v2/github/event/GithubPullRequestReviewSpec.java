...
import static io.harness.ngtriggers.beans.source.webhook.v2.github.event.GithubTriggerEvent.PULL_REQUEST_REVIEW;
...
@OwnedBy(PIPELINE)
public class GithubPullRequestReviewSpec implements GithubEventSpec {
  String connectorRef;
  String repoName;
  List<GithubPullRequestReviewAction> actions;
