...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = WebhookTriggerConfigV2.class, name = "Webhook"),
      ...
      @JsonSubTypes.Type(value = MultiRegionArtifactTriggerConfig.class, name = "MultiRegionArtifact"),
      @JsonSubTypes.Type(value = SystemEventTriggerConfig.class, name = "SystemEvent")
})
@OwnedBy(PIPELINE)
