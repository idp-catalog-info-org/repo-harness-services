...
public class PipelineValidationResponseDTO {
  ...
  @Schema(description = "OPA onSave governance status for the pipeline; present for remote pipelines when evaluated")
  OpaOnSaveStatusResponseDTO opaOnSaveStatus;
}
