...
import io.harness.opa.serializer.json.serializers.GovernanceMetadataSerializer;
import io.harness.opa.serializer.json.serializers.PolicyMetadataSerializer;
import io.harness.opa.serializer.json.serializers.PolicySetMetadataSerializer;
...
import io.harness.pms.serializer.json.serializers.TemplateReferenceSummarySerializer;
...
public class PmsBeansJacksonModule extends SimpleModule {
  public PmsBeansJacksonModule() {
    ...
    addSerializer(TemplateReferenceSummary.class, new TemplateReferenceSummarySerializer());
  }
}
