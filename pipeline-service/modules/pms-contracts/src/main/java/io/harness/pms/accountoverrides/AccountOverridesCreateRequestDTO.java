...
@ApiModel("AccountOverridesCreateRequest")
@Schema(name = "AccountOverridesCreateRequest", description = "Contains information for creating account override")
@CodePulse(module = ProductModule.CDS, unitCoverageRequired = false, components = {HarnessModuleComponent.CDS_PIPELINE})
public class AccountOverridesCreateRequestDTO {
  ...
  @Schema(description = "Export settings") ExportSettingsCreateRequestDTO exportSettings;
