...
public class MergeInputSetRequestDTOPMS {
  ...
  @Schema(description = "This is a boolean value that indicates if the response must contain the YAML for the merged "
  ...
  @Schema(description = "InputSetBranchName") String inputSetBranchName;
}
