...
public interface PipelineResourceConstants {
  ...
  String ALLOW_DYNAMIC_EXECUTIONS = "Allow  Dynamic Executions for the Pipeline";
  ...
  String USE_ORIGINAL_PIPELINE_YAML = "Whether to use the original pipeline yaml from the original execution";
  String YAML = "Yaml of the Pipeline";
  String DATA_RETENTION_PERIOD = "Data Retention Period";
  String INPUT_SET_IDENTIFIER_LIST_PARAM_MESSAGE =
      "Input set identifiers for tracking and filtering pipeline executions. A list of input set identifiers to apply.";
}
