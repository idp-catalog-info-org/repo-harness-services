...
import io.harness.pms.serializer.kryo.serializers.ExecutionContextKryoSerializer;
import io.harness.pms.serializer.kryo.serializers.ExecutionTriggerInfoKryoSerializer;
...
import io.harness.pms.serializer.kryo.serializers.RunModeConfigKryoSerializer;
...
import io.harness.pms.serializer.kryo.serializers.StrategyMetadataKryoSerializer;
import io.harness.pms.serializer.kryo.serializers.TemplateReferenceSummaryKryoSerializer;
...
public class PmsContractsKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(ExecutionContext.class, ExecutionContextKryoSerializer.getInstance(), 2631);
    ...
    kryo.register(StrategyMetadata.class, StrategyMetadataKryoSerializer.getInstance(), 954003);
    kryo.register(ExecutionTriggerInfo.class, ExecutionTriggerInfoKryoSerializer.getInstance(), 954004);
    kryo.register(TemplateReferenceSummary.class, TemplateReferenceSummaryKryoSerializer.getInstance(), 954005);
    kryo.register(RunModeConfig.class, RunModeConfigKryoSerializer.getInstance(), 954006);
  }
}
