...
public class InputSetTemplateRequestDTO {
  ...
  @Schema(
      description = "Map of Service identifiers with their gitBranch for which the Runtime Input Metadata is needed")
  List<EntityWithGitInfo> serviceWithGitInfoList;
}
