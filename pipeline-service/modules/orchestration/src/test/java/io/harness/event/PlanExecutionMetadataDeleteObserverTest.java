...
public class PlanExecutionMetadataDeleteObserverTest extends CategoryTest {
  ...
  public void testOnPlanExecutionsDelete() {
    planExecutionMetadataDeleteObserver.onPlanExecutionsDelete(Collections.emptyList(), false, null);
  ...
  public void testRetainPipelineExecutionDetailsAfterDeleteTrue() {
    planExecutionMetadataDeleteObserver.onPlanExecutionsDelete(Collections.emptyList(), true, null);
