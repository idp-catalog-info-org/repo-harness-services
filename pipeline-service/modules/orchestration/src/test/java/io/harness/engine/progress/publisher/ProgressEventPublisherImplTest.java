...
public class ProgressEventPublisherImplTest extends OrchestrationTestBase {
  @Mock NodeExecutionService nodeExecutionService;
  @Mock PmsEventSender eventSender;
  @InjectMocks ProgressEventPublisherImpl progressEventPublisherImpl;
  ...
  public void testIfStepParametersSentAreResolvedOne() {
    ...
    when(nodeExecutionService.getAmbiance(nodeExecution)).thenReturn(nodeExecution.getAmbiance());
    ...
    doNothing()
        .when(eventSender)
        .sendEvent(nodeExecution.getAmbiance(), progressEvent, PmsEventCategory.PROGRESS_EVENT,
            nodeExecution.getModule(), false, false);

    progressEventPublisherImpl.publishEvent(nodeExecution.getUuid(),
