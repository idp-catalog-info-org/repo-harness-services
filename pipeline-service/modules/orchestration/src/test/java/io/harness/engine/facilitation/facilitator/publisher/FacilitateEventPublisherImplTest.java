...
public class FacilitateEventPublisherImplTest extends OrchestrationTestBase {
  @Mock NodeExecutionService nodeExecutionService;
  @Mock PmsEventSender eventSender;
  @Inject @InjectMocks FacilitateEventPublisherImpl facilitateEventPublisherImpl;
  ...
  public void testIfStepParametersSentAreResolvedOne() {
    ...
    facilitateEventPublisherImpl.publishEvent(ambiance, planNode);

    ArgumentCaptor<FacilitatorEvent> argumentCaptor = ArgumentCaptor.forClass(FacilitatorEvent.class);
    ...
    verify(eventSender)
        .sendEvent(ambianceArgumentCaptor.capture(), argumentCaptor.capture(), eq(PmsEventCategory.FACILITATOR_EVENT),
            eq(nodeExecution.getModule()), eq(true), eq(true));
    FacilitatorEvent facilitatorEvent = argumentCaptor.getValue();
