...
public class PlanServiceImplTest extends OrchestrationTestBase {
  ...
  public void shouldTestSave() {
    ...
    assertThat(plan.getValidUntil()).isAfterOrEqualTo(Date.from(now.plusMonths(3).toInstant()));
  }
  ...
  public void shouldTestFetch() {
    ...
    assertThat(fetchedPlan.getValidUntil()).isAfterOrEqualTo(Date.from(now.plusMonths(3).toInstant()));
  }
