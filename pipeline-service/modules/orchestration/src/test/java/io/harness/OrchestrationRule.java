  ...
  public List<Module> modules(List<Annotation> annotations) throws Exception {
    ...
    modules.add(new AbstractModule() {
      ...
      protected void configure() {
        ...
        bind(FMEPipelineClient.class).toInstance(mock(FMEPipelineClient.class));
    ...
    modules.add(new ProviderModule() {
      ...
      // exercise a real Redis; we only need the injector to resolve and the atomic long to be
      // a mock so any incidental hook fire is a no-op.
      @Provides
