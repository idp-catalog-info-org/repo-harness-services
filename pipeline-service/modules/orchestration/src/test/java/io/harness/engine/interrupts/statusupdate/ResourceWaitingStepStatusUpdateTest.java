...
public class ResourceWaitingStepStatusUpdateTest extends CategoryTest {
  @Mock private PlanExecutionService planExecutionService;
  @Mock private NodeExecutionService nodeExecutionService;
  @Mock private PmsFeatureFlagService pmsFeatureFlagService;
  @Mock private PipelineStageStatusHelper pipelineStageStatusHelper;
  @InjectMocks ResourceWaitingStepStatusUpdate resourceWaitingStepStatusUpdate;
  ...
  public void testHandleNodeStatusUpdate() {
    ...
    doReturn(true)
        ...
        .isEnabled("accountId", FeatureName.CDS_MARK_PIPELINE_AND_STAGE_AS_RESOURCE_WAITING);
    resourceWaitingStepStatusUpdate.handleNodeStatusUpdate(nodeUpdateInfo);
    ...
    verify(planExecutionService, times(1)).updateStatus(planExecutionId, RESOURCE_WAITING);
    verify(pipelineStageStatusHelper, times(1)).updatePipelineAndStageWaitingStatus(nodeUpdateInfo, RESOURCE_WAITING);
  }
}
