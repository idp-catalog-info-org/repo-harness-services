...
public class NodeResumeEventPublisherImplTest extends OrchestrationTestBase {
  @Mock PmsEventSender eventSender;
  @Inject @InjectMocks NodeResumeEventPublisherImpl resumeEventPublisher;
  ...
  public void testIfStepParametersSentAreResolvedOne() {
    ...
    verify(eventSender)
        .sendEvent(nodeExecution.getAmbiance(), nodeResumeEvent, PmsEventCategory.NODE_RESUME,
            nodeExecution.getModule(), true, false);
  }
  ...
  public void testPublishEventForIdentityNode() {
    ...
    verify(eventSender)
        .sendEvent(IdentityStep.modifyAmbiance(nodeExecution.getAmbiance()), nodeResumeEvent,
            PmsEventCategory.NODE_RESUME, "service1", true, false);
  }
