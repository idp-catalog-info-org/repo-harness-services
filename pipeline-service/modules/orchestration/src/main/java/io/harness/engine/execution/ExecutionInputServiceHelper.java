...
public class ExecutionInputServiceHelper {
  ...
  public Map<String, Object> getExecutionInputMap(JsonNode inputTemplate, JsonNode userInput, String harnessVersion) {
    ...
    templateFqnToValueMap.keySet().forEach(key -> {
      ...
      boolean isExecutionInput = HarnessYamlVersion.isV1(harnessVersion)
          ? NGExpressionUtils.matchesExecutionInputPatternV1(value)
    ...
    return FQNHelper.convertFQNExpressionToMap(inputMap, false);
  }
}
