...
@Slf4j
public class EssentialsAccountConfigStrategy implements EditionBasedAccountConfigStrategy {
  ...
  public int getMaxPipelineCreationLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getPipelineCreationRestriction().getEssentials();
    }
    ...
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return pipelineRetentionService.getMaxConcurrentPipelineExecution(accountIdentifier)
          .orElseGet(()
                  ...
                  ? ngConcurrencyLimit
                  : orchestrationRestrictionConfiguration.getPlanExecutionRestriction().getEssentials());
    }
  ...
  public long getMaxInputParameterSize(String accountIdentifier) {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      ...
      return overriddenValue.orElseGet(
          () -> orchestrationRestrictionConfiguration.getMaxInputParameterSizeRestriction().getEssentials());
    }
  ...
  public int getStepOrStageMaxConcurrency() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getMaxConcurrencyRestriction().getEssentials();
    }
    return Integer.MAX_VALUE;
  }
  ...
  public long getMaxOutcomeSize() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return orchestrationRestrictionConfiguration.getMaxExecutionOutcomeSizeRestriction().getEssentials();
    }
    return Long.MAX_VALUE;
  }
  ...
  public long getMaxParallelismStopRestriction() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return orchestrationRestrictionConfiguration.getTotalParallelismStopRestriction().getEssentials();
    }
    return Long.MAX_VALUE;
  }
  ...
  public int getMaxQueuedExecutionLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getMaxQueuedExecutionsRestriction().getEssentials();
    }
    return Integer.MAX_VALUE;
  }
  ...
  public int getMaxTriggerCreationLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getTriggerCreationRestriction().getEssentials();
    }
    return Integer.MAX_VALUE;
  }
  ...
  public long getMaxFileSizeLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getFileSizeRestriction().getEssentials();
    }
    return Long.MAX_VALUE;
  }
  ...
  public long getPayloadSizeLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEssentials()) {
      return (int) orchestrationRestrictionConfiguration.getPayloadSizeRestriction().getEssentials();
    }
    return Long.MAX_VALUE;
  }
