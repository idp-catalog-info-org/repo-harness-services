...
@Singleton
public class ProgressEventPublisherImpl implements ProgressEventPublisher {
  @Inject private NodeExecutionService nodeExecutionService;
  @Inject private PmsEventSender eventSender;

  @Override
  public void publishEvent(String nodeExecutionId, BinaryResponseData progressData) {
    ...
    eventSender.sendEvent(
        ambiance, progressEvent, PmsEventCategory.PROGRESS_EVENT, nodeExecution.getModule(), false, false);
  }
}
