...
public class RetryAdviserResponseHandler implements AdviserResponseHandler {
  ...
  public void handleAdvise(NodeExecution nodeExecution, AdviserResponse adviserResponse) {
    ...
    failureStrategyAdviserHandlerUtils.interruptPipelineIfFailAll(nodeExecution, ambiance, advise.getFailAll());
                ...
                InterruptConfig.newBuilder()
                    .setIssuedBy(
                        IssuedBy.newBuilder()
                            ...
                            .build())
                    .setRetryInterruptConfig(RetryInterruptConfig.newBuilder()
                                                 .setWaitInterval(advise.getWaitInterval())
                                                 .setCondition(advise.getCondition())
                                                 .build())
                    .build())
            .build();
