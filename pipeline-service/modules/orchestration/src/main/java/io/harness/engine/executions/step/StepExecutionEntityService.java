...
public interface StepExecutionEntityService {
   ...
   * @return step execution entity
   */
  StepExecutionEntity findStepExecutionEntity(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String stepExecutionId, String parentUniqueId);
