...
@OwnedBy(PIPELINE)
@Singleton
public class InitiateNodeBatchEventRedisConsumer
    extends PmsAbstractRedisConsumer<InitiateNodeBatchEventMessageListener> {
  @Inject
  public InitiateNodeBatchEventRedisConsumer(@Named(INITIATE_NODE_BATCH_EVENT_CONSUMER) Consumer redisConsumer,
      InitiateNodeBatchEventMessageListener initiateNodeEventMessageListener,
