...
public class FacilitatorObtainmentReadConverter extends ProtoReadConverter<FacilitatorObtainment> {
  ...
  @Override
  public FacilitatorObtainment getDeserializedValue(Binary bytes) throws InvalidProtocolBufferException {
    return FacilitatorObtainment.parseFrom(bytes.getData());
  }
}
