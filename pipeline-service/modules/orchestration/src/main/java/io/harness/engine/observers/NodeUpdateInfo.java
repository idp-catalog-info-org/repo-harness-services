...
public class NodeUpdateInfo {
  ...
  public String getAccountId() {
    return nodeExecution.getAccountId();
  }

  public AutoLogContext autoLogContext() {
    Map<String, String> logContextMap =
        AmbianceUtils.logContextMap(nodeExecution.getCurrentLevel(), nodeExecution.getSetupAbstractionsMap(),
            nodeExecution.getPlanExecutionId(), nodeExecution.getPipelineIdentifier());
