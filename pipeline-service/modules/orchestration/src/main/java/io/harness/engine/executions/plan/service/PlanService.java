...
public interface PlanService {
  ...
  /**
   * Appends additional nodes to an existing plan
   * @param planId The ID of the plan to append nodes to
   * @param nodes The list of nodes to append
   * @return The updated plan with appended nodes
   */
  Plan appendNodes(String planId, List<Node> nodes);
