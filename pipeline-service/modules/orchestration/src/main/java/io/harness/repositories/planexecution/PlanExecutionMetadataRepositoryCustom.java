...
public interface PlanExecutionMetadataRepositoryCustom {
  ...
  /**
   * Fetches PlanExecutionMetadata by planExecutionId from secondary mongo
   * Uses - planExecutionId_idx index
   * @param planExecutionId planExecutionId to filter by
   * @return PlanExecutionMetadata metadata
   */
  PlanExecutionMetadata fetchByPlanExecutionIdFromSecondary(String planExecutionId);
}
