...
public class InterruptEffectReadConverter extends ProtoReadConverter<InterruptEffectProto> {
  ...
  @Override
  public InterruptEffectProto getDeserializedValue(Binary bytes) throws InvalidProtocolBufferException {
    return InterruptEffectProto.parseFrom(bytes.getData());
  }
}
