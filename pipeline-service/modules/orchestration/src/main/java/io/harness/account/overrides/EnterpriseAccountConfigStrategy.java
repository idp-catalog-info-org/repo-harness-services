...
@Slf4j
public class EnterpriseAccountConfigStrategy implements EditionBasedAccountConfigStrategy {
  ...
  public int getMaxPipelineCreationLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return (int) orchestrationRestrictionConfiguration.getPipelineCreationRestriction().getEnterprise();
    }
  ...
  public long getMaxInputParameterSize(String accountIdentifier) {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      ...
      return overriddenValue.orElseGet(
          () -> orchestrationRestrictionConfiguration.getMaxInputParameterSizeRestriction().getEnterprise());
    }
  ...
  public long getMaxOutcomeSize() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return orchestrationRestrictionConfiguration.getMaxExecutionOutcomeSizeRestriction().getEnterprise();
    }
    return Long.MAX_VALUE;
  }
  ...
  public long getMaxParallelismStopRestriction() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return orchestrationRestrictionConfiguration.getTotalParallelismStopRestriction().getEnterprise();
    }
    return Long.MAX_VALUE;
  }
  ...
  public int getMaxQueuedExecutionLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return (int) orchestrationRestrictionConfiguration.getMaxQueuedExecutionsRestriction().getEnterprise();
    }
    return Integer.MAX_VALUE;
  }
  ...
  public int getMaxTriggerCreationLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return (int) orchestrationRestrictionConfiguration.getTriggerCreationRestriction().getEnterprise();
    }
    return Integer.MAX_VALUE;
  }
  ...
  public long getMaxFileSizeLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return (int) orchestrationRestrictionConfiguration.getFileSizeRestriction().getEnterprise();
    }
    return Long.MAX_VALUE;
  }
  ...
  public long getPayloadSizeLimit() {
    if (orchestrationRestrictionConfiguration.isUseRestrictionForEnterprise()) {
      return (int) orchestrationRestrictionConfiguration.getPayloadSizeRestriction().getEnterprise();
    }
    return Long.MAX_VALUE;
  }
