...
public class ExpiryInterruptCallback implements OldNotifyCallback {
  ...
  void expireNode(Map<String, ResponseData> response) {
    NodeExecution nodeExecution = nodeExecutionService.getWithFieldsIncluded(nodeExecutionId,
        Set.of(NodeExecutionKeys.uuid, NodeExecutionKeys.ambiance, NodeExecutionKeys.executionContext,
            NodeExecutionKeys.unitProgresses, NodeExecutionKeys.progressData));
