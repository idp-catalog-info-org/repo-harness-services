...
import static io.harness.eventsframework.EventsFrameworkConstants.PIPELINE_BACKFILL_ORCHESTRATION_EVENT_MAX_TOPIC_SIZE;
...
public class OrchestrationRedisEventsConfig {
  ...
  @Builder.Default
  RedisEventConfig pipelineBackfillOrchestrationEvent =
      RedisEventConfig.builder().maxTopicSize(PIPELINE_BACKFILL_ORCHESTRATION_EVENT_MAX_TOPIC_SIZE).build();
}
