...
public class ExecutionPrincipalInfoReadConverter extends ProtoReadConverter<ExecutionPrincipalInfo> {
  ...
  @Override
  public ExecutionPrincipalInfo getDeserializedValue(Binary bytes) throws InvalidProtocolBufferException {
    return ExecutionPrincipalInfo.parseFrom(bytes.getData());
  }
}
