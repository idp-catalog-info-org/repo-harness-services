...
@Slf4j
public class InterruptEventPublisherImpl implements InterruptEventPublisher {
  ...
  public String publishEvent(String nodeExecutionId, Interrupt interrupt, InterruptType interruptType) {
    ...
    eventSender.sendEvent(ambiance, event, PmsEventCategory.INTERRUPT_EVENT, nodeExecution.getModule(), false, false);
