...
import io.harness.event.handlers.IdentityContextUpdateProcessor;
...
public class SdkResponseProcessorFactory {
  ...
  public SdkResponseProcessor getHandler(SdkResponseEventType eventType) {
    switch (eventType) {
      ...
      case IDENTITY_CONTEXT_UPDATE:
        return injector.getInstance(IdentityContextUpdateProcessor.class);
      default:
