...
public class FailureInterruptCallback implements OldNotifyCallback {
  ...
  public void notify(Map<String, ResponseData> response) {
    try {
      ...
      orchestrationEngine.concludeNodeExecution(nodeExecutionService.getAmbiance(updatedNodeExecution), Status.FAILED,
          originalStatus, EnumSet.noneOf(Status.class));
    } catch (Exception ex) {
