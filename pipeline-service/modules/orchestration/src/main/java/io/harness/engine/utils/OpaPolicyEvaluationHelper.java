...
public class OpaPolicyEvaluationHelper {
  ...
  public boolean shouldEvaluatePolicy(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String type, String action, String yamlVersion) {
    try {
      OpaShouldEvaluateResponse opaShouldEvaluateResponse =
          SafeHttpCall.executeWithExceptions(opaServiceClient.shouldEvaluateByTypeAndAction(
              accountIdentifier, orgIdentifier, projectIdentifier, type, action, yamlVersion));
