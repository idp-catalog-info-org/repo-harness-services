...
public final class NodeExecutionOutboxEventConstants {
  ...
  public static final String PIPELINE_END_FOR_KAFKA = "PipelineKafkaEndEvent";
  public static final String STAGE_END_FOR_KAFKA = "StageKafkaEndEvent";
  public static final String STEP_END_FOR_KAFKA = "StepKafkaEndEvent";
  // Event Type Constants
  public static final String EVENT_TYPE_NODE_START = "nodeStart";
  public static final String EVENT_TYPE_NODE_STATUS_UPDATE = "nodeStatusUpdate";
  public static final String EVENT_TYPE_NODE_END = "nodeEnd";
  ...
  public static final String END_EVENT_PUBLISH_SUPPORTED_MSG =
      "Currently pushing end events are not supported for NodeGroup of type: %s";
