...
package io.harness.repositories.interrupt;
...
public interface InterruptRepository extends CrudRepository<Interrupt, String> {
  ...
  List<Interrupt> findByPlanExecutionIdInAndStateInAndTypeInOrderByCreatedAtDesc(
      List<String> planExecutionIds, EnumSet<State> states, EnumSet<InterruptType> planLevelInterrupts);
