...
public class PipelineEndEvent extends NodeExecutionEvent {
  ...
  public PipelineEndEvent(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String parentUniqueId, String pipelineIdentifier, String planExecutionId, TriggeredInfo triggeredInfo,
      String status, Long startTs, Long endTs, Integer runSequence) {
