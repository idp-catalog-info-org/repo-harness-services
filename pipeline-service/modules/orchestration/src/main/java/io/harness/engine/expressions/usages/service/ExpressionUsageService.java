...
package io.harness.engine.expressions.usages.service;
...
public interface ExpressionUsageService {
  ...
  boolean doesExpressionUsagesEntityExists(String pipelineIdentifier, String accountIdentifier, String parentUniqueId);

  ExpressionUsagesEntity upsertExpressions(String pipelineIdentifier, String accountId, String orgId, String projectId,
      Map<ExpressionCategory, Set<ExpressionMetadata>> expressionUsages, String parentUniqueId, boolean useScopeInfo);
