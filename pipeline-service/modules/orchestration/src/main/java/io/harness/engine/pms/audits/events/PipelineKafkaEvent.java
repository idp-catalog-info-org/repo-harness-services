...
@Data
@NoArgsConstructor
public class PipelineKafkaEvent extends BaseKafkaExecutionEvent {
  ...
  @Builder
  public PipelineKafkaEvent(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String parentUniqueId, String pipelineIdentifier, String planExecutionId, String status, Long startTs, Long endTs,
      Long createdAt, Long lastModifiedAt, FailureInfo failureInfo, Integer runSequence, TriggeredInfo triggeredInfo,
      Map<String, String> tags, String nodeEventType) {
  ...
  public String getEventType() {
    return NodeExecutionOutboxEventConstants.PIPELINE_END_FOR_KAFKA;
  }
}
