...
package io.harness.engine.expressions.provider;
...
public interface ExpressionEvaluatorProvider {
  ...
  default EngineExpressionEvaluator get(VariableResolverTracker variableResolverTracker, Ambiance ambiance,
    ...
    return get(variableResolverTracker, ambiance, entityTypes, refObjectSpecific, null, isCel);
  }
  ...
  default EngineExpressionEvaluator get(Ambiance ambiance, Set<NodeExecutionEntityType> entityTypes,
  ...
  default EngineExpressionEvaluator get(VariableResolverTracker variableResolverTracker, Ambiance ambiance,
    ...
    return get(variableResolverTracker, ambiance, entityTypes, refObjectSpecific, null, false);
  }
  EngineExpressionEvaluator get(VariableResolverTracker variableResolverTracker, Ambiance ambiance,
      Set<NodeExecutionEntityType> entityTypes, boolean refObjectSpecific, Map<String, Object> contextMap);
