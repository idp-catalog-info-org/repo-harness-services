...
@OwnedBy(PIPELINE)
@Singleton
public class SdkResponseEventKafkaConsumer extends HKafkaProtoConsumer<SdkResponseEventProto> {
  @Inject
  public SdkResponseEventKafkaConsumer(SdkResponseHandler messageHandler, @Named(SDK_SERVICE_NAME) String serviceName,
      @Named("SdkResponseExecutorService") ExecutorService executorService,
    ...
    super(KafkaConsumerConfig.<SdkResponseEventProto>builder()
              ...
              .topic(PmsSdkKafkaTopicResolver.getPipelineSdkResponseTopic())
