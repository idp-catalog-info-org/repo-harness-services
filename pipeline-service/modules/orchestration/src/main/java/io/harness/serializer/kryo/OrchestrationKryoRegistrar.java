...
public class OrchestrationKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(OutcomeException.class, 870023);
    kryo.register(LazyStringArrayList.class, 870034);
    kryo.register(ManualExecutionCallback.class, 870035);
    kryo.register(ManualExecutionResponseData.class, 870036);
    kryo.register(ManualExecutionAction.class, 870037);
    kryo.register(DagExecutionCallback.class, 870038);
    kryo.register(ManualExecutionDetailsInfo.class, 870039);
  }
}
