...
import io.harness.pms.serializer.PmsContractsRegistrars;
...
import io.harness.serializer.morphia.converters.ExecutionContextMorphiaConverter;
...
import io.harness.serializer.morphia.converters.TemplateReferenceSummaryMorphiaConverter;
...
import io.harness.serializer.spring.converters.dependencyGraph.DependencyGraphProtoReadConverter;
import io.harness.serializer.spring.converters.dependencyGraph.DependencyGraphProtoWriteConverter;
...
import io.harness.serializer.spring.converters.executionContext.ExecutionContextReadConverter;
import io.harness.serializer.spring.converters.executionContext.ExecutionContextWriteConverter;
...
import io.harness.serializer.spring.converters.outcomes.RunStepInfoV1OutcomeReadConverter;
import io.harness.serializer.spring.converters.outcomes.RunStepInfoV1OutcomeWriteConverter;
...
import io.harness.serializer.spring.converters.plannode.RunModeConfigProtoReadConverter;
import io.harness.serializer.spring.converters.plannode.RunModeConfigProtoWriteConverter;
import io.harness.serializer.spring.converters.plannode.SendGitStatusProtoReadConverter;
import io.harness.serializer.spring.converters.plannode.SendGitStatusProtoWriteConverter;
...
import io.harness.serializer.spring.converters.template.TemplateReferenceSummaryReadConverter;
import io.harness.serializer.spring.converters.template.TemplateReferenceSummaryWriteConverter;
...
public class OrchestrationRegistrars {
  ...
  public static final ImmutableSet<Class<? extends MorphiaRegistrar>> morphiaRegistrars =
      ImmutableSet.<Class<? extends MorphiaRegistrar>>builder()
          ...
          .add(NgCertificateMorphiaRegistrar.class)
  ...
  public static final ImmutableSet<Class<? extends TypeConverter>> morphiaConverters =
      ImmutableSet.<Class<? extends TypeConverter>>builder()
          ...
          .add(ExecutionContextMorphiaConverter.class)
          .add(TemplateReferenceSummaryMorphiaConverter.class)
          .build();
  ...
  public static final List<Class<? extends Converter<?, ?>>> orchestrationConverters = ImmutableList.of(
      ...
      AmbianceWriteConverter.class, ExecutionContextReadConverter.class, ExecutionContextWriteConverter.class,
      AdviserTypeReadConverter.class, AdviserTypeWriteConverter.class, AdviserObtainmentReadConverter.class,
      AdviserObtainmentWriteConverter.class, FacilitatorTypeReadConverter.class, FacilitatorTypeWriteConverter.class,
      StepTypeReadConverter.class, StepTypeWriteConverter.class, FacilitatorObtainmentReadConverter.class,
      FacilitatorObtainmentWriteConverter.class, RefTypeReadConverter.class, RefTypeWriteConverter.class,
      RefObjectReadConverter.class, RefObjectWriteConverter.class, StepInfoReadConverter.class,
      StepInfoWriteConverter.class, FailureInfoReadConverter.class, FailureInfoWriteConverter.class,
      PlanNodeProtoReadConverter.class, PlanNodeProtoWriteConverter.class, StepOutcomeRefReadConverter.class,
      StepOutcomeRefWriteConverter.class, ExecutableResponseReadConverter.class, ExecutableResponseWriteConverter.class,
      NodeExecutionReadConverter.class, NodeExecutionWriteConverter.class, FacilitatorResponseReadConverter.class,
      ...
      RetryInfoWriteConverter.class, TemplateReferenceSummaryReadConverter.class,
      TemplateReferenceSummaryWriteConverter.class, SendGitStatusProtoWriteConverter.class,
      SendGitStatusProtoReadConverter.class, RunModeConfigProtoReadConverter.class,
      RunModeConfigProtoWriteConverter.class, DependencyGraphProtoWriteConverter.class,
      DependencyGraphProtoReadConverter.class, RunStepInfoV1OutcomeWriteConverter.class,
      RunStepInfoV1OutcomeReadConverter.class);

  public static final List<Class<? extends Converter<?, ?>>> springConverters =
      ImmutableList.<Class<? extends Converter<?, ?>>>builder()
          .addAll(orchestrationConverters)
          .addAll(PmsContractsRegistrars.springConverters)
