...
public class StageStartEvent extends NodeExecutionEvent {
  ...
  public StageStartEvent(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String parentUniqueId, String pipelineIdentifier, String planExecutionId, String stageIdentifier,
      String stageType, Long startTs, String nodeExecutionId, Integer runSequence, TriggeredInfo triggeredInfo) {
