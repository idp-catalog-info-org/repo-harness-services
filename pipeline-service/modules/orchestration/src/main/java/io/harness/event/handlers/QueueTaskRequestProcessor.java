...
public class QueueTaskRequestProcessor implements SdkResponseProcessor {
  ...
  public void handleEvent(SdkResponseEventProto event) {
    ...
    nodeExecutionService.updateV2ForNonFinalStatusNodeExecution(nodeExecutionId, ops -> {
      ops.addToSet(NodeExecutionKeys.executableResponses, executableResponse);
      ops.set(NodeExecutionKeys.status, queueTaskRequest.getStatus());
    });
