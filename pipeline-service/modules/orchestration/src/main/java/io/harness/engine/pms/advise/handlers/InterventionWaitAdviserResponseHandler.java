...
public class InterventionWaitAdviserResponseHandler implements AdviserResponseHandler {
  ...
  public void handleAdvise(NodeExecution nodeExecution, AdviserResponse adviserResponse) {
    ...
    TimeoutCallback timeoutCallback =
        new InterventionWaitTimeoutCallback(nodeExecution.getPlanExecutionId(), nodeExecution.getUuid());
    ...
    failureStrategyAdviserHandlerUtils.interruptPipelineIfFailAll(
        nodeExecution, ambiance, interventionWaitAdvise.getFailAll());
    ...
    eventEmitter.emitEvent(OrchestrationEvent.newBuilder()
                               ...
                               .setAmbiance(nodeExecutionService.getAmbiance(nodeExecution))
