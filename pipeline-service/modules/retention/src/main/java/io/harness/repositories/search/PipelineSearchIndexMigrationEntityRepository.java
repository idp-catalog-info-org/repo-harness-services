...
@OwnedBy(PIPELINE)
@HarnessRepo
public interface PipelineSearchIndexMigrationEntityRepository
    extends CrudRepository<PipelineSearchIndexMigrationEntity, String>,
            PipelineSearchIndexMigrationEntityRepositoryCustom {}
