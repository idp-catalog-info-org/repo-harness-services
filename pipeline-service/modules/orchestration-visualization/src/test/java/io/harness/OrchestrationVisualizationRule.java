  ...
  public List<Module> modules(List<Annotation> annotations) throws Exception {
    ...
    modules.add(new AbstractModule() {
      ...
      protected void configure() {
        ...
        bind(PipelineSearchService.class).toInstance(mock(PipelineSearchService.class));
        bind(ExecutionRetentionService.class).toInstance(mock(ExecutionRetentionService.class));
        bind(ExecutionRetentionIteratorEntityService.class)
            .toInstance(mock(ExecutionRetentionIteratorEntityService.class));
        bind(PostgresDBService.class).toInstance(mock(PostgresDBService.class));
        bind(GraphCDCService.class).toInstance(mock(GraphCDCService.class));
    ...
    modules.add(new ProviderModule() {
      ...
      RedissonClient cacheRedissonClient() {
        ...
        org.mockito.Mockito.when(redissonClient.getAtomicLong(org.mockito.ArgumentMatchers.anyString()))
    ...
    modules.add(JooqModuleV1.getInstance(
        TimeScaleDBConfig.builder().build(), TimeScaleDBConfig.builder().build(), PostgresDBConfig.builder().build()));
