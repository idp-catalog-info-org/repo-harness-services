...
public class OrchestrationEndEventHandlerTest extends OrchestrationVisualizationTestBase {
  ...
  public void setUp() {
    ...
    PmsFeatureFlagHelper pmsFeatureFlagHelper = mock(PmsFeatureFlagHelper.class);
    orchestrationEndEventHandler = new OrchestrationEndGraphHandler(
        executorService, planExecutionService, graphGenerationService, pmsFeatureFlagHelper);
  }
