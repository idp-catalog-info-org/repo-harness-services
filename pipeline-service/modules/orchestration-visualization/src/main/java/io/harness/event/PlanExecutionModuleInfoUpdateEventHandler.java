    ...
    for (Map.Entry<String, LinkedHashMap<String, Object>> entry : moduleInfo.entrySet()) {
      ...
      if (entry.getValue() != null) {
        for (Map.Entry<String, Object> entry1 : entry.getValue().entrySet()) {
          ...
          } else if (entry1.getValue() != null && Map.class.isAssignableFrom(entry1.getValue().getClass())) {
            Map<Object, Object> values = (Map<Object, Object>) entry1.getValue();
            for (Map.Entry<Object, Object> entry2 : values.entrySet()) {
              String mapKey = key + "." + entry2.getKey();
              update.set(mapKey, entry2.getValue());
            }
          } else {
