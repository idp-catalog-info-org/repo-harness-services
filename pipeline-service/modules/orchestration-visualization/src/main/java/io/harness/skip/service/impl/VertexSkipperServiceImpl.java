...
public class VertexSkipperServiceImpl implements VertexSkipperService {
  ...
  public void removeSkippedVertices(EphemeralOrchestrationGraph orchestrationGraph) {
    ...
    // skipping order of vertex will start from top level and right most corner vertex in the graph
    // and vertex skipper is selected from skipType i.e. SKIP_NODE or SKIP_TREE
