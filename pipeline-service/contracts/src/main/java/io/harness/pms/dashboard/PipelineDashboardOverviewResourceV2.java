...
public interface PipelineDashboardOverviewResourceV2 {
  ...
  fetchPipelinedHealth(
      ...
      @Parameter(description = PipelineResourceConstants.END_TIME_EPOCH_PARAM_MESSAGE, required = true) @NotNull
      @QueryParam(NGResourceFilterConstants.END_TIME) long endInterval, @Context ScopeInfo scopeInfo);
