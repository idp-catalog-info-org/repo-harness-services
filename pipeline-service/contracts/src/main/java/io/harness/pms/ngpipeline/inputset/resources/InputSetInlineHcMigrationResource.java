...
@OwnedBy(PIPELINE)
@Api("/input-set/inline-hc-migrations")
@Path("/input-set/inline-hc-migrations")
...
@Tag(name = "InputSet InlineHC Migrations",
    description = "This contains APIs for InputSet InlineHC Migration operations")
@Hidden
public interface InputSetInlineHcMigrationResource {
  @POST
  @Path("rollback")
  @Timed
  @Hidden
