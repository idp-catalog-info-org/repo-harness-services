...
public class InputSetYamlWithTemplateDTO {
  ...
  // Details of inputSets used in this execution
  @Schema(description = "Details of inputsets used in this execution") List<InputSetDetailsDTO> inputSetDetails;

  // Branch name from which input sets were fetched (only for trigger-based executions)
  @Schema(description = "Branch name from which input sets were fetched") String inputSetBranchName;

  // Resolved Yaml with all expressions and runtime inputs resolved
  @Schema(description = "Resolved Yaml with all expressions and runtime inputs resolved") String resolvedYaml;
}
