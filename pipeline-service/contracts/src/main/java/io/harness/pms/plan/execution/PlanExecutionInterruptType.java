...
public enum PlanExecutionInterruptType {
  ...
  @JsonProperty("PipelineRollback")
  PIPELINEROLLBACK("Do pipeline rollback of the execution", InterruptType.MARK_FAILED, "PipelineRollback"),
  ...
  @JsonProperty("RetryStepGroup")
  RETRYSTEPGROUP("Retry execution of  Step Group", InterruptType.RETRY_STEP_GROUP, "RetryStepGroup");
