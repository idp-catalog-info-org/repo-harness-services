...
@OwnedBy(CDP)
@AllArgsConstructor
public class K8sReleaseFunctorV2 extends LateBindingMap {
  Ambiance ambiance;
  @VisibleForTesting
  static final Set<String> SUPPORTED_STEP_TYPES =
      ImmutableSet.of(StepSpecTypeConstants.K8S_ROLLING_DEPLOY, StepSpecTypeConstants.K8S_BLUE_GREEN_DEPLOY,
          StepSpecTypeConstants.K8S_APPLY, StepSpecTypeConstants.K8S_BG_SWAP_SERVICES,
          StepSpecTypeConstants.K8S_CANARY_DEPLOY, StepSpecTypeConstants.K8S_DELETE,
          StepSpecTypeConstants.K8S_DRY_RUN_MANIFEST, StepSpecTypeConstants.RENDERING_STEP);
