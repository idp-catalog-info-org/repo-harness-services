...
import io.harness.pms.inputset.gitsync.dto.InputSetYamlInfoDTO;
import io.harness.pms.inputset.gitsync.dto.OverlayInputSetYamlInfoDTO;
import io.harness.pms.ngpipeline.inputset.beans.entity.InputSetEntity;
import io.harness.pms.ngpipeline.inputset.beans.entity.InputSetEntity.InputSetEntityKeys;
import io.harness.pms.ngpipeline.inputset.mappers.PMSInputSetElementMapper;
import io.harness.pms.ngpipeline.inputset.service.PMSInputSetService;
import io.harness.pms.ngpipeline.inputset.service.handler.InputSetFullGitSyncHandler;
...
public class InputSetEntityGitSyncHelper extends AbstractGitSdkEntityHandler<InputSetEntity, InputSetYamlDTO>
  ...
  public InputSetEntityGitSyncHelper(PMSInputSetService pmsInputSetService,
      InputSetFullGitSyncHandler inputSetFullGitSyncHandler, ScopeResolutionHelper scopeResolutionHelper) {
  ...
  public InputSetYamlDTO save(String accountIdentifier, String yaml) {
    ...
    InputSetEntity savedEntity = pmsInputSetService.create(initEntity, false, null);
  ...
  public boolean delete(EntityReference entityReference) {
    return pmsInputSetService.delete(null, ((InputSetReference) entityReference).getPipelineIdentifier(),
        entityReference.getIdentifier(), null, false);
  }
  ...
  public Optional<EntityGitDetails> getEntityDetailsIfExists(String accountIdentifier, String yaml) {
    ...
    if (inputSetYamlDTO.getInputSetInfo() != null) {
      ...
      inputSetEntity = pmsInputSetService.getWithoutValidations(
          scopeResolutionHelper.getScopeInfo(
              accountIdentifier, inputSetInfo.getOrgIdentifier(), inputSetInfo.getProjectIdentifier()),
          inputSetInfo.getPipelineInfoConfig().getIdentifier(), inputSetInfo.getIdentifier(), false, false, false,
          false);
    } else {
      final OverlayInputSetYamlInfoDTO overlayInputSetInfo = inputSetYamlDTO.getOverlayInputSetInfo();
      inputSetEntity = pmsInputSetService.getWithoutValidations(
          scopeResolutionHelper.getScopeInfo(
              accountIdentifier, overlayInputSetInfo.getOrgIdentifier(), overlayInputSetInfo.getProjectIdentifier()),
          overlayInputSetInfo.getPipelineIdentifier(), overlayInputSetInfo.getIdentifier(), false, false, false, false);
    }
  ...
  public String getYamlFromEntityRef(EntityDetailProtoDTO entityReference) {
    ...
    final Optional<InputSetEntity> inputSetEntity = pmsInputSetService.getWithoutValidations(
        ...
        StringValueUtils.getStringFromStringValue(inputSetRef.getIdentifier()), false, false, false, false);
