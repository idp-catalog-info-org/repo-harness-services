...
package io.harness.pms.pipeline.gitsync.helper;
...
import io.harness.pms.pipeline.mappers.dto.PipelineYamlDtoMapper;
...
public class PipelineEntityGitSyncHelper extends AbstractGitSdkEntityHandler<PipelineEntity, PipelineConfig>
  ...
  public PipelineConfig save(String accountIdentifier, String yaml) {
    ...
    ScopeInfo scopeInfo =
        scopeResolutionHelper.getScopeInfo(accountIdentifier, entity.getOrgIdentifier(), entity.getProjectIdentifier());
    PipelineCRUDResult pipelineCRUDResult = pmsPipelineService.validateAndCreatePipeline(entity, true, scopeInfo, true);
  ...
  public PipelineConfig update(String accountIdentifier, String yaml, ChangeType changeType) {
    ...
    PipelineCRUDResult pipelineCRUDResult =
        pmsPipelineService.validateAndUpdatePipeline(entity, changeType, true, false, scopeInfo, true);
    PipelineEntity pipelineEntity = pipelineCRUDResult.getPipelineEntity();
    return PipelineYamlDtoMapper.toDto(pipelineEntity);
  }
  ...
  public boolean delete(EntityReference entityReference) {
    try {
      return pmsPipelineService.delete(entityReference.getAccountIdentifier(), entityReference.getOrgIdentifier(),
          entityReference.getProjectIdentifier(), entityReference.getIdentifier(), null, null, false);
  ...
  protected PipelineConfig updateEntityFilePath(String accountIdentifier, String yaml, String newFilePath) {
    ...
    ScopeInfo scopeInfo =
        scopeResolutionHelper.getScopeInfo(accountIdentifier, entity.getOrgIdentifier(), entity.getProjectIdentifier());
    pipelineServiceHelper.resolveTemplatesAndValidatePipeline(entity, true, false, scopeInfo, true, false);
  ...
  public Optional<EntityGitDetails> getEntityDetailsIfExists(String accountIdentifier, String yaml) {
    ...
    try {
      final Optional<PipelineEntity> pipelineEntity = pmsPipelineService.getAndValidatePipeline(accountIdentifier,
          pipelineInfoConfig.getOrgIdentifier(), pipelineInfoConfig.getProjectIdentifier(),
          pipelineInfoConfig.getIdentifier(), false, false, false, null, false, false);
  ...
  public String getYamlFromEntityRef(EntityDetailProtoDTO entityReference) {
    ...
    final Optional<PipelineEntity> pipelineEntity = pmsPipelineService.getAndValidatePipeline(
        ...
        StringValueUtils.getStringFromStringValue(identifierRef.getIdentifier()), false, false, false, null, false,
        false);
