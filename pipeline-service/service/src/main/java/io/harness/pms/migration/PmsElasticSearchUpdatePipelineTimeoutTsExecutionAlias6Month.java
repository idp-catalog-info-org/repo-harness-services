...
@Slf4j
public class PmsElasticSearchUpdatePipelineTimeoutTsExecutionAlias6Month implements NGMigration {
    ...
    if (elasticsearchClient != null) {
      try {
        pipelineSearchService.updateIndexAlias(
            null, FIELD_NAME, DEFAULT_RETENTION_6_MONTHS, PipelineSearchFieldType.DATE);
      } catch (Exception ex) {
