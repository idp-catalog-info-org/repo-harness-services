...
public interface PipelineEnforcementService {
  ...
  void validateExecutionEnforcementsBasedOnStage(PipelineEntity pipelineEntity, String processedYaml);

  void validatePipelineChainingEnforcement(String accountIdentifier);

  void validatePipelineChainingInYaml(String accountId, String yaml, String orgIdentifier, String projectIdentifier);
}
