...
public class PlanExecutionUtils {
  public Plan extractPlan(PlanCreationBlobResponse planCreationBlobResponse, String accountId) {
    PlanBuilder planBuilder = Plan.builder();
    planBuilder.accountIdentifier(accountId);
    return buildPlan(planCreationBlobResponse, planBuilder, accountId);
  }

  public Plan extractPlan(String planNodeUuid, PlanCreationBlobResponse planCreationBlobResponse, String accountId) {
    PlanBuilder planBuilder = Plan.builder().uuid(planNodeUuid);
    planBuilder.accountIdentifier(accountId);
    return buildPlan(planCreationBlobResponse, planBuilder, accountId);
  }

  private Plan buildPlan(PlanCreationBlobResponse planCreationBlobResponse, PlanBuilder planBuilder, String accountId) {
