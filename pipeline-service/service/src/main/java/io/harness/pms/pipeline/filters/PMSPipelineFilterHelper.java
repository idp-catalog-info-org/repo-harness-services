...
public class PMSPipelineFilterHelper {
  public Update getUpdateOperationsForPatch(PipelineEntity pipelineEntity, long timestamp) {
    ...
    if (pipelineEntity.getAllowDynamicExecutions() != null) {
      update.set(PipelineEntityKeys.allowDynamicExecutions, pipelineEntity.getAllowDynamicExecutions());
    }
  ...
  public Update getPipelineFilterUpdateOperations(PipelineEntity pipelineEntity) {
    ...
    update.set(PipelineEntityKeys.stageCount, pipelineEntity.getStageCount());
    update.set(PipelineEntityKeys.stageNames, pipelineEntity.getStageNames());
    update.set(PipelineEntityKeys.templateModules, pipelineEntity.getTemplateModules());
    return update;
  }
  ...
  public Criteria getCriteriaForFind(String accountId, String parentUniqueId, String identifier, boolean notDeleted) {
    return Criteria.where(PipelineEntityKeys.accountId)
        .is(accountId)
  ...
  public Criteria getCriteriaForAllPipelinesInProject(ScopeInfo scopeInfo) {
    return Criteria.where(PipelineEntityKeys.accountId)
