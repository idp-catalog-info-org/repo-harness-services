...
public class ApprovalResourceImpl implements ApprovalResource {
  ...
  public ResponseDTO<ApprovalInstanceResponseDTO> getApprovalInstance(
      @NotEmpty String approvalInstanceId, @AccountIdentifier String accountId, boolean refresh) {
    return ResponseDTO.newResponse(approvalResourceService.get(approvalInstanceId, accountId, refresh));
  }
  ...
  public ResponseDTO<PageResponse<PendingApprovalSummaryDTO>> listPendingApprovals(
      @NotNull String accountId, int size) {
    return ResponseDTO.newResponse(approvalResourceService.listPendingApprovals(accountId, size));
  }
}
