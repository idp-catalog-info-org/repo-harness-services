...
public class InputSetEntity
  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList
        ...
        .add(CompoundMongoIndex.builder()
                 .name("unique_accountId_parentUniqueId_pipelineId_inputSetId_repo_branch")
                 .unique(true)
                 .field(InputSetEntityKeys.accountId)
                 .field(InputSetEntityKeys.parentUniqueId)
        ...
        .add(CompoundMongoIndex.builder()
                 .name("gitx_accountId_parentUniqueId_pipelineId_inputSetId_repo")
                 .field(InputSetEntityKeys.accountId)
                 .field(InputSetEntityKeys.parentUniqueId)
                 .field(InputSetEntityKeys.pipelineIdentifier)
                 .field(InputSetEntityKeys.identifier)
        ...
        .add(SortCompoundMongoIndex.builder()
                 .name("accountId_parentUniqueId_repo_branch_WithCollationIdx")
                 .field(InputSetEntityKeys.accountId)
                 .field(InputSetEntityKeys.parentUniqueId)
                 .field(InputSetEntityKeys.yamlGitConfigRef)
                 .field(InputSetEntityKeys.branch)
                 ...
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("gitx_accountId_parentUniqueId_pipelineId_name_WithCollationIdx")
                 .field(InputSetEntityKeys.accountId)
                 .field(InputSetEntityKeys.parentUniqueId)
                 .field(InputSetEntityKeys.pipelineIdentifier)
                 .ascSortField(InputSetEntityKeys.name)
                 .collation(
                     Collation.builder().locale(CollationLocale.ENGLISH).strength(CollationStrength.SECONDARY).build())
                 .build())
        .build();
  ...
  // These references can be out of sync for remote overlay input sets, compute it as runtime instead
  ...
  @FdUniqueIndex @Setter @NonFinal String uniqueId;
