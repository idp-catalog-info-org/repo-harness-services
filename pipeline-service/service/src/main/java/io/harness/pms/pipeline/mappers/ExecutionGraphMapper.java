...
public class ExecutionGraphMapper {
  ...
  public ExecutionGraph toExecutionGraph(
      OrchestrationGraphDTO orchestrationGraph, PipelineExecutionSummaryEntity summaryEntity, ScopeInfo scopeInfo) {
    return ExecutionGraph.builder()
        ...
        .executionMetadata(getMetadataMap(summaryEntity, scopeInfo))
        .build();
  }
  ...
  public Map<String, String> getMetadataMap(PipelineExecutionSummaryEntity summaryEntity, ScopeInfo scopeInfo) {
    ...
    if (summaryEntity.getOrgIdentifier() != null) {
      executionMetadata.put(PipelineExecutionSummaryKeys.orgIdentifier,
          useScopeInfo ? scopeInfo.getOrgIdentifier() : summaryEntity.getOrgIdentifier());
    }
    if (summaryEntity.getProjectIdentifier() != null) {
      executionMetadata.put(PipelineExecutionSummaryKeys.projectIdentifier,
          useScopeInfo ? scopeInfo.getProjectIdentifier() : summaryEntity.getProjectIdentifier());
    }
