...
public class BuildTriggerEventMapper {
  ...
  private void saveEventHistoryForNotMatchedTriggers(
    ...
    for (UnMatchedTriggerInfo unMatchedTriggerInfo : webhookEventMappingResponse.getUnMatchedTriggerInfoList()) {
      ...
      // trigger entity's orgIdentifier and projectIdentifer are needed for trigger Event history.
      // The removal of projectid/orgid field in trigger entity should be done after triggerEventHistory.
      TriggerEventHistory triggerEventHistory =
          TriggerEventHistory.builder()
              ...
              .parentUniqueId(unMatchedTriggerInfo.getUnMatchedTriggers().getNgTriggerEntity().getParentUniqueId())
