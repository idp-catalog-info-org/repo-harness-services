...
public abstract class AbstractApprovalCallback {
  ...
  protected void checkApprovalAndRejectionCriteriaAndWithinChangeWindow(TicketNG ticket, ApprovalInstance instance,
    ...
    boolean approvalEvaluationResult = evaluateCriteria(ticket, approvalCriteriaSpec, logCallback, instance);
    ...
    boolean rejectionEvaluationResult = evaluateCriteria(ticket, rejectionCriteriaSpec, logCallback, instance);
  ...
  protected abstract boolean evaluateCriteria(
