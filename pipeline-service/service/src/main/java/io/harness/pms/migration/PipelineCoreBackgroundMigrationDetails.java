...
public class PipelineCoreBackgroundMigrationDetails implements MigrationDetails {
  ...
  public List<Pair<Integer, Class<? extends NGMigration>>> getMigrations() {
    return new ImmutableList.Builder<Pair<Integer, Class<? extends NGMigration>>>()
        ...
        // increase in count as the previous migration did not migrate all the documents as expected.
        .add(Pair.of(5, NGTriggerTypeMigration.class))
        .add(Pair.of(6, PipelineBranchSequenceDedupMigration.class))
        .build();
  }
}
