...
public class OutcomeServiceGrpcServerImpl extends OutcomeProtoServiceImplBase {
  ...
  @Inject
  public OutcomeServiceGrpcServerImpl(
      PmsOutcomeService pmsOutcomeService, BlockExecutionMetadataService blockExecutionMetadataService) {
