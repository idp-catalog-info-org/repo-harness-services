...
public interface PipelineMetadataService {
  ...
  Optional<PipelineMetadataV2> getMetadata(String accountId, String parentUniqueId, String identifier);

  Map<String, PipelineMetadataV2> getMetadataForGivenPipelineIds(String accountId, String orgIdentifier,
   ...
   * @return
   */
  boolean deletePipelineMetadata(
