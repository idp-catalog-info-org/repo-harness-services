...
public class PipelineCRUDErrorResponse {
  ...
  public String errorMessageForInvalidYamlOnGit(String orgId, String projectId, String pipelineId, String branch) {
    return format("Invalid YAML found on Git in branch [%s] for Pipeline [%s] under Project[%s], Organization [%s].",
        branch, pipelineId, projectId, orgId);
  }
