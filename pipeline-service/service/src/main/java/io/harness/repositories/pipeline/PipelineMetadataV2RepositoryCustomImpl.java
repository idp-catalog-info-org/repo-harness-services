...
public class PipelineMetadataV2RepositoryCustomImpl implements PipelineMetadataV2RepositoryCustom {
  ...
  @Override
  public PipelineMetadataV2 incCounter(String accountId, ScopeInfo scopeInfo, String pipelineId) {
    Update update = new Update();
    Criteria criteria = Criteria.where(PipelineMetadataV2Keys.accountIdentifier)
                            .is(accountId)
  ...
  @Override
  public Optional<PipelineMetadataV2> getPipelineMetadata(String accountId, String parentUniqueId, String identifier) {
    Criteria criteria = Criteria.where(PipelineMetadataV2Keys.accountIdentifier)
                            .is(accountId)
                            .and(PipelineMetadataV2Keys.parentUniqueId)
                            .is(parentUniqueId)
  ...
  @Override
  public List<PipelineMetadataV2> getMetadataForGivenPipelineIds(
      String accountId, String parentUniqueId, List<String> identifiers) {
    Criteria criteria = Criteria.where(PipelineMetadataV2Keys.accountIdentifier)
                            .is(accountId)
                            .and(PipelineMetadataV2Keys.parentUniqueId)
                            .is(parentUniqueId)
  ...
  @Override
  public Optional<PipelineMetadataV2> cloneFromPipelineMetadata(String accountIdentifier, String orgIdentifier,
      String projectIdentifier, String parentUniqueId, String identifier) {
    ...
    PipelineMetadataV2Builder pipelineMetadataV2Builder = PipelineMetadataV2.builder()
    ...
    if (pipelineMetadata == null) {
      return Optional.of(mongoTemplate.save(pipelineMetadataV2Builder.runSequence(1).build()));
    }
    return Optional.of(
        mongoTemplate.save(pipelineMetadataV2Builder.runSequence(pipelineMetadata.getRunSequence() + 1).build()));
  }
