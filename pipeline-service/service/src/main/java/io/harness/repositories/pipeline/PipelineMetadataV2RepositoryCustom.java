...
public interface PipelineMetadataV2RepositoryCustom {
  ...
  PipelineMetadataV2 incCounter(String accountId, ScopeInfo scopeInfo, String pipelineId);

  Optional<PipelineMetadataV2> getPipelineMetadata(
      String accountId, String orgId, String projectIdentifier, String identifier);

  Optional<PipelineMetadataV2> getPipelineMetadata(String accountId, String parentUniqueId, String identifier);
  ...
  Optional<PipelineMetadataV2> cloneFromPipelineMetadata(String accountIdentifier, String orgIdentifier,
