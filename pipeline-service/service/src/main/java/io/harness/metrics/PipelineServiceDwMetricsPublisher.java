...
public class PipelineServiceDwMetricsPublisher implements MetricsPublisher {
  ...
  private void addTimerMetricsForResources(String metricName, Timer timer) {
    ...
    try (DwMetricContext ignore =
      ...
      recordSnapshot(
          DwMetricContext.IO_HARNESS_RESOURCE_RESPONSES_LATENCY_METRIC_NAME + "_snapshot", timer.getSnapshot());
    }
  }

  private boolean checkIfResourceMetrics(String metricName, String additionalMetricNameCheck) {
    List<String> resourcesList = List.of("PipelineResource", "InputSetResourcePMS", "PlanExecutionResource",
        "ExecutionDetailsResource", "NGTriggerResource", "NGTriggerEventHistoryResource",
        "NGTriggerWebhookConfigResource", "PMSLandingDashboardResource", "PipelineRefreshResource");
