    ...
    try {
      ...
      List<PredefinedTemplate> templates = new ArrayList<>(
          Arrays.asList(PredefinedTemplate.PIPELINE_PLAIN_SLACK, PredefinedTemplate.PIPELINE_PLAIN_WEBHOOK,
              PredefinedTemplate.PIPELINE_PLAIN_DATADOG, PredefinedTemplate.PIPELINE_PLAIN_EMAIL,
              PredefinedTemplate.PIPELINE_PLAIN_PAGERDUTY, PredefinedTemplate.PIPELINE_PLAIN_MSTEAMS,
              PredefinedTemplate.PIPELINE_PLAIN_MSTEAMS_WF, PredefinedTemplate.STAGE_PLAIN_SLACK,
              PredefinedTemplate.STAGE_PLAIN_WEBHOOK, PredefinedTemplate.STAGE_PLAIN_DATADOG,
              PredefinedTemplate.STAGE_PLAIN_EMAIL, PredefinedTemplate.STAGE_PLAIN_PAGERDUTY,
              PredefinedTemplate.STAGE_PLAIN_MSTEAMS, PredefinedTemplate.STAGE_PLAIN_MSTEAMS_WF,
              PredefinedTemplate.STEP_PLAIN_EMAIL, PredefinedTemplate.STEP_PLAIN_SLACK,
              PredefinedTemplate.STEP_PLAIN_WEBHOOK, PredefinedTemplate.STEP_PLAIN_DATADOG,
              PredefinedTemplate.STEP_PLAIN_MSTEAMS, PredefinedTemplate.STEP_PLAIN_MSTEAMS_WF,
              ...
              PredefinedTemplate.HARNESS_APPROVAL_NOTIFICATION_MSTEAMS_WF,
              PredefinedTemplate.HARNESS_APPROVAL_EXECUTION_NOTIFICATION_MSTEAMS,
              PredefinedTemplate.HARNESS_APPROVAL_EXECUTION_NOTIFICATION_MSTEAMS_WF,
              ...
              PredefinedTemplate.HARNESS_APPROVAL_ACTION_NOTIFICATION_MSTEAMS_WF,
              ...
              PredefinedTemplate.HARNESS_APPROVAL_ACTION_EXECUTION_NOTIFICATION_MSTEAMS_WF,
              PredefinedTemplate.TRIGGER_PLAIN_EMAIL, PredefinedTemplate.TRIGGER_PLAIN_WEBHOOK,
              PredefinedTemplate.TRIGGER_PLAIN_SLACK, PredefinedTemplate.TRIGGER_PLAIN_PAGERDUTY,
              PredefinedTemplate.TRIGGER_PLAIN_DATADOG, PredefinedTemplate.TRIGGER_PLAIN_MSTEAMS,
              PredefinedTemplate.TRIGGER_PLAIN_MSTEAMS_WF));
      while (true) {
