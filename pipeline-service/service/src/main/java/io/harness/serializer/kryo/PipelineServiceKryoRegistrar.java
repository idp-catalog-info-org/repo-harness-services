...
import io.harness.pms.preflight.service.PreflightNotifyCallback;
...
public class PipelineServiceKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(PreflightNotifyCallback.class, 800010);
    kryo.register(EmptyResponseData.class, 800011);
    kryo.register(AbortAllPlanExecutionsCallback.class, 800012);
    kryo.register(ConversionJobEntity.class, 800013);
    kryo.register(ConversionChecksum.class, 800014);
  }
}
