...
SELECT createPartitioningTable(
    param_table_name := 'pipeline_execution_summary_ci',
...
BEGIN;
SELECT createPartitioningTable(
    param_table_name := 'pipeline_execution_summary_cd',
    param_column_name := 'startts',
    p_interval := '604800000'
);
COMMIT;
...
BEGIN;
SELECT createPartitioningTable(
    param_table_name := 'service_infra_info',
    param_column_name := 'service_startts',
    p_interval := '604800000'
);
COMMIT;
