...
public class NotificationTemplateRegistrarTest extends PipelineServiceTestBase {
  ...
  public void testNotificationTemplatesRegistration() {
    ...
    verify(notificationClient, times(1))
        .saveNotificationTemplate(Team.PIPELINE, PredefinedTemplate.PIPELINE_PLAIN_MSTEAMS_WF, true);
    verify(notificationClient, times(1))
    ...
    verify(notificationClient, times(1))
        .saveNotificationTemplate(Team.PIPELINE, PredefinedTemplate.STAGE_PLAIN_MSTEAMS_WF, true);
    verify(notificationClient, times(1))
    ...
    verify(notificationClient, times(1))
        .saveNotificationTemplate(Team.PIPELINE, PredefinedTemplate.STEP_PLAIN_MSTEAMS_WF, true);
    verify(notificationClient, times(1))
    ...
    verify(notificationClient, times(1))
        .saveNotificationTemplate(
            Team.PIPELINE, PredefinedTemplate.HARNESS_APPROVAL_EXECUTION_NOTIFICATION_MSTEAMS_WF, true);
    verify(notificationClient, times(1))
        .saveNotificationTemplate(Team.PIPELINE, PredefinedTemplate.HARNESS_APPROVAL_NOTIFICATION_MSTEAMS, true);
    verify(notificationClient, times(1))
        .saveNotificationTemplate(Team.PIPELINE, PredefinedTemplate.HARNESS_APPROVAL_NOTIFICATION_MSTEAMS_WF, true);
  }
}
