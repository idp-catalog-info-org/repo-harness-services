...
public class AccountFunctorTest extends CategoryTest {
  ...
  public void testBind() throws IOException {
    ...
    RestResponse<AccountDTO> restRequest = new RestResponse<>();
    restRequest.setResource(accountDTO);
    aStatic.when(() -> SafeHttpCall.execute(any())).thenReturn(restRequest);
    assertEquals(accountFunctor.bind(), MapperUtils.toMapViaJsonString(accountDTO));
  }
}
