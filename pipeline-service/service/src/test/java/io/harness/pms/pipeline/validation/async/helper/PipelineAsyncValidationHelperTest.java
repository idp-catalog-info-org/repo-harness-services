...
public class PipelineAsyncValidationHelperTest extends CategoryTest {
  ...
  public void testBuildFQN() {
    PipelineEntity entity = PipelineEntity.builder()
                                ...
                                .build();
    assertThat(PipelineAsyncValidationHelper.buildFQN(entity, null, false)).isEqualTo("acc/parentId/id");
    assertThat(PipelineAsyncValidationHelper.buildFQN(entity, "", false)).isEqualTo("acc/parentId/id");
    assertThat(PipelineAsyncValidationHelper.buildFQN(entity, "br", false)).isEqualTo("acc/parentId/id/br");
  }
