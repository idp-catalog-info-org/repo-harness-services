...
public class PlanExecutionContextMapperTest extends CategoryTest {
  ...
  @Category(UnitTests.class)
  public void testCreatePlanExecutionContext_withEnableDAGTrue() {
    ExecutionMetadata executionMetadata = ExecutionMetadata.newBuilder()
                                              .setExecutionUuid("execId")
                                              .setRunSequence(3)
                                              .setModuleType("cd")
                                              ...
                                              .build();
    PlanExecutionContext planExecutionContext = PlanExecutionContextMapper.toExecutionContext(
        executionMetadata, Collections.emptyMap(), Collections.emptyMap());
    assertThat(planExecutionContext.getExecutionUuid()).isEqualTo("execId");
    assertThat(planExecutionContext.getEnableDAG()).isTrue();
  }

  @Test
  @Owner(developers = KUSHAL_DASARI)
  @Category(UnitTests.class)
  public void testCreatePlanExecutionContext_withEnableDAGFalse() {
    ExecutionMetadata executionMetadata = ExecutionMetadata.newBuilder()
                                              .setExecutionUuid("execId")
                                              .setRunSequence(3)
                                              .setModuleType("cd")
    ...
    PlanExecutionContext planExecutionContext = PlanExecutionContextMapper.toExecutionContext(
        executionMetadata, Collections.emptyMap(), Collections.emptyMap());
    assertThat(planExecutionContext.getExecutionUuid()).isEqualTo("execId");
    assertThat(planExecutionContext.getEnableDAG()).isFalse();
  }

  @Test
  @Owner(developers = KUSHAL_DASARI)
  @Category(UnitTests.class)
  public void testCreatePlanExecutionContext_withNullMetadata() {
    PlanExecutionContext planExecutionContext =
        PlanExecutionContextMapper.toExecutionContext(null, Collections.emptyMap(), Collections.emptyMap());
    assertThat(planExecutionContext.getEnableDAG()).isFalse();
  }
}