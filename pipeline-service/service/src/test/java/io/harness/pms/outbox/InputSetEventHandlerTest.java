...
public class InputSetEventHandlerTest extends CategoryTest {
  ...
  public void testCreate() throws IOException {
    ...
    InputSetCreateEvent inputSetCreateEvent = new InputSetCreateEvent(
        accountIdentifier, orgIdentifier, projectIdentifier, pipelineIdentifier, inputSet, false, scopeInfo);
    ...
    assertAuditEntryWithUniqueId(uniqueId, parentUniqueId, auditEntry);
  ...
  public void testUpdate() throws IOException {
    ...
    InputSetUpdateEvent inputSetUpdateEvent = new InputSetUpdateEvent(accountIdentifier, orgIdentifier,
        projectIdentifier, pipelineIdentifier, newInputSet, oldInputSet, false,
        ScopeInfo.builder()
            .accountIdentifier(accountIdentifier)
            .orgIdentifier(orgIdentifier)
            .projectIdentifier(projectIdentifier)
  ...
  public void testUpdateWithOldInputSetAsNull() throws IOException {
    ...
    InputSetEntity newInputSet =
        InputSetEntity.builder().name(randomAlphabetic(10)).identifier(identifier).yaml(newYaml).build();
    InputSetUpdateEvent inputSetUpdateEvent = new InputSetUpdateEvent(accountIdentifier, orgIdentifier,
        projectIdentifier, pipelineIdentifier, newInputSet, null, false,
        ScopeInfo.builder()
            .accountIdentifier(accountIdentifier)
            .orgIdentifier(orgIdentifier)
            .projectIdentifier(projectIdentifier)
  ...
  private void assertAuditEntryWithUniqueId(String uniqueId, String parentUniqueId, AuditEntry auditEntry) {
    assertNotNull(auditEntry);
    assertEquals(uniqueId, auditEntry.getResource().getUniqueId());
    assertEquals(parentUniqueId, auditEntry.getResourceScope().getUniqueId());
  }
