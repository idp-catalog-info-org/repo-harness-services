...
@OwnedBy(PIPELINE)
public class PipelineCreateEventTest extends CategoryTest {
  ...
  public void testConstructorWithoutFeatureFlagHelper() {
    PipelineCreateEvent event = new PipelineCreateEvent(ACCOUNT_ID, ORG_ID, PROJECT_ID, pipelineEntity);
  ...
  public void testConstructorWithFeatureFlagHelper() {
    PipelineCreateEvent event =
        new PipelineCreateEvent(ACCOUNT_ID, ORG_ID, PROJECT_ID, pipelineEntity, pmsFeatureFlagHelper);
  ...
  public void testBuilderConstructor() {
    PipelineCreateEvent event = PipelineCreateEvent.builder()
  ...
  public void testGetEventType() {
    ...
    assertThat(event.getEventType()).isEqualTo(PipelineOutboxEvents.PIPELINE_CREATED);
  }
}
