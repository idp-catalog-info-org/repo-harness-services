...
public class ServiceNowApprovalCallbackTest extends CategoryTest {
  ...
  public void setUp() {
    ...
    on(serviceNowApprovalCallback).set("pmsFeatureFlagService", pmsFeatureFlagService);
  }
  ...
  public void testPush() {
    try (MockedStatic<ServiceNowCriteriaEvaluator> mockStatic = Mockito.mockStatic(ServiceNowCriteriaEvaluator.class)) {
      mockStatic.when(() -> ServiceNowCriteriaEvaluator.evaluateCriteria(any(), any(), any())).thenReturn(true);
      ...
      when(ServiceNowCriteriaEvaluator.evaluateCriteria(any(), any(), any())).thenReturn(false);
      serviceNowApprovalCallback.push(response);
      ...
      when(ServiceNowCriteriaEvaluator.evaluateCriteria(any(), eq(rejectionCriteria), any())).thenReturn(true);
      serviceNowApprovalCallback.push(response);
      ...
      when(ServiceNowCriteriaEvaluator.evaluateCriteria(any(), any(), any()))
