...
public class StagesExecutionHelperTest extends CategoryTest {
  ...
  public void testThrowErrorIfAllStagesAreDeleted() {
    StagesExecutionHelper.throwErrorIfAllStagesAreDeleted(
        pipelineYaml, Collections.singletonList("s2"), HarnessYamlVersion.V0);
    StagesExecutionHelper.throwErrorIfAllStagesAreDeleted(
        pipelineYaml, Arrays.asList("s2", "s3", "s4"), HarnessYamlVersion.V0);
    assertThatThrownBy(()
                           -> StagesExecutionHelper.throwErrorIfAllStagesAreDeleted(
                               pipelineYaml, Collections.singletonList("s3"), HarnessYamlVersion.V0))
  ...
  public void testGetStagesExecutionInfo() {
    ...
    StagesExecutionInfo stagesExecutionInfo0 =
        StagesExecutionHelper.getStagesExecutionInfo(pipelineYaml, stagesToRun, null, HarnessYamlVersion.V0);
    ...
    assertThat(stagesExecutionInfo0.getStageIdentifierToNameMap().keySet()).isEqualTo(Set.of("s2"));
    ...
    StagesExecutionInfo stagesExecutionInfo1 = StagesExecutionHelper.getStagesExecutionInfo(
        pipelineYaml, stagesToRun, expressionValues, HarnessYamlVersion.V0);
    ...
    assertThat(stagesExecutionInfo1.getStageIdentifierToNameMap().keySet()).isEqualTo(Set.of("s2"));
