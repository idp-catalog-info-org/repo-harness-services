...
public class ServiceNowApprovalHelperServiceImplTest extends CategoryTest {
  ...
  @Mock RunnerTaskExecutor runnerTaskExecutor;
  ...
  public void setUp() {
    ...
    serviceNowApprovalHelperService =
        spy(new ServiceNowApprovalHelperServiceImpl(connectorResourceClient, pmsGitSyncHelper,
            logStreamingStepClientFactory, secretManagerClient, ngDelegate2TaskExecutor, kryoSerializer, publisherName,
            waitNotifyEngine, approvalInstanceService, runnerTaskExecutor, oidcContextHelper, pmsFeatureFlagHelper));
  }
