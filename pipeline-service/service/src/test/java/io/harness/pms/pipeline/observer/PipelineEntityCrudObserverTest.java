  ...
  public void testOnDelete() {
    ...
    EntityChangeDTO.Builder pipelineEntityChangeDTOBuilder =
        EntityChangeDTO.newBuilder()
            ...
            .setUniqueId(StringValue.of(pipelineEntity.getUniqueId()))
            .setScopeInfo(
                ScopeInfo.newBuilder().setUniqueId(StringValue.of(pipelineEntity.getParentUniqueId())).build())
