...
public class PipelineNotificationUtilsTest extends CategoryTest {
  ...
  public void testGetStatusForImage() {
    ...
    assertEquals(PipelineNotificationUtils.getStatusForImage(Status.ASYNC_WAITING), "resumed");
  }
  ...
  public void testGetNodeStatus() {
    ...
    assertEquals(PipelineNotificationUtils.getNodeStatus(null, pipelineEventType, true), "started");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.SUCCEEDED, PipelineEventType.PIPELINE_SUCCESS, true),
        "succeeded");
    assertEquals(PipelineNotificationUtils.getStatusForImage(Status.IGNORE_FAILED), "completed");
    assertEquals(
        PipelineNotificationUtils.getNodeStatus(Status.FAILED, PipelineEventType.PIPELINE_FAILED, true), "failed");
    assertEquals(
        PipelineNotificationUtils.getNodeStatus(Status.ERRORED, PipelineEventType.PIPELINE_FAILED, true), "failed");
    assertEquals(
        PipelineNotificationUtils.getNodeStatus(Status.PAUSED, PipelineEventType.PIPELINE_PAUSED, true), "paused");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.ABORTED, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.APPROVAL_REJECTED, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.EXPIRED, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.QUEUED, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.RUNNING, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.SKIPPED, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.ASYNC_WAITING, pipelineEventType, true), "ended");
    assertEquals(PipelineNotificationUtils.getNodeStatus(Status.ASYNC_WAITING, PipelineEventType.PIPELINE_START, true),
        "started");
  }
