...
public class StagesExecutionInfoTest extends CategoryTest {
  ...
  public void testToStagesExecutionMetadata() {
    ...
    LinkedHashMap<String, String> identifierToNameMap = new LinkedHashMap<>();
    identifierToNameMap.put("id", "name");
    StagesExecutionInfo stagesExecutionInfo0 = StagesExecutionInfo.builder()
                                                   ...
                                                   .stageIdentifierToNameMap(identifierToNameMap)
    ...
    assertThat(stagesExecutionMetadata0.getStageIdentifierToNameMap().get("id")).isEqualTo("name");
