...
public class PMSOutboxEventHandlerTest {
  ...
  public void setup() throws Exception {
    ...
    TriggerOutboxEventHandler triggerOutboxEventHandler =
        new TriggerOutboxEventHandler(auditClientService, objectMapper);
  ...
  public void testInputSetCreate() throws Exception {
    ...
    InputSetCreateEvent inputSetCreateEvent = new InputSetCreateEvent(
        accountIdentifier, orgIdentifier, projectIdentifier, pipelineIdentifier, inputSet, false, null);
