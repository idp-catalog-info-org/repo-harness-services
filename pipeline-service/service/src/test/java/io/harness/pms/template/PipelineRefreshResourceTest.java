...
public class PipelineRefreshResourceTest extends PipelineServiceTestBase {
    ...
    ResponseDTO<Boolean> responseDTO =
        ResponseDTO
            .newResponse(pipelineRefreshResource.refreshAndUpdateTemplate(
                ACCOUNT_ID, ORG_IDENTIFIER, PROJ_IDENTIFIER, PIPELINE_IDENTIFIER, "false", null, null))
            .getData();
    verify(pipelineRefreshService, times(1))
        .refreshTemplateInputsInPipeline(
            ACCOUNT_ID, ORG_IDENTIFIER, PROJ_IDENTIFIER, PIPELINE_IDENTIFIER, "false", null);
  ...
  public void testValidateTemplateInputs() {
    ResponseDTO.newResponse(pipelineRefreshResource
                                ...
                                .getData());
    verify(pipelineRefreshService, times(1))
        .validateTemplateInputsInPipeline(
            ACCOUNT_ID, ORG_IDENTIFIER, PROJ_IDENTIFIER, PIPELINE_IDENTIFIER, "false", null);
    verifyNoMoreInteractions(pipelineRefreshService);
  }
  ...
  public void testGetYamlDiff() {
    ResponseDTO.newResponse(
        pipelineRefreshResource
            .getYamlDiff(ACCOUNT_ID, ORG_IDENTIFIER, PROJ_IDENTIFIER, PIPELINE_IDENTIFIER, "false", null, null)
            .getData());
    verify(pipelineRefreshService, times(1))
  ...
  public void testRefreshAll() {
    ...
    ResponseDTO.newResponse(
        pipelineRefreshResource
            .refreshAll(ACCOUNT_ID, ORG_IDENTIFIER, PROJ_IDENTIFIER, PIPELINE_IDENTIFIER, "false", null, null)
            .getData());
    verify(pipelineRefreshService, times(1))
