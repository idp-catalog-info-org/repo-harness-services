...
public class PipelineServiceGrpcModuleTest extends PipelineServiceTestBase {
  ...
  @Before
  public void setUp() {
    pipelineServiceGrpcModule = PipelineServiceGrpcModule.getInstance(false, null);
    ...
    executionServiceGrpcService = mock(ExecutionServiceGrpcImpl.class);
    ...
    doCallRealMethod().when(executionServiceGrpcService).bindService();
  }
  ...
  public void testBindableServices() {
    Set<BindableService> bindableServices =
        pipelineServiceGrpcModule.bindableServices(healthStatusManager, pmsSdkInstanceService, pmsExecutionGrpcService,
            sweepingOutputService, outcomeServiceGrpcServer, engineExpressionGrpcService, interruptGrpcService,
            entityReferenceGrpcService, variablesService, executionServiceGrpcService);
