...
public class PipelinePersistenceTestModule extends SpringPersistenceModule {
  ...
  protected MongoTemplate getSecondaryMongoTemplate(
    ...
    HMongoTemplate template = new HMongoTemplate(mongoTemplate.getMongoDatabaseFactory(), mongoTemplate.getConverter(),
        primaryMongoConfig, bucketRegistry, QueryBudgetBindings.resolveQueryBudgetMetrics(injector), null);
