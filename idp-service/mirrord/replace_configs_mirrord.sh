...
IDP_SERVICE_CONFIG=$HOME/.bazel_runner/.mirrord/harness-services/idp-service
CONFIG_FILE=$IDP_SERVICE_CONFIG/config.yml
REDISSON_CACHE_FILE=$IDP_SERVICE_CONFIG/redisson-jcache.yaml
ENTERPRISE_REDISSON_CACHE_FILE=$IDP_SERVICE_CONFIG/enterprise-redisson-jcache.yaml
