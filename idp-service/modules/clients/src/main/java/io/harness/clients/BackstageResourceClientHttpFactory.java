...
public class BackstageResourceClientHttpFactory implements Provider<BackstageResourceClient> {
  ...
  private static final int MAX_STRING_LENGTH = 50000000;
  ...
  private OkHttpClient getHttpClient() {
    return Http.getOkHttpClientWithProxyAuthSetup()
        ...
        .addInterceptor(new BackstageRequestInterceptor(
            secretManagerClientService, env, this.backstageClientConfig.getBaseUrl(), accountsDetailsCache))
        .build();
  }
}
