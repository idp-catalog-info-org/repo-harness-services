...
public class DelegateProxyApiImplTest extends CategoryTest {
  ...
  public void testForwardProxy() throws JsonProcessingException {
    ...
    when(delegateProxyRequestForwarder.createHeaderConfig(backstageProxyRequest.getHeaders())).thenReturn(headers);
    when(
        delegateProxyRequestForwarder.forwardRequestToDelegate(ACCOUNT_IDENTIFIER, backstageProxyRequest.getUrl(),
            headers, backstageProxyRequest.getBody(), backstageProxyRequest.getMethod(), delegateSelectors, null, null))
