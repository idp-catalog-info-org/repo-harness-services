...
public class IDPLicenseUsageImplTest extends CategoryTest {
  ...
  public void testGetLicenseUsage() {
    ...
    when(activeDevelopersRepository.findByAccountIdentifierAndLastAccessedAtGreaterThan(anyString(), anyLong()))
  ...
  public void testGetLicenseUsageCSVReport() {
    File file = idpLicenseUsage.getLicenseUsageCSVReport(
        TEST_ACCOUNT_IDENTIFIER, ModuleType.IDP, System.currentTimeMillis(), Optional.empty());
    assertNull(file);
  }
