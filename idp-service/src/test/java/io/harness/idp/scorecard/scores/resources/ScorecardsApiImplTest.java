...
public class ScorecardsApiImplTest extends CategoryTest {
  ...
  public void testGetEntityFacets() {
    ...
    EntityFiltersResponse entityFiltersResponse1 = new EntityFiltersResponse();
    entityFiltersResponse1.setFilter("type");
    entityFiltersResponse1.setValues(List.of("service"));
    entityFiltersResponses.add(entityFiltersResponse1);
    EntityFiltersResponse entityFiltersResponse2 = new EntityFiltersResponse();
    entityFiltersResponse2.setFilter("tags");
    entityFiltersResponse2.setValues(List.of("java"));
    entityFiltersResponses.add(entityFiltersResponse2);
    EntityFiltersResponse entityFiltersResponse3 = new EntityFiltersResponse();
    entityFiltersResponse3.setFilter("lifecycle");
    entityFiltersResponse3.setValues(List.of("production"));
    entityFiltersResponses.add(entityFiltersResponse3);
    when(scorecardService.getAllEntityFacets(ACCOUNT_ID, KIND)).thenReturn(entityFiltersResponses);
