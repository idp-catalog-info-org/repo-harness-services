...
public class KubernetesDataPointParserFactoryTest extends CategoryTest {
  ...
  public void testGetParser() {
    assertEquals(kubernetesReplicasParser, factory.getParser(REPLICAS, null));
    assertEquals(kubernetesLastDeployedParser, factory.getParser(DAYS_SINCE_LAST_DEPLOYED, null));
  }
  ...
  public void testGetParserUnsupported() {
    factory.getParser("unsupported", null);
  }
}
