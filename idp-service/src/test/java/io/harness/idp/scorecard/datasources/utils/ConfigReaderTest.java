...
public class ConfigReaderTest extends CategoryTest {
  ...
  private static final String ERROR_MESSAGE_FOR_DECRYPTED_VALUE_EMPTY =
      "Could not get the decrypted value for secret: test-secret-identifier, used by env: HARNESS_GITHUB_TOKEN, in "
      + "account: test-accountIdentifier";
  ...
  public void testGetConfigValues() {
    ...
    when(backstageEnvVariableService.getDecryptedValueAndLastModifiedTime(
             TEST_ENV_VARIABLE_SECRET_NAME, TEST_SECRET_IDENTIFIER, TEST_ACCOUNT_IDENTIFIER, null, null))
