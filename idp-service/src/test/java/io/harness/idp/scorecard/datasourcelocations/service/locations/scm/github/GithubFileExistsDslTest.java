...
public class GithubFileExistsDslTest extends CategoryTest {
  AutoCloseable openMocks;
  @InjectMocks GithubFileExistsDsl githubFileExistsDsl;
  ...
  public void testFetchData() {
    ...
    Map<String, Object> data = githubFileExistsDsl.fetchData(ACCOUNT_ID, null, getDataSourceLocationEntity(),
        List.of(getDataFetchDTO("README.md")), replaceableHeaders(), possibleReplaceableRequestBody(),
        possibleReplaceableUrlBody(), getDataSourceConfig(), true, Set.of());
    assertNotNull(data);
  ...
  private DataFetchDTO getDataFetchDTO(String path) {
    DataPointEntity dataPointEntity =
        DataPointEntity.builder().dataSourceIdentifier(GITHUB_IDENTIFIER).identifier(IS_FILE_EXISTS).build();
