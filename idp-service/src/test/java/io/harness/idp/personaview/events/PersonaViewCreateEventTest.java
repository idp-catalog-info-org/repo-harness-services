...
@OwnedBy(IDP)
public class PersonaViewCreateEventTest extends CategoryTest {
  static final String TEST_ACCOUNT_IDENTIFIER = "testAccount123";
  static final String TEST_VIEW_IDENTIFIER = "platform";
  static final String TEST_VIEW_NAME = "Platform View";
  ...
  public void testPersonaViewCreateEvent() {
    PersonaViewCreateEvent event = new PersonaViewCreateEvent(personaView, TEST_ACCOUNT_IDENTIFIER);

    assertNotNull(event);
    assertEquals(personaView, event.getNewPersonaView());
  ...
  public void testGetEventType() {
    ...
    assertEquals(PERSONA_VIEW_CREATED, event.getEventType());
  }
  ...
  public void testNoArgsConstructor() {
    PersonaViewCreateEvent event = new PersonaViewCreateEvent();
    assertNotNull(event);
  }
}
