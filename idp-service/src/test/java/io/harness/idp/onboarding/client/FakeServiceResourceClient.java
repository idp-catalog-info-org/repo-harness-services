...
public class FakeServiceResourceClient implements ServiceResourceClient {
  ...
  public Call<ResponseDTO<ServiceResponse>> getService(
    ...
    return new Call<>() {
      @Override
      public Response<ResponseDTO<ServiceResponse>> execute() {
        return Response.success(ResponseDTO.newResponse(ServiceResponse.builder()
                                                            .service(ServiceResponseDTO.builder()
                                                                         .identifier(TEST_SERVICE_IDENTIFIER)
                                                                         .accountId(ACCOUNT_IDENTIFIER)
                                                                         .orgIdentifier(TEST_ORG_IDENTIFIER)
      ...
      @Override
      public void enqueue(Callback<ResponseDTO<ServiceResponse>> callback) {}
      ...
      @Override
      public Call<ResponseDTO<ServiceResponse>> clone() {
        return null;
      }
  ...
  @Override
  public Call<ResponseDTO<YamlValidationListAPIResponse>> validateServiceYaml(
      String accountIdentifier, YamlValidationRequestBody yamlValidationRequestBody) {
    throw new UnsupportedOperationException("mocked method - provide impl when required");
  }

  @Override
  public Call<ResponseDTO<ForceImportServiceResponse>> forceImportService(
      String accountIdentifier, ForceImportServiceRequestDTO requestDTO) {
    throw new UnsupportedOperationException("mocked method - provide impl when required");
  }
}
