...
public class BackstageCatalogEntitiesBeansTest {
  ...
  public void testBackstageCatalogDomainEntity() {
    BackstageCatalogDomainEntity backstageCatalogDomainEntity =
        BackstageCatalogDomainEntity.builder()
            .metadata(Map.of(MetadataFieldConstants.NAME, TEST_ENTITY_NAME, MetadataFieldConstants.IDENTIFIER,
