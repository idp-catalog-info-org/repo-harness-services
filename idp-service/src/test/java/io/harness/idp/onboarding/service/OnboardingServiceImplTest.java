...
public class OnboardingServiceImplTest extends CategoryTest {
  ...
  @Mock GitIntegrationServiceImpl gitIntegrationServiceImpl;
  ...
  public void testImportHarnessEntities() throws Exception {
    ...
    GitIntegrationRequest gitIntegrationRequest = gitIntegrationRequest(connectorInfoDTO.getIdentifier());
    when(gitIntegrationServiceImpl.saveOrUpdate(ACCOUNT_IDENTIFIER, gitIntegrationRequest)).thenReturn(null);
    when(onboardingServiceV2.importCdEntities(any(), any())).thenReturn(null);
        ...
        .catalogDomains(
            AsyncCatalogImportDetails.builder()
                .entities(Collections.singletonList(BackstageCatalogDomainEntity.builder()
                                                        .metadata(Map.of(MetadataFieldConstants.NAME, TEST_ENTITY_NAME,
                                                            MetadataFieldConstants.IDENTIFIER, TEST_ENTITY_IDENTIFIER))
                                                        .build()))
