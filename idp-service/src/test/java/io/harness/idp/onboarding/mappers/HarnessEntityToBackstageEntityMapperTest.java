...
public class HarnessEntityToBackstageEntityMapperTest extends CategoryTest {
  ...
  public void testHarnessOrgToBackstageDomainMapper() {
    ...
    assertEquals(organizationDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
    assertEquals(organizationDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.ABSOLUTE_IDENTIFIER, String.class));
    assertEquals(organizationDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.NAME, String.class));
    assertEquals(organizationDTO.getDescription(),
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.DESCRIPTION, String.class));
    assertNull(BackstageCatalogEntity.getValue(
        backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class));
    assertEquals(Collections.EMPTY_LIST,
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class));
  ...
  public void testHarnessOrgToBackstageDomainMapperWithTags() {
    ...
    assertEquals(2,
        BackstageCatalogEntity
            .getValue(backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class)
            .size());
    assertEquals(ENTITY_UNKNOWN_OWNER, backstageCatalogDomainEntity.getSpec().getOwner());
    assertEquals(BackstageCatalogEntityTypes.DOMAIN.kind, backstageCatalogDomainEntity.getKind());
    assertEquals(TEST_BACKSTAGE_API_VERSION, backstageCatalogDomainEntity.getApiVersion());
  ...
  public void testHarnessOrgToBackstageDomainMapperForEntityNameTruncate() {
    ...
    assertEquals(organizationDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.ABSOLUTE_IDENTIFIER, String.class));
    assertEquals(TEST_ORG_IDENTIFIER_BIG_TRUNCATED,
        BackstageCatalogEntity.getValue(
            backstageCatalogDomainEntity.getMetadata(), MetadataFieldConstants.NAME, String.class));
  }
  ...
  public void testHarnessProjectToBackstageSystemMapper() {
    ...
    assertEquals(projectDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
    ...
    assertEquals(projectDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.NAME, String.class));
    assertEquals(projectDTO.getDescription(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.DESCRIPTION, String.class));
    assertNull(BackstageCatalogEntity.getValue(
        backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class));
    assertEquals(Collections.EMPTY_LIST,
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class));
  ...
  public void testHarnessProjectToBackstageSystemMapperWithTags() {
    ...
    assertEquals(2,
        BackstageCatalogEntity
            .getValue(backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class)
            .size());
    assertEquals(ENTITY_UNKNOWN_OWNER, backstageCatalogSystemEntity.getSpec().getOwner());
    assertEquals(projectDTO.getOrgIdentifier(), backstageCatalogSystemEntity.getSpec().getDomain());
    assertEquals(BackstageCatalogEntityTypes.SYSTEM.kind, backstageCatalogSystemEntity.getKind());
  ...
  public void testHarnessProjectToBackstageSystemMapperWithEntitiesCollision() {
    ...
    assertEquals(projectDTO1.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
    ...
    assertEquals(projectDTO2.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
  ...
  public void testHarnessProjectToBackstageSystemMapperForEntityNameTruncate() {
    ...
    assertEquals(projectDTO.getOrgIdentifier() + "-" + projectDTO.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.ABSOLUTE_IDENTIFIER, String.class));
    assertEquals(TEST_PROJECT_IDENTIFIER_BIG_TRUNCATED,
        BackstageCatalogEntity.getValue(
            backstageCatalogSystemEntity.getMetadata(), MetadataFieldConstants.NAME, String.class));
  }
  ...
  public void testHarnessServiceToBackstageComponentMapper() {
    ...
    assertEquals(serviceResponseDTO.getDescription(),
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.DESCRIPTION, String.class));
    assertEquals(Collections.EMPTY_LIST,
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class));
    assertEquals(3,
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
            .size());
    ...
    assertEquals(
        serviceResponseDTO.getProjectIdentifier(), backstageCatalogComponentEntity.getSpec().getSystem().get(0));
    assertEquals(
  ...
  public void testHarnessServiceToBackstageComponentMapperWithTags() {
    ...
    assertEquals(2,
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.TAGS, List.class)
            .size());
    assertEquals(3,
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
    ...
    assertEquals("https://localhost:8181/ng/account/" + serviceResponseDTO.getAccountId() + "/home/orgs/"
        ...
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
            .get("harness.io/project-url"));
    assertEquals(serviceResponseDTO.getIdentifier(),
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
            .get("harness.io/cd-serviceId"));
    assertEquals(serviceResponseDTO.getIdentifier() + ": https://localhost:8181/ng/account/"
        ...
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
            .get(BACKSTAGE_HARNESS_ANNOTATION_SERVICES));
    assertEquals("Service", backstageCatalogComponentEntity.getSpec().getType());
    assertEquals(ENTITY_UNKNOWN_LIFECYCLE, backstageCatalogComponentEntity.getSpec().getLifecycle());
    assertEquals(ENTITY_UNKNOWN_OWNER, backstageCatalogComponentEntity.getSpec().getOwner());
    assertEquals(serviceResponseDTO.getOrgIdentifier(), backstageCatalogComponentEntity.getSpec().getDomain());
  ...
  public void testHarnessServiceToBackstageComponentMapperWithEntitiesCollision() {
    ...
    assertEquals(serviceResponseDTO1.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
    ...
    assertEquals(serviceResponseDTO2.getIdentifier(),
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.IDENTIFIER, String.class));
  ...
  public void testHarnessServiceToBackstageComponentMapperForEntityNameTruncate() {
    ...
    assertEquals(serviceResponseDTO.getOrgIdentifier() + "-" + serviceResponseDTO.getProjectIdentifier() + "-"
        ...
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ABSOLUTE_IDENTIFIER, String.class));
    assertEquals(TEST_SERVICE_IDENTIFIER_BIG_TRUNCATED,
        BackstageCatalogEntity.getValue(
            backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.NAME, String.class));
  }
  ...
  public void testHarnessServiceToBackstageComponentMapperForEnvBasedHarnessCiCdAnnotations() {
    ...
    assertTrue(
        BackstageCatalogEntity
            .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
            .containsKey(BACKSTAGE_HARNESS_ANNOTATION_PROJECT_URL + "-stress")
        && BackstageCatalogEntity
                .getValue(backstageCatalogComponentEntity.getMetadata(), MetadataFieldConstants.ANNOTATIONS, Map.class)
                .get(BACKSTAGE_HARNESS_ANNOTATION_PROJECT_URL + "-stress")
            != null);
    assertEquals(serviceResponseDTO.getIdentifier() + ": https://localhost:8181/ng/account/"
            + serviceResponseDTO.getAccountId() + "/cd/orgs/" + serviceResponseDTO.getOrgIdentifier() + "/projects/"
            + serviceResponseDTO.getProjectIdentifier() + "/services/" + serviceResponseDTO.getIdentifier() + "\n",
