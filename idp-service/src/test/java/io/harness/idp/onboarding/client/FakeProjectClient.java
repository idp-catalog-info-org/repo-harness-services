...
import io.harness.ng.core.dto.ProjectResponseInternal;
...
public class FakeProjectClient implements ProjectClient {
  ...
  @Override
  public Call<ResponseDTO<Optional<ProjectResponseInternal>>> getProjectInternal(
      String identifier, String accountIdentifier, String orgIdentifier) {
    throw new UnsupportedOperationException("mocked method - provide impl when required");
  }
  ...
  public Call<ResponseDTO<PageResponse<ProjectResponse>>> listWithMultiOrg(String accountIdentifier,
      ...
      int page, int size, List<String> sort, boolean withFavoritesInfo) {
    return new Call<>() {
      @Override
      public Response<ResponseDTO<PageResponse<ProjectResponse>>> execute() {
        if (Objects.equals(accountIdentifier, ACCOUNT_IDENTIFIER) && page < 1) {
  ...
  @Override
  public Call<ResponseDTO<Optional<ProjectResponse>>> getProjectByUniqueId(String uniqueId) {
    throw new UnsupportedOperationException("mocked method - provide impl when required");
  }

  @Override
  public Call<ResponseDTO<List<ProjectResponse>>> getChildrenProjects(List<String> childrenOrgUniqueIds) {
    throw new UnsupportedOperationException("mocked method - provide impl when required");
  }
}
