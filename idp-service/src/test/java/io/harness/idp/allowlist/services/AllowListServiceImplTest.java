...
public class AllowListServiceImplTest {
  ...
  private static final String schema =
      ...
      + "\"$id\": \"https://example.com/object1686050391.json\", \"title\": \"Root\", \"type\": \"object\", "
      + "\"required\": [\"backend\"], "
      + "\"properties\": {\"backend\": {\"$id\": \"#root/backend\", \"title\": \"Backend\", \"type\": "
      + "\"object\",\"required\": [\"reading\"],"
      + "\"properties\": {\"reading\": {\"$id\": \"#root/backend/reading\", \"title\": \"Reading\", \"type\": "
      + "\"object\",\"additionalProperties\": false,\"required\": [\"allow\"],"
      + "\"properties\": {\"allow\": {\"$id\": \"#root/backend/reading/allow\", \"title\": \"Allow\", \"type\": "
      + "\"array\",\"default\": []}}}}}}}\n";
  ...
  public void testSaveAllowList() throws Exception {
    ...
    String expectedConfig = "---\nbackend:\n  reading:\n    allow:\n    - host: stress.harness.io\n    - host: "
        + "qa.harness.io\n      paths:\n      - /v1/secrets\n";
    verify(configManagerService).saveUpdateAndMergeConfigForAccount(appConfigCaptor.capture(), any(), any(), eq(false));
