...
public class BackstagePermissionsRepositoryCustomImplTest extends CategoryTest {
  ...
  public void testUpdate() {
    BackstagePermissionsEntity backstagePermissionsEntity = BackstagePermissionsEntity.builder()
                                                                ...
                                                                .userGroups(List.of(TEST_USERGROUP))
                                                                .build();
    ...
    update.set(BackstagePermissionsEntity.BackstagePermissionsEntityKeys.userGroups,
        backstagePermissionsEntity.getUserGroups());
  ...
  @Category(UnitTests.class)
  public void testUpdateWithNullReturn() {
    BackstagePermissionsEntity backstagePermissionsEntity = BackstagePermissionsEntity.builder()
                                                                .accountIdentifier(TEST_ACCOUNT_IDENTIFIER)
                                                                .permissions(TEST_PERMISSIONS)
                                                                .userGroup(TEST_USERGROUP)
    ...
    when(mongoTemplate.findAndModify(
             eq(query), eq(update), any(FindAndModifyOptions.class), eq(BackstagePermissionsEntity.class)))
        .thenReturn(null);
    assertEquals(null, backstagePermissionsRepositoryCustomImpl.update(backstagePermissionsEntity));
  }

  @Test
  @Owner(developers = NISARG)
  @Category(UnitTests.class)
  public void testUpdateWithMultipleUserGroups() {
    List<String> multipleUserGroups = List.of("IDP-ADMIN", "IDP-USER", "IDP-VIEWER");
    BackstagePermissionsEntity backstagePermissionsEntity = BackstagePermissionsEntity.builder()
                                                                .accountIdentifier(TEST_ACCOUNT_IDENTIFIER)
                                                                .permissions(TEST_PERMISSIONS)
                                                                .userGroup(TEST_USERGROUP)
                                                                .userGroups(multipleUserGroups)
                                                                .build();
    Criteria criteria = Criteria.where(BackstagePermissionsEntity.BackstagePermissionsEntityKeys.accountIdentifier)
                            .is(backstagePermissionsEntity.getAccountIdentifier());
    Query query = new Query(criteria);
    ...
    when(mongoTemplate.findAndModify(
             eq(query), eq(update), any(FindAndModifyOptions.class), eq(BackstagePermissionsEntity.class)))
        .thenReturn(backstagePermissionsEntity);
    BackstagePermissionsEntity result = backstagePermissionsRepositoryCustomImpl.update(backstagePermissionsEntity);
    assertEquals(backstagePermissionsEntity, result);
    assertEquals(multipleUserGroups, result.getUserGroups());
  }
