...
public class BackstageEnvVariableRepositoryCustomImplTest extends CategoryTest {
  ...
  public void testUpdate() {
    ...
    update.unset(BackstageEnvConfigVariableKeys.value);
    update.set("_class", "io.harness.idp.secret.beans.entity.BackstageEnvSecretVariableEntity");
    ...
    update.unset(BackstageEnvSecretVariableKeys.harnessSecretIdentifier);
    update.unset(BackstageEnvSecretVariableKeys.isDeleted);
    update.unset(BackstageEnvSecretVariableKeys.secretLastModifiedAt);
    update.set("_class", "io.harness.idp.secret.beans.entity.BackstageEnvConfigVariableEntity");
    when(mongoTemplate.findAndModify(
             eq(query), eq(update), any(FindAndModifyOptions.class), eq(BackstageEnvVariableEntity.class)))
