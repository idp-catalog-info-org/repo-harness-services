...
public class ConfigEnvVariableServiceImplTest extends CategoryTest {
  ...
  public void testInsertConfigEnvVariable() {
    ...
    List<BackstageEnvSecretVariable> returnList =
        configEnvVariablesServiceImpl.insertConfigEnvVariables(appConfig, TEST_ACCOUNT_IDENTIFIER, false);
    ...
    returnList = configEnvVariablesServiceImpl.insertConfigEnvVariables(appConfig, TEST_ACCOUNT_IDENTIFIER, false);
    ...
    try {
      configEnvVariablesServiceImpl.updateConfigEnvVariables(appConfig, TEST_ACCOUNT_IDENTIFIER, false);
    } catch (Exception e) {
      exception = e;
    }
    assertNotNull(exception);
  ...
  public void testUpdateEnvVariable() {
    ...
    when(backstageEnvVariableService.createOrUpdate(any(), any())).thenReturn(Collections.emptyList());
    appConfig.setEnvVariables(Arrays.asList());
    returnList = configEnvVariablesServiceImpl.updateConfigEnvVariables(appConfig, TEST_ACCOUNT_IDENTIFIER, false);
