...
public class BackstageEnvSecretDeleteEventTest extends CategoryTest {
  ...
  public void testBackstageEnvSecretDeleteEvent_Construction() {
    BackstageEnvSecretDeleteEvent event = new BackstageEnvSecretDeleteEvent(TEST_ACCOUNT_IDENTIFIER, testEnvVariable);

    assertEquals(TEST_ACCOUNT_IDENTIFIER, event.getAccountIdentifier());
    assertNotNull(event.getOldBackstageEnvSecretVariable());
    assertEquals(TEST_ENV_NAME, event.getOldBackstageEnvSecretVariable().getEnvName());
    assertEquals(TEST_SECRET_ID, event.getOldBackstageEnvSecretVariable().getHarnessSecretIdentifier());
  }

  @Test
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testBackstageEnvSecretDeleteEvent_EventType() {
    BackstageEnvSecretDeleteEvent event = new BackstageEnvSecretDeleteEvent(TEST_ACCOUNT_IDENTIFIER, testEnvVariable);

    assertEquals(BackstageEnvSecretDeleteEvent.ENV_VARIABLE_DELETED, event.getEventType());
    assertEquals("EnvVariableDeleted", event.getEventType());
  }

  @Test
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testBackstageEnvSecretDeleteEvent_ResourceScope() {
    BackstageEnvSecretDeleteEvent event = new BackstageEnvSecretDeleteEvent(TEST_ACCOUNT_IDENTIFIER, testEnvVariable);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testBackstageEnvSecretDeleteEvent_Resource() {
    BackstageEnvSecretDeleteEvent event = new BackstageEnvSecretDeleteEvent(TEST_ACCOUNT_IDENTIFIER, testEnvVariable);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testBackstageEnvSecretDeleteEvent_NoArgsConstructor() {
    BackstageEnvSecretDeleteEvent event = new BackstageEnvSecretDeleteEvent();
