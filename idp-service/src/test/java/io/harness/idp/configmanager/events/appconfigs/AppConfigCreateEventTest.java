...
public class AppConfigCreateEventTest extends CategoryTest {
  ...
  public void setUp() {
    ...
    testAppConfig.setConfigId(TEST_CONFIG_ID);
    testAppConfig.setConfigName(TEST_CONFIG_NAME);
  }

  @Test
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testAppConfigCreateEvent_Construction() {
    AppConfigCreateEvent event = new AppConfigCreateEvent(TEST_ACCOUNT_IDENTIFIER, testAppConfig);

    assertEquals(TEST_ACCOUNT_IDENTIFIER, event.getAccountIdentifier());
    assertNotNull(event.getNewAppConfig());
    assertEquals(TEST_CONFIG_ID, event.getNewAppConfig().getConfigId());
    assertEquals(TEST_CONFIG_NAME, event.getNewAppConfig().getConfigName());
  }

  @Test
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testAppConfigCreateEvent_EventType() {
    AppConfigCreateEvent event = new AppConfigCreateEvent(TEST_ACCOUNT_IDENTIFIER, testAppConfig);

    assertEquals(AppConfigCreateEvent.APP_CONFIG_CREATED, event.getEventType());
    assertEquals("AppConfigCreated", event.getEventType());
  }

  @Test
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testAppConfigCreateEvent_ResourceScope() {
    AppConfigCreateEvent event = new AppConfigCreateEvent(TEST_ACCOUNT_IDENTIFIER, testAppConfig);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testAppConfigCreateEvent_Resource() {
    AppConfigCreateEvent event = new AppConfigCreateEvent(TEST_ACCOUNT_IDENTIFIER, testAppConfig);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testAppConfigCreateEvent_NoArgsConstructor() {
    AppConfigCreateEvent event = new AppConfigCreateEvent();
