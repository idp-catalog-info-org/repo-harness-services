...
public class EventMessageHandlerFactoryTest extends CategoryTest {
  ...
  public void testGetEventMessageHandler() {
    ...
    assertEquals(projectMessageHandler, eventMessageHandlerFactory.getEventMessageHandler(PROJECT_ENTITY));
    assertEquals(organizationMessageHandler, eventMessageHandlerFactory.getEventMessageHandler(ORGANIZATION_ENTITY));
