...
public class IDPStepVariableCreatorTest extends CategoryTest {
  IDPStepVariableCreator idpStepVariableCreator;

  @Before
  public void setUp() {
    idpStepVariableCreator = new IDPStepVariableCreator();
  }
  ...
  public void testGetSupportedStepTypes() {
    Set<String> supportedStepTypes = idpStepVariableCreator.getSupportedStepTypes();
