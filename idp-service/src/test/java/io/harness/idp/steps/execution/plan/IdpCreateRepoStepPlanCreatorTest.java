...
public class IdpCreateRepoStepPlanCreatorTest extends CategoryTest {
  IdpCreateRepoStepPlanCreator planCreator;

  @Before
  public void setUp() {
    planCreator = new IdpCreateRepoStepPlanCreator();
  }
  ...
  public void testGetFieldClass() {
    Class<IdpCreateRepoStepNode> fieldClass = planCreator.getFieldClass();

    assertNotNull(fieldClass);
    assertEquals(IdpCreateRepoStepNode.class, fieldClass);
  }
