...
public class IdpDirectPushStepPlanCreatorTest extends CategoryTest {
  IdpDirectPushStepPlanCreator planCreator;

  @Before
  public void setUp() {
    planCreator = new IdpDirectPushStepPlanCreator();
  }
  ...
  public void testGetFieldClass() {
    Class<IdpDirectPushStepNode> fieldClass = planCreator.getFieldClass();

    assertNotNull(fieldClass);
    assertEquals(IdpDirectPushStepNode.class, fieldClass);
  }
