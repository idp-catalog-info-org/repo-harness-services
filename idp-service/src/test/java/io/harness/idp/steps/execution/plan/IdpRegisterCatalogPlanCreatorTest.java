...
public class IdpRegisterCatalogPlanCreatorTest extends CategoryTest {
  IdpRegisterCatalogPlanCreator planCreator;

  @Before
  public void setUp() {
    planCreator = new IdpRegisterCatalogPlanCreator();
  }
  ...
  public void testGetFieldClass() {
    Class<IdpRegisterCatalogStepNode> fieldClass = planCreator.getFieldClass();

    assertNotNull(fieldClass);
    assertEquals(IdpRegisterCatalogStepNode.class, fieldClass);
  }
