...
public class IDPCatalogEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private IDPCatalogEventHandler idpCatalogEventHandler;
  ...
  private static final String IDENTIFIER = "test-component";
  ...
  public void testHandleCatalogCreateEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
                              .build();
    CatalogCreateEvent createEvent = new CatalogCreateEvent(scopeInfo, YAML_CONTENT, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_CATALOG_CREATED)
    ...
    boolean result = idpCatalogEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleCatalogUpdateEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
    ...
    CatalogUpdateEvent updateEvent = new CatalogUpdateEvent(scopeInfo, newYaml, oldYaml, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_CATALOG_UPDATED)
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleCatalogDeleteEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
                              .build();
    CatalogDeleteEvent deleteEvent = new CatalogDeleteEvent(scopeInfo, YAML_CONTENT, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_CATALOG_DELETED)
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    idpCatalogEventHandler.handle(outboxEvent);
  }
