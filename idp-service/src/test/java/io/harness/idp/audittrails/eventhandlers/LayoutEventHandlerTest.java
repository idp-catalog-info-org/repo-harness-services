...
public class LayoutEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private LayoutEventHandler layoutEventHandler;

  private static final String ACCOUNT_ID = "accountId";
  private static final String LAYOUT_YAML = "{\"layout\": \"configuration\"}";
  ...
  public void testHandleLayoutCreateEvent() throws Exception {
    LayoutRequest layoutRequest = new LayoutRequest();
    layoutRequest.setYaml(LAYOUT_YAML);
    layoutRequest.setName("test-layout");
    layoutRequest.setDisplayName("Test Layout");
    layoutRequest.setType("sidebar");
    LayoutCreateEvent createEvent = new LayoutCreateEvent(layoutRequest, ACCOUNT_ID);
    ...
    boolean result = layoutEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleLayoutUpdateEvent() throws Exception {
    LayoutRequest newLayoutRequest = new LayoutRequest();
    newLayoutRequest.setYaml("{\"layout\": \"new configuration\"}");
    newLayoutRequest.setName("test-layout");
    newLayoutRequest.setDisplayName("Test Layout");
    newLayoutRequest.setType("sidebar");

    LayoutRequest oldLayoutRequest = new LayoutRequest();
    oldLayoutRequest.setYaml("{\"layout\": \"old configuration\"}");
    oldLayoutRequest.setName("test-layout");
    oldLayoutRequest.setDisplayName("Test Layout");
    oldLayoutRequest.setType("sidebar");

    LayoutUpdateEvent updateEvent = new LayoutUpdateEvent(newLayoutRequest, oldLayoutRequest, ACCOUNT_ID);
  ...
  @Category(UnitTests.class)
  public void testHandleLayoutDeleteEvent() throws Exception {
    LayoutRequest layoutRequest = new LayoutRequest();
    layoutRequest.setYaml(LAYOUT_YAML);
    layoutRequest.setName("test-layout");
    layoutRequest.setDisplayName("Test Layout");
    layoutRequest.setType("sidebar");
    LayoutDeleteEvent deleteEvent = new LayoutDeleteEvent(layoutRequest, ACCOUNT_ID);
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    layoutEventHandler.handle(outboxEvent);
  }
