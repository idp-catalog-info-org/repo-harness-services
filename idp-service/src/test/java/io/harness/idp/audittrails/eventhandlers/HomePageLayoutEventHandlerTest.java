...
public class HomePageLayoutEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private HomePageLayoutEventHandler homePageLayoutEventHandler;

  private static final String ACCOUNT_ID = "accountId";
  private static final String LAYOUT_JSON = "{\"layout\": \"test\"}";
  ...
  public void testHandleHomePageLayoutCreateEvent() throws Exception {
    HomePageLayoutResponse layoutResponse = new HomePageLayoutResponse();
    HomePageLayoutInfo layoutInfo = new HomePageLayoutInfo();
    layoutResponse.setHomePageLayout(layoutInfo);
    HomePageLayoutCreateEvent createEvent = new HomePageLayoutCreateEvent(layoutResponse, ACCOUNT_ID);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(HOMEPAGE_LAYOUT_CREATED)
    ...
    boolean result = homePageLayoutEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleHomePageLayoutUpdateEvent() throws Exception {
    HomePageLayoutResponse newLayoutResponse = new HomePageLayoutResponse();
    HomePageLayoutInfo newLayoutInfo = new HomePageLayoutInfo();
    newLayoutResponse.setHomePageLayout(newLayoutInfo);
    HomePageLayoutResponse oldLayoutResponse = new HomePageLayoutResponse();
    HomePageLayoutInfo oldLayoutInfo = new HomePageLayoutInfo();
    oldLayoutResponse.setHomePageLayout(oldLayoutInfo);
    HomePageLayoutUpdateEvent updateEvent =
        new HomePageLayoutUpdateEvent(newLayoutResponse, oldLayoutResponse, ACCOUNT_ID);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(HOMEPAGE_LAYOUT_UPDATED)
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    homePageLayoutEventHandler.handle(outboxEvent);
  }
