...
public class BackstageCatalogEntityEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private BackstageCatalogEntityEventHandler backstageCatalogEntityEventHandler;

  private static final String ACCOUNT_ID = "accountId";
  private static final String ENTITY_UID = "component:default/my-service";
  ...
  public void testHandleBackstageCatalogEntityCreateEvent() throws Exception {
    BackstageCatalogEntityCreateEvent createEvent =
        new BackstageCatalogEntityCreateEvent(ACCOUNT_ID, ENTITY_UID, YAML_CONTENT);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(BACKSTAGE_CATALOG_ENTITY_CREATED)
    ...
    boolean result = backstageCatalogEntityEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleBackstageCatalogEntityUpdateEvent() throws Exception {
    String newYaml = "apiVersion: backstage.io/v1alpha1\nkind: Component\nmetadata:\n  name: my-service-updated";
    BackstageCatalogEntityUpdateEvent updateEvent =
        new BackstageCatalogEntityUpdateEvent(ACCOUNT_ID, ENTITY_UID, newYaml, YAML_CONTENT);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(BACKSTAGE_CATALOG_ENTITY_UPDATED)
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleBackstageCatalogEntityDeleteEvent() throws Exception {
    BackstageCatalogEntityDeleteEvent deleteEvent =
        new BackstageCatalogEntityDeleteEvent(ACCOUNT_ID, ENTITY_UID, YAML_CONTENT);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(BACKSTAGE_CATALOG_ENTITY_DELETED)
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    backstageCatalogEntityEventHandler.handle(outboxEvent);
  }
