...
public class IDPCatalogTableEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private IDPCatalogTableEventHandler idpCatalogTableEventHandler;
  ...
  public void testHandleCatalogTableCreateEvent() throws Exception {
    EntityTableResponse tableResponse = getEntityTableResponse();
    CatalogTableCreateEvent createEvent = new CatalogTableCreateEvent(ACCOUNT_ID, tableResponse);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_CATALOG_TABLE_CREATED)
    ...
    boolean result = idpCatalogTableEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleCatalogTableUpdateEvent() throws Exception {
    EntityTableResponse newTableResponse = getEntityTableResponse();
    EntityTableResponse oldTableResponse = getEntityTableResponse();
    oldTableResponse.setName("oldTableName");

    CatalogTableUpdateEvent updateEvent = new CatalogTableUpdateEvent(ACCOUNT_ID, newTableResponse, oldTableResponse);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_CATALOG_TABLE_UPDATED)
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    idpCatalogTableEventHandler.handle(outboxEvent);
  }
  ...
  private EntityTableResponse getEntityTableResponse() {
    EntityTableResponse tableResponse = new EntityTableResponse();
    tableResponse.setName(TABLE_NAME);
