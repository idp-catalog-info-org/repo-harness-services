...
public class IDPWorkflowEventHandlerTest {
  @Mock private AuditClientService auditClientService;
  @InjectMocks private IDPWorkflowEventHandler idpWorkflowEventHandler;

  private static final String ACCOUNT_ID = "accountId";
  private static final String YAML_CONTENT = "apiVersion: scaffolder.backstage.io/v1beta3\nkind: Template";
  private static final String KIND = "Template";
  private static final String IDENTIFIER = "workflow";
  ...
  public void testHandleWorkflowCreateEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
                              .build();
    WorkflowCreateEvent createEvent = new WorkflowCreateEvent(scopeInfo, YAML_CONTENT, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_WORKFLOW_CREATED)
    ...
    boolean result = idpWorkflowEventHandler.handle(outboxEvent);
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleWorkflowUpdateEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
                              .build();
    String newYaml = "apiVersion: scaffolder.backstage.io/v1beta3\nkind: Template\nmetadata:\n  name: new";
    String oldYaml = "apiVersion: scaffolder.backstage.io/v1beta3\nkind: Template\nmetadata:\n  name: old";
    WorkflowUpdateEvent updateEvent = new WorkflowUpdateEvent(scopeInfo, newYaml, oldYaml, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_WORKFLOW_UPDATED)
  ...
  @Owner(developers = DEVESH)
  @Category(UnitTests.class)
  public void testHandleWorkflowDeleteEvent() throws Exception {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(ACCOUNT_ID)
                              .uniqueId(IDENTIFIER)
                              .scopeType(io.harness.beans.ScopeLevel.ACCOUNT)
                              .build();
    WorkflowDeleteEvent deleteEvent = new WorkflowDeleteEvent(scopeInfo, YAML_CONTENT, KIND, IDENTIFIER);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .eventType(IDP_WORKFLOW_DELETED)
  ...
  public void testHandleUnsupportedEventType() throws Exception {
    ...
    idpWorkflowEventHandler.handle(outboxEvent);
  }
