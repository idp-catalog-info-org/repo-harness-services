...
public class GitIntegrationCreateEventTest extends CategoryTest {
  ...
  public void testWithGithubIntegrationEntity() {
    ...
    GitIntegrationCreateEvent gitIntegrationCreateEvent =
        new GitIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, githubIntegrationEntity);
    validateResult(gitIntegrationCreateEvent);
  }
  ...
  public void testWithGitlabIntegrationEntity() {
    ...
    GitIntegrationCreateEvent gitIntegrationCreateEvent =
        new GitIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, gitlabIntegrationEntity);
    validateResult(gitIntegrationCreateEvent);
  }
  ...
  public void testWithAzureIntegrationEntity() {
    ...
    GitIntegrationCreateEvent gitIntegrationCreateEvent =
        new GitIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, azureIntegrationEntity);
    validateResult(gitIntegrationCreateEvent);
  }
  ...
  public void testWithBitbucketCloudIntegrationEntity() {
    ...
    GitIntegrationCreateEvent gitIntegrationCreateEvent =
        new GitIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, bitbucketCloudIntegrationEntity);
    validateResult(gitIntegrationCreateEvent);
  }
  ...
  public void testWithBitbucketServerIntegrationEntity() {
    ...
    GitIntegrationCreateEvent gitIntegrationCreateEvent =
        new GitIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, bitbucketServerIntegrationEntity);
    validateResult(gitIntegrationCreateEvent);
  }

  private void validateResult(GitIntegrationCreateEvent gitIntegrationCreateEvent) {
    assertEquals(AccountScope.class, gitIntegrationCreateEvent.getResourceScope().getClass());
    assertEquals(TEST_ACCOUNT_SCOPE, gitIntegrationCreateEvent.getResourceScope().getScope());
    assertEquals(TEST_ACCOUNT_IDENTIFIER + "_" + TEST_GIT_INTEGRATION_IDENTIFIER,
        gitIntegrationCreateEvent.getResource().getIdentifier());
    assertEquals(IDP_GIT_INTEGRATIONS, gitIntegrationCreateEvent.getResource().getType());
    assertEquals(TEST_GIT_INTEGRATION_IDENTIFIER,
        gitIntegrationCreateEvent.getResource().getLabels().get(LABEL_KEY_RESOURCE_NAME));
    assertEquals(GIT_INTEGRATION_CREATED, gitIntegrationCreateEvent.getEventType());
  }
}
