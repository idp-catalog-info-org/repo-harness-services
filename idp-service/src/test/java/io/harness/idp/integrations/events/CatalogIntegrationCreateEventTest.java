...
public class CatalogIntegrationCreateEventTest extends CategoryTest {
  ...
  public void testConstructorWithHarnessCDEntity() {
    CatalogIntegrationCreateEvent event = new CatalogIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, harnessCDEntity);
  ...
  public void testNoArgsConstructor() {
    CatalogIntegrationCreateEvent event = new CatalogIntegrationCreateEvent();
  ...
  public void testGetResourceWithRegularEntity() {
    CatalogIntegrationCreateEvent event = new CatalogIntegrationCreateEvent(TEST_ACCOUNT_IDENTIFIER, regularEntity);
  ...
  public void testGetEventType() {
    ...
    assertThat(event.getEventType()).isEqualTo(CATALOG_INTEGRATION_CREATED);
  }
  ...
  public void testEventConstant() {
    assertThat(CatalogIntegrationCreateEvent.CATALOG_INTEGRATION_CREATED).isEqualTo("CATALOG_INTEGRATION_CREATED");
  }
}
