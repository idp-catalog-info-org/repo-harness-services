...
public class RbacConstants {
  ...
  public static final String IDP_AGGREGATION_RULE = "IDP_AGGREGATION_RULE";
  public static final String IDP_CATALOG = "IDP_CATALOG";
  public static final String IDP_TEAM = "IDP_TEAM";
  ...
  public static final String IDP_CATALOG_EDIT = "idp_catalog_edit";
  public static final String IDP_CATALOG_DELETE = "idp_catalog_delete";
  public static final String IDP_CATALOG_VIEW = "idp_catalog_view";
  public static final String IDP_TEAM_EDIT = "idp_team_edit";
  public static final String IDP_TEAM_DELETE = "idp_team_delete";
  public static final String IDP_TEAM_VIEW = "idp_team_view";
  ...
  public static final String IDP_AGGREGATION_RULE_VIEW = "idp_aggregationrule_view";
  public static final String IDP_AGGREGATION_RULE_CREATE = "idp_aggregationrule_create";
  public static final String IDP_AGGREGATION_RULE_EDIT = "idp_aggregationrule_edit";
  public static final String IDP_AGGREGATION_RULE_DELETE = "idp_aggregationrule_delete";
  public static final String IDP_AGGREGATION_RULE_COMPUTE = "idp_aggregationrule_compute";
}
