...
public interface BackstageEnvVariableService {
  ...
  ResolvedEnvVariableResponse resolveEnvVariables(String accountIdentifier, String namespace);
  Pair<String, Long> getDecryptedValueAndLastModifiedTime(String envName, String secretIdentifier,
      String accountIdentifier, String orgIdentifier, String projectIdentifier);
  void reloadSecrets(String harnessAccount, String namespace);
  List<BackstageEnvVariable> updateAndAuditEnvironmentVariables(
      List<BackstageEnvVariable> envVariables, String accountIdentifier);
  void cleanupEnvSecret(String accountIdentifier, String namespace);
}
