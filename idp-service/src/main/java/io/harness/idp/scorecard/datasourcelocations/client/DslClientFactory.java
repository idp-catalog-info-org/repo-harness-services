...
public class DslClientFactory {
  ...
  public DslClient getClient(String accountIdentifier, String host, boolean throughDelegate) {
    if (throughDelegate) {
  ...
  public DslClient getClient(String accountIdentifier, String host, boolean throughDelegate, String url) {
    if (url != null && url.contains("/v1/data-sources/scm/data-point/values")) {
      return directDslClient;
    }
    return getClient(accountIdentifier, host, throughDelegate);
  }
}
