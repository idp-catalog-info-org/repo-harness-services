...
public class KubernetesDataSourceProviderV2 extends IntegrationDataSourceProvider {
  private final KubernetesProvider kubernetesProvider;

  protected KubernetesDataSourceProviderV2(DataPointService dataPointService,
  ...
  public Map<String, Map<String, Object>> fetchData(
    ...
    return fetchDataWithLegacySplit(accountIdentifier, entity, dataToFetch, configs, kubernetesProvider);
  }
}
