...
public interface CheckRepository extends CrudRepository<CheckEntity, String>, CheckRepositoryCustom {
  ...
  List<CheckEntity> findByAccountIdentifierAndIsDeleted(String accountIdentifier, boolean deleted);
  ...
  void deleteByAccountIdentifierAndIdentifierAndIsCustom(String accountIdentifier, String identifier, boolean isCustom);
}
