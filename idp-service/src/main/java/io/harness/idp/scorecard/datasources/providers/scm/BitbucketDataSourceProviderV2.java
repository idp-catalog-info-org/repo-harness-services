...
public class BitbucketDataSourceProviderV2 extends IntegrationDataSourceProvider {
  private final BitbucketProvider bitbucketProvider;

  public BitbucketDataSourceProviderV2(DataPointService dataPointService,
  ...
  public Map<String, Map<String, Object>> fetchData(
    ...
    return fetchDataWithLegacySplit(accountIdentifier, entity, dataToFetch, configs, bitbucketProvider);
  }
}
