...
public class DelegateDslClient implements DslClient {
  ...
  public Response call(
    ...
    delegateSelectors =
        !isEmpty(delegateSelectors) ? delegateSelectors : delegateSelectorsCache.get(accountIdentifier, host);
    ...
    try {
      HttpStepResponse httpResponse =
          delegateProxyRequestForwarder.forwardRequestToDelegate(accountIdentifier, url, headerList,
              apiRequestDetails.getRequestBody(), apiRequestDetails.getMethod(), delegateSelectors, entity, null);
