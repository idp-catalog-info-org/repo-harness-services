...
public interface CheckStatusRepository extends CrudRepository<CheckStatusEntity, String>, CheckStatusRepositoryCustom {
  ...
  List<CheckStatusEntity> findByAccountIdentifierAndTimestampBetween(String accountIdentifier, long start, long end);
  List<CheckStatusEntity> findByAccountIdentifier(String accountIdentifier);
}
