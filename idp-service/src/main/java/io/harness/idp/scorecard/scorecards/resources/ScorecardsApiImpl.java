...
public class ScorecardsApiImpl implements ScorecardsApi {
  ...
  public Response deleteScorecard(@ResourceIdentifier String scorecardId, @AccountIdentifier String harnessAccount) {
    try {
  ...
  public Response getEntityFacets(@NotNull String kind, @AccountIdentifier String harnessAccount) {
    try {
      List<EntityFiltersResponse> responses = scorecardService.getAllEntityFacets(harnessAccount, kind);
  ...
  @Override
  @NGAccessControlCheck(resourceType = IDP_SCORECARD, permission = IDP_SCORECARD_EDIT)
  public Response updateScorecard(@ResourceIdentifier String scorecardId, @Valid ScorecardDetailsRequest body,
