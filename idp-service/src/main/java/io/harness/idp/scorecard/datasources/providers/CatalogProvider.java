...
public class CatalogProvider extends NoopDataSourceProvider {
  ...
  public Map<String, Map<String, Object>> fetchData(
    ...
    return processOut(accountIdentifier, CATALOG_IDENTIFIER, entity, getAuthHeaders(accountIdentifier, null, null),
        Collections.emptyMap(), Collections.emptyMap(), dataPointsAndInputValues, false, Set.of());
  }
