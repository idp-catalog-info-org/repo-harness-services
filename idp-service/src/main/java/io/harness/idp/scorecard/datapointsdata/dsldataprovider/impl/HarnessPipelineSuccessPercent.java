...
public class HarnessPipelineSuccessPercent implements DslDataProvider {
  ...
  public Map<String, Object> getDslData(String accountIdentifier, Object config) {
    ...
    try {
      ...
      log.error(String.format("Error in getting the ci pipeline dash board summary info of success percent in seven "
                        + "days check in account - %s, org - %s, project - %s, and pipeline - %s",
