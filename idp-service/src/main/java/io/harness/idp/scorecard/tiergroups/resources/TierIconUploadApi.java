...
@Path("/v1/scorecard-tiers/icon")
@OwnedBy(HarnessTeam.IDP)
public interface TierIconUploadApi {
  @POST
  @Consumes({"multipart/form-data"})
  @Produces({"application/json", "application/yaml"})
  @Operation(operationId = "uploadTierIcon", summary = "Upload Scorecard Tier Icon", description = "",
      security = { @SecurityRequirement(name = "x-api-key") }, tags = {"Scorecard"})
  @ApiResponses({
  ...
  Response
  uploadTierIcon(@FormDataParam("file_type") String fileType, @FormDataParam("file") InputStream fileInputStream,
