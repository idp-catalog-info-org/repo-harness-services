...
import io.harness.idp.scorecard.datapointsdata.dsldataprovider.impl.HarnessCodeContentDsl;
...
public class HarnessDslFactory implements DataSourceDsl {
  ...
  HarnessCodeContentDsl harnessCodeContentDsl;
