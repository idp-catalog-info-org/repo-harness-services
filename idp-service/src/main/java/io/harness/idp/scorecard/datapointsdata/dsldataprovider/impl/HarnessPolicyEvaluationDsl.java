...
public class HarnessPolicyEvaluationDsl implements DslDataProvider {
  ...
  public Map<String, Object> getDslData(String accountIdentifier, Object config) {
    ...
    try {
      ...
      log.error(String.format("Error in getting the ci pipeline info of policy evaluation check in account - %s, org - "
    ...
    if (serviceUrl != null) {
      ...
      try {
        ...
        log.error(String.format("Error in getting the service dashboard info of policy evaluation check in account - "
      ...
      if (cdPipelineId != null) {
        try {
          ...
          log.error(String.format("Error in getting the cd pipeline info of policy evaluation check in account - %s, "
