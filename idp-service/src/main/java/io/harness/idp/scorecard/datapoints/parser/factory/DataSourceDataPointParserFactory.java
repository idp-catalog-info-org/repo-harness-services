...
public class DataSourceDataPointParserFactory {
  ...
  DefaultIntegrationDataPointParserFactory defaultIntegrationDataPointParserFactory;
  ...
  public DataPointParserFactory getDataPointParserFactory(String identifier) {
    switch (identifier) {
      ...
      case TRACEABLE_IDENTIFIER, SONAR_IDENTIFIER, DYNATRACE_IDENTIFIER, DATADOG_IDENTIFIER, GCP_IDENTIFIER,
          HARNESS_CD_IDENTIFIER:
        return defaultIntegrationDataPointParserFactory;
      default:
