...
public class ScoreComputationHandler implements MongoPersistenceIterator.Handler<NamespaceEntity> {
  ...
  private static final String SCORE_COMPUTATION_HANDLER = "IDPScoreCardScoreCalculator";
  ...
  public void handle(NamespaceEntity namespaceEntity) {
    ...
    try {
      ...
      idpIteratorMetricRecorder.recordSuccess(SCORE_COMPUTATION_HANDLER, accountIdentifier);
    } catch (Exception exception) {
      idpIteratorMetricRecorder.recordFailure(SCORE_COMPUTATION_HANDLER, accountIdentifier);
      throw exception;
    }
  ...
  public void registerIterators(IteratorConfig iteratorConfig) {
    ...
    persistenceIteratorFactory.createPumpIteratorWithDedicatedThreadPool(
        PersistenceIteratorFactory.PumpExecutorOptions.builder()
            .name(SCORE_COMPUTATION_HANDLER)
