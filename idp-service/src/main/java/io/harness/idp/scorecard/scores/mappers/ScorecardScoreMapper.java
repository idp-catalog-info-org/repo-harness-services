...
public class ScorecardScoreMapper {
  public ScorecardScore toDTO(ScoreEntity scoreEntity, String scorecardName, String scorecardDescription) {
    return toDTO(scoreEntity, scorecardName, scorecardDescription, true);
  }

  public ScorecardScore toDTO(
      ScoreEntity scoreEntity, String scorecardName, String scorecardDescription, boolean includeTier) {
    ...
    if (includeTier) {
      ScoreTierMapper.fromScoreEntity(scoreEntity).ifPresent(scorecardScore::setTier);
    }
