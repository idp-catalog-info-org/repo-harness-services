...
@Getter
@NoArgsConstructor
public class CatalogCustomPropertyDeleteEvent implements Event {
  public static final String CATALOG_CUSTOM_PROPERTY_DELETED = "CatalogCustomPropertyDeleted";
  private String accountIdentifier;
  private CatalogCustomPropertyEntity entity;

  public CatalogCustomPropertyDeleteEvent(String accountIdentifier, CatalogCustomPropertyEntity entity) {
  ...
  public String getEventType() {
    return CATALOG_CUSTOM_PROPERTY_DELETED;
  }
}
