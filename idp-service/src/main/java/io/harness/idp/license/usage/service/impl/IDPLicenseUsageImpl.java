...
import static io.harness.idp.common.DateUtils.timestampInMsWithAmountManipulation;
  ...
  public IDPLicenseUsageDTO getLicenseUsage(
    ...
    return IDPLicenseUsageDTO.builder()
        ...
        .activeDevelopers(UsageDataDTO.builder()
                              ...
                              .count(activeDevelopersRepository
                                         .findByAccountIdentifierAndLastAccessedAtGreaterThan(
                                             accountIdentifier, timestampInMsWithAmountManipulation(-30))
                                         .size())
                              .build())
        .build();
  }
