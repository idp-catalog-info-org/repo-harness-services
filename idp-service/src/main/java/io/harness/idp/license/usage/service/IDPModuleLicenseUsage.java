...
public interface IDPModuleLicenseUsage {
  ...
  List<ActiveDevelopersEntity> getActiveDevelopersPerDay();
  void populateActiveDevelopersDataForSync();
  void migrateActiveDevelopersData(String accountIdentifier);
  ...
  ActiveDevelopersTrendResponse getHistoryTrendV2(
      String accountIdentifier, IDPLicenseDateUsageParams idpLicenseDateUsageParams);
  /**
