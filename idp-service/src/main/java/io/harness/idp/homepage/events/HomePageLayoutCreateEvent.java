...
@Getter
@NoArgsConstructor
public class HomePageLayoutCreateEvent implements Event {
  public static final String HOMEPAGE_LAYOUT_CREATED = "HomePageLayoutCreated";

  private HomePageLayoutResponse newHomePageLayout;
  private String accountIdentifier;

  public HomePageLayoutCreateEvent(HomePageLayoutResponse newHomePageLayout, String accountIdentifier) {
  ...
  public String getEventType() {
    return HOMEPAGE_LAYOUT_CREATED;
  }
}
