...
public class UserEventEntityUserGroupIdentifierMigration implements NGMigration {
  ...
  @Override
  public void migrate() {
    log.info("Starting the migration for adding userGroupIdentifier field (default = \"\") and setting hasEvent field "
        + "to false in userEvents collection.");
    ...
    log.info("Migration complete for adding userGroupIdentifier field (default = \"\") and setting hasEvent field to "
        + "false in userEvents collection.");
  }
}
