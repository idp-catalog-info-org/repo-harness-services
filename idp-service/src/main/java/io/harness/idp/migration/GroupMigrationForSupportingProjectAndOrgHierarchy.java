...
public class GroupMigrationForSupportingProjectAndOrgHierarchy implements NGMigration {
  GroupsService groupsService;
  NamespaceService namespaceService;

  @Override
  public void migrate() {
    log.info("Starting the migration for adding parentUniqueId and unique ID to groups");
    ...
    for (NamespaceEntity namespaceEntity : namespaceEntities) {
      groupsService.addUniqueIdAndParentUniqueIdInfo(namespaceEntity.getAccountIdentifier());
    }
