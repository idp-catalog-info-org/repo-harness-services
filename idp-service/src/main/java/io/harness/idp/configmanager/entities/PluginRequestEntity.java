...
public class PluginRequestEntity
  ...
  @NotNull PluginRequestStatus status;
  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        ...
        .add(CompoundMongoIndex.builder()
                 ...
                 .unique(true)
                 .field(PluginRequestKeys.accountIdentifier)
                 .field(PluginRequestKeys.identifier)
                 .build())
        .build();
  }
  ...
  public Map<String, String> toMap() {
    ...
    pluginRequestEntityMap.put(PluginRequestKeys.identifier, identifier);
    ...
    pluginRequestEntityMap.put(PluginRequestKeys.status, status.name());
