...
public interface K8sClient {
  void updateSecretData(String accountIdentifier, String namespace, String secretName, Map<String, byte[]> data);
  ...
  void createNamespaceForFailoverCluster(String namespace);
  void deleteConfigMap(String accountIdentifier, String namespace, String configMapName);
}
