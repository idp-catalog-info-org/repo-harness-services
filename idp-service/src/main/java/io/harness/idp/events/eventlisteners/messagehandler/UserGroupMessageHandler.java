...
public class UserGroupMessageHandler implements EventMessageHandler {
  ...
  public void handleMessage(Message message, Object dto, String action) {
    ...
    if (CommonUtils.checkIfAccountLevelEvent(accountIdentifier, entityChangeDTO.getOrgIdentifier().getValue(),
      ...
      catalogService.handleUserGroupBasedOnAction(
          entityChangeDTO.getAccountIdentifier().getValue(), entityChangeDTO.getIdentifier().getValue(), action);
    }
  }
}
