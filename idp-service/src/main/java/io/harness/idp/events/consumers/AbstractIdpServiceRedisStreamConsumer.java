...
public abstract class AbstractIdpServiceRedisStreamConsumer extends RedisTraceConsumer implements IdpRedisConsumer {
  ...
  protected boolean lockAndProcessData(String lockName, String entityType, ByteString data) throws Exception {
    ...
    try {
      ...
      processInternal(entityType, data);
    } finally {
      if (lock != null) {
  ...
  protected abstract void processInternal(String entityType, ByteString data) throws Exception;
