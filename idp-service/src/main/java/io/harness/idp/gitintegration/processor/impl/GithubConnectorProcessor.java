...
import io.harness.delegate.beans.connector.scm.github.GithubHttpCredentialsOutcomeDTO;
...
public class GithubConnectorProcessor extends ConnectorProcessor {
  ...
  public String getLocationTarget(CatalogConnectorInfo catalogConnectorInfo, String path) {
    return catalogConnectorInfo.getRepo() + SLASH_DELIMITER + SOURCE_FORMAT_BLOB + SLASH_DELIMITER
