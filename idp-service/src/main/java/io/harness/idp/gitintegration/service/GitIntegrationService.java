...
public interface GitIntegrationService {
  ...
  void processConnectorDelete(Message message, EntityChangeDTO entityChangeDTO);
  ...
  String validateConnectorAndSecret(CatalogConnectorEntity catalogConnectorEntity, String accountIdentifier);
}
