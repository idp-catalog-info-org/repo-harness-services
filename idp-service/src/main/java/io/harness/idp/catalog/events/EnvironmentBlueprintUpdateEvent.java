...
@Getter
@NoArgsConstructor
public class EnvironmentBlueprintUpdateEvent implements Event {
  public static final String IDP_ENVIRONMENT_BLUEPRINT_UPDATED = "IDPEnvironmentBlueprintUpdated";
  ...
  public EnvironmentBlueprintUpdateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml,
      String oldInlineCatalogEntityYaml, String kind, String identifier) {
  ...
  public Resource getResource() {
    ...
    return Resource.builder()
        ...
        .type(IDP_ENVIRONMENT_BLUEPRINT)
        .labels(labels)
        .build();
  }
  ...
  public String getEventType() {
    return IDP_ENVIRONMENT_BLUEPRINT_UPDATED;
  }
}
