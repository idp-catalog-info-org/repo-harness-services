...
@Getter
@NoArgsConstructor
public class CatalogCreateEvent implements Event {
  public static final String IDP_CATALOG_CREATED = "IDPCatalogCreated";
  ...
  public CatalogCreateEvent(ScopeInfo scopeInfo, String inlineCatalogEntityYaml, String kind, String identifier) {
    this.scopeInfo = scopeInfo;
    this.newInlineCatalogEntityYaml = inlineCatalogEntityYaml;
    this.kind = kind;
