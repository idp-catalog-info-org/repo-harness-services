...
@Getter
@NoArgsConstructor
public class TeamUpdateEvent implements Event {
  public static final String IDP_TEAM_UPDATED = "IDPTeamUpdated";
  ...
  public TeamUpdateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml, String oldInlineCatalogEntityYaml,
