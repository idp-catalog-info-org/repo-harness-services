...
@Getter
@NoArgsConstructor
public class EnvironmentBlueprintCreateEvent implements Event {
  public static final String IDP_ENVIRONMENT_BLUEPRINT_CREATED = "IDPEnvironmentBlueprintCreated";
  ...
  public EnvironmentBlueprintCreateEvent(
      ScopeInfo scopeInfo, String newInlineCatalogEntityYaml, String kind, String identifier) {
  ...
  public String getEventType() {
    return IDP_ENVIRONMENT_BLUEPRINT_CREATED;
  }
}
