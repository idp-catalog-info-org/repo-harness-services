...
@Getter
@NoArgsConstructor
public class CatalogDeleteEvent implements Event {
  public static final String IDP_CATALOG_DELETED = "IDPCatalogDeleted";
  ...
  public CatalogDeleteEvent(ScopeInfo scopeInfo, String oldInlineCatalogEntityYaml, String kind, String identifier) {
