...
@Getter
@NoArgsConstructor
public class WorkflowDeleteEvent implements Event {
  public static final String IDP_WORKFLOW_DELETED = "IDPWorkflowDeleted";
  ...
  public WorkflowDeleteEvent(ScopeInfo scopeInfo, String oldInlineCatalogEntityYaml, String kind, String identifier) {
