...
@Getter
@NoArgsConstructor
public class EntityLinkUpdateEvent implements Event {
  public static final String ENTITY_LINK_UPDATED = "EntityLinkUpdated";
  ...
  private String newEntityLinkJson;

  public EntityLinkUpdateEvent(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String entityRef, String oldEntityLinkJson, String newEntityLinkJson) {
    this.accountIdentifier = accountIdentifier;
    this.orgIdentifier = orgIdentifier;
    this.projectIdentifier = projectIdentifier;
    this.entityRef = entityRef;
    this.oldEntityLinkJson = oldEntityLinkJson;
    this.newEntityLinkJson = newEntityLinkJson;
  }
