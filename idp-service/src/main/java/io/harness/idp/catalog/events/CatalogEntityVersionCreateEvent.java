...
@Getter
@NoArgsConstructor
public class CatalogEntityVersionCreateEvent implements Event {
  public static final String IDP_CATALOG_ENTITY_VERSION_CREATED = "IDPCatalogEntityVersionCreated";
  ...
  public CatalogEntityVersionCreateEvent(ScopeInfo scopeInfo, String inlineCatalogEntityVersionYaml, String kind,
      String identifier, String version, Boolean stable, Boolean deprecated) {
    this.scopeInfo = scopeInfo;
    this.newInlineCatalogEntityVersionYaml = inlineCatalogEntityVersionYaml;
    this.kind = kind;
  ...
  public String getEventType() {
    return IDP_CATALOG_ENTITY_VERSION_CREATED;
  }
}
