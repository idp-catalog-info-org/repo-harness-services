...
@Getter
@NoArgsConstructor
public class EnvironmentDeleteEvent implements Event {
  public static final String IDP_ENVIRONMENT_DELETED = "IDPEnvironmentDeleted";
  ...
  public String getEventType() {
    return IDP_ENVIRONMENT_DELETED;
  }
}
