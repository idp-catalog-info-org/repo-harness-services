...
@Getter
@NoArgsConstructor
public class EnvironmentUpdateEvent implements Event {
  public static final String IDP_ENVIRONMENT_UPDATED = "IDPEnvironmentUpdated";
  ...
  public EnvironmentUpdateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml,
  ...
  public String getEventType() {
    return IDP_ENVIRONMENT_UPDATED;
  }
}
