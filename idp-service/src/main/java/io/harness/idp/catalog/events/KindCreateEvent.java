...
@Getter
@NoArgsConstructor
public class KindCreateEvent implements Event {
  public static final String IDP_KIND_CREATED = "IDPKindCreated";

  private ScopeInfo scopeInfo;
  private KindEntity kindEntity;

  public KindCreateEvent(ScopeInfo scopeInfo, KindEntity kindEntity) {
