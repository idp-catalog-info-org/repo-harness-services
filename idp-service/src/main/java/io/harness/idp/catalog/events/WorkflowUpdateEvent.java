...
@Getter
@NoArgsConstructor
public class WorkflowUpdateEvent implements Event {
  public static final String IDP_WORKFLOW_UPDATED = "IDPWorkflowUpdated";
  ...
  public WorkflowUpdateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml, String oldInlineCatalogEntityYaml,
