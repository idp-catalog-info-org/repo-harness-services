...
public class ActionDeleteEvent implements Event {
  public static final String IDP_ACTION_DELETED = "IDPActionDeleted";
  ...
  public ActionDeleteEvent(
      ScopeInfo scopeInfo, String oldActionJson, String identifier, String version, String uniqueId) {
