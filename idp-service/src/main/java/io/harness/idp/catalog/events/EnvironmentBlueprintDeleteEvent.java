...
@Getter
@NoArgsConstructor
public class EnvironmentBlueprintDeleteEvent implements Event {
  public static final String IDP_ENVIRONMENT_BLUEPRINT_DELETED = "IDPEnvironmentBlueprintDeleted";
  ...
  public EnvironmentBlueprintDeleteEvent(
      ScopeInfo scopeInfo, String oldInlineCatalogEntityYaml, String kind, String identifier) {
  ...
  public String getEventType() {
    return IDP_ENVIRONMENT_BLUEPRINT_DELETED;
  }
}
