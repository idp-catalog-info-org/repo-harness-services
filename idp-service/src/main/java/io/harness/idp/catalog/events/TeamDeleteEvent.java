...
@Getter
@NoArgsConstructor
public class TeamDeleteEvent implements Event {
  public static final String IDP_TEAM_DELETED = "IDPTeamDeleted";
  ...
  public TeamDeleteEvent(ScopeInfo scopeInfo, String oldInlineCatalogEntityYaml, String kind, String identifier) {
