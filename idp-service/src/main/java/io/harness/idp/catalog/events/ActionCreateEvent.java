...
public class ActionCreateEvent implements Event {
  public static final String IDP_ACTION_CREATED = "IDPActionCreated";
  ...
  public ActionCreateEvent(
      ScopeInfo scopeInfo, String newActionJson, String identifier, String version, String uniqueId) {
