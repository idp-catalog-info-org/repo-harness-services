...
@Getter
@NoArgsConstructor
public class WorkflowCreateEvent implements Event {
  public static final String IDP_WORKFLOW_CREATED = "IDPWorkflowCreated";
  ...
  public WorkflowCreateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml, String kind, String identifier) {
