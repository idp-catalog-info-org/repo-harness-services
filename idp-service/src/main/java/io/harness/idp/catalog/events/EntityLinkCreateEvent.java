...
@Getter
@NoArgsConstructor
public class EntityLinkCreateEvent implements Event {
  public static final String ENTITY_LINK_CREATED = "EntityLinkCreated";
  ...
  public EntityLinkCreateEvent(String accountIdentifier, String orgIdentifier, String projectIdentifier,
      String entityRef, String newEntityLinkJson) {
