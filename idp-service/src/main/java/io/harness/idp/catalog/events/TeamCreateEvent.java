...
@Getter
@NoArgsConstructor
public class TeamCreateEvent implements Event {
  public static final String IDP_TEAM_CREATED = "IDPTeamCreated";
  ...
  public TeamCreateEvent(ScopeInfo scopeInfo, String newInlineCatalogEntityYaml, String kind, String identifier) {
