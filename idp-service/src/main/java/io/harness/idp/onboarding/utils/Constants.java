...
public class Constants {
  ...
  public static final String ONBOARDING_SAMPLE_CATALOG_INFO = "configs/onboarding/sample-catalog-info.yaml";
  ...
  public static final String STATUS_UPDATE_REASON_FOR_ONBOARDING_SKIPPED = "Onboarding skipped";
  public static final String SUCCESS_RESPONSE_STRING = "SUCCESS";
  public static final String ONBOARDING_COMPLETED_ALLOW_FURTHER = "ONBOARDING_COMPLETED_ALLOW_FURTHER";
}
