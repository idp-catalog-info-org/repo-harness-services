...
@JsonSubTypes({ @JsonSubTypes.Type(value = HarnessCDIntegrationEntity.class, name = "HARNESS_CD") })
@OwnedBy(HarnessTeam.IDP)
public abstract class CatalogIntegrationEntity extends IntegrationEntity {}
