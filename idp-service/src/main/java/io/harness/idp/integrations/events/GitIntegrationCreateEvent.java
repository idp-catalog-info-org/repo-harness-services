...
@NoArgsConstructor
@OwnedBy(IDP)
public class GitIntegrationCreateEvent implements Event {
  public static final String GIT_INTEGRATION_CREATED = "GIT_INTEGRATION_CREATED";
  private String accountIdentifier;
  private GitIntegrationEntity entity;

  public GitIntegrationCreateEvent(String accountIdentifier, GitIntegrationEntity entity) {
  ...
  public String getEventType() {
    return GIT_INTEGRATION_CREATED;
  }
}
