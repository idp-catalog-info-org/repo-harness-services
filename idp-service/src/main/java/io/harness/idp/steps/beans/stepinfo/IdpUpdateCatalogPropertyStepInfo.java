...
@Data
@NoArgsConstructor
@JsonTypeName(Constants.UPDATE_CATALOG_PROPERTY)
@TypeAlias("IdpUpdateCatalogPropertyStepInfo")
@OwnedBy(HarnessTeam.IDP)
@Builder
@AllArgsConstructor
@RecasterAlias("io.harness.idp.pipeline.steps.beans.stepinfo.IdpUpdateCatalogPropertyStepInfo")
public class IdpUpdateCatalogPropertyStepInfo implements PluginCompatibleStep {
  ...
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> property;
  @ApiModelProperty(dataType = STRING_LIST_CLASSPATH) ParameterField<List<PropertiesParameterField>> properties;
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> entityRef;
  @ApiModelProperty(dataType = STRING_LIST_CLASSPATH) ParameterField<List<EntityRefsParameterField>> entityRefs;
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<Object> value;
  ...
  public TypeInfo getNonYamlInfo() {
    return TypeInfo.builder().stepInfoType(CIStepInfoType.UPDATE_CATALOG_PROPERTY).build();
  }

  @Override
  public StepType getStepType() {
    return Constants.UPDATE_CATALOG_PROPERTY_STEP_TYPE;
  }
