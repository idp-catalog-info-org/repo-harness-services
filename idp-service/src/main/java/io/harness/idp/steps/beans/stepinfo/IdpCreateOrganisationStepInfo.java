...
@TypeAlias("IdpCreateOrganisationStepInfo")
@OwnedBy(HarnessTeam.IDP)
@Builder
@AllArgsConstructor
@RecasterAlias("io.harness.idp.pipeline.steps.beans.stepinfo.IdpCreateOrganisationStepInfo")
public class IdpCreateOrganisationStepInfo implements PluginCompatibleStep {
  ...
  public TypeInfo getNonYamlInfo() {
    return TypeInfo.builder().stepInfoType(CIStepInfoType.CREATE_ORGANISATION).build();
  }

  @Override
  public StepType getStepType() {
    return Constants.CREATE_ORGANISATION_STEP_TYPE;
  }
