...
@TypeAlias("IdpCreateProjectStepInfo")
@OwnedBy(HarnessTeam.IDP)
@Builder
@AllArgsConstructor
@RecasterAlias("io.harness.idp.pipeline.steps.beans.stepinfo.IdpCreateProjectStepInfo")
public class IdpCreateProjectStepInfo implements PluginCompatibleStep {
  ...
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> orgIdentifier;
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> description;
  @ApiModelProperty(dataType = STRING_LIST_CLASSPATH) ParameterField<List<String>> tags;
  ...
  public TypeInfo getNonYamlInfo() {
    return TypeInfo.builder().stepInfoType(CIStepInfoType.CREATE_PROJECT).build();
  }

  @Override
  public StepType getStepType() {
    return Constants.CREATE_PROJECT_STEP_TYPE;
  }
