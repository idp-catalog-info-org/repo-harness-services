...
import io.harness.steps.spec.NGSpecStep;
...
public class IDPStagePlanCreator extends AbstractStagePlanCreator<IDPStageNode> {
  ...
  private IntegrationStageNode getIntegrationStageNode(IDPStageNode stageNode) {
    ...
    // Resolve cloneCodebase with default false to handle unspecified cases
    boolean cloneCodebase = RunTimeInputHandler.resolveBooleanParameter(currentStageConfig.getCloneCodebase(), false);
