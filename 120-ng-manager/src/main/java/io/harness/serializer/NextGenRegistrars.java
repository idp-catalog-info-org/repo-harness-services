...
import io.harness.branding.serializer.BrandingRegistrars;
import io.harness.cdng.artifact.bean.yaml.ArtifactSourceConfig;
import io.harness.cdng.deployable.bean.yaml.DeployableWrapperConfig;
...
import io.harness.connector.serializer.spring.BitbucketApiAccessReadConverter;
...
import io.harness.serializer.morphia.PrivateConnectivityMorphiaRegistrars;
...
import io.harness.transientData.TransientExecutionDataRegistrars;
...
public class NextGenRegistrars {
  public static final ImmutableSet<Class<? extends KryoRegistrar>> kryoRegistrars =
      ImmutableSet.<Class<? extends KryoRegistrar>>builder()
          ...
          .addAll(TransientExecutionDataRegistrars.kryoRegistrars)
          .build();
  ...
  public static final ImmutableSet<Class<? extends MorphiaRegistrar>> morphiaRegistrars =
      ImmutableSet.<Class<? extends MorphiaRegistrar>>builder()
          ...
          .addAll(NgSubscriptionsRegistrars.morphiaRegistrars)
          .addAll(NgCertificateRegistrars.morphiaRegistrars)
          .addAll(NgBannerRegistrars.morphiaRegistrars)
          .addAll(BrandingRegistrars.morphiaRegistrars)
          .addAll(NGLdapSettingsRegistrars.morphiaRegistrars)
          .addAll(EulaRegistrar.morphiaRegistrars)
          .addAll(OidcRegistrars.morphiaRegistrars)
          .addAll(FavoritesRegistrar.morphiaRegistrars)
          .add(TunnelMorphiaRegistrars.class)
          .add(PrivateConnectivityMorphiaRegistrars.class)
          .addAll(TransientExecutionDataRegistrars.morphiaRegistrars)
          .build();
  ...
  public static final ImmutableList<YamlSchemaRootClass> yamlSchemaRegistrars =
      ImmutableList.<YamlSchemaRootClass>builder()
          ...
          .add(YamlSchemaRootClass.builder()
                   ...
                   .availableAtAccountLevel(true)
                   .availableAtOrgLevel(true)
                   .clazz(ServiceOverrideSpecConfig.class)
                   .build())
          .add(YamlSchemaRootClass.builder()
                   .entityType(EntityType.DEPLOYABLE)
                   .availableAtProjectLevel(true)
                   .availableAtAccountLevel(true)
                   .availableAtOrgLevel(true)
                   .clazz(DeployableWrapperConfig.class)
                   .build())
          .build();
  ...
  public static final ImmutableList<Class<? extends Converter<?, ?>>> springConvertors =
      ImmutableList.<Class<? extends Converter<?, ?>>>builder()
          .add(EntityUsageDetailReadConvertor.class)
          .add(EntityUsageDetailWriteConvertor.class)
          .add(BitbucketApiAccessReadConverter.class)
          .addAll(TransientExecutionDataRegistrars.springConverters)
          .build();
}