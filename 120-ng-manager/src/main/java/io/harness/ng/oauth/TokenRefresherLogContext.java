...
public class TokenRefresherLogContext extends AutoLogContext {
  ...
  public TokenRefresherLogContext(String accountIdentifier, String userIdentifier, SCMType type,
      String providerIdentifier, OverrideBehavior behavior) {
    super(ImmutableMap.of("accountIdentifier", accountIdentifier, "userIdentifier", userIdentifier, "type",
              type.toString(), "message", "OAuthTokenRefresher", "providerIdentifier", providerIdentifier),
        behavior);
  }
}
