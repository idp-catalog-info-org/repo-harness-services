...
public class ServiceGrowthTrendAndEnvBasedInfo {
  io.harness.ng.overview.dto.TimeValuePairListDTO<Integer> timeValuePairListDTO;
  Map<EnvironmentTypeCount, Integer> ActiveServiceInstancesCountBasedOnEnvironmentType;
