...
public class CDLandingDashboardResource {
  ...
  public ResponseDTO<ServicesDashboardInfo> getActiveServices(
    ...
    return ResponseDTO.newResponse(cdLandingDashboardService.getActiveServicesWithParentUniqueId(
  ...
  public ResponseDTO<ProjectsDashboardInfo> getTopProjects(
    ...
    return ResponseDTO.newResponse(cdLandingDashboardService.getTopProjectsWithParentIdQuerying(
  ...
  public ResponseDTO<DeploymentStatsSummary> getDeploymentStatsSummary(
    ...
    return ResponseDTO.newResponse(cdLandingDashboardService.getDeploymentStatsSummaryWithParentUniqueIdQuerying(
  ...
  public ResponseDTO<PipelinesExecutionDashboardInfo> getActiveDeploymentStats(
      @NotNull @QueryParam(NGCommonEntityConstants.ACCOUNT_KEY) @AccountIdentifier String accountIdentifier,
      @NotNull LandingDashboardRequestCD landingDashboardRequestCD) {
    return ResponseDTO.newResponse(cdLandingDashboardService.getActiveDeploymentStatsWithParentUniqueIdQuerying(
  ...
  public ResponseDTO<ServicesCount> getServicesCount(
      ...
      @NotNull @QueryParam(NGResourceFilterConstants.END_TIME) long endInterval,
      @NotNull LandingDashboardRequestCD landingDashboardRequestCD) {
    return ResponseDTO.newResponse(cdLandingDashboardService.getServicesCountWithParentUniqueIdQuerying(
        accountIdentifier, landingDashboardRequestCD.getOrgProjectIdentifiers(),
        landingDashboardRequestCD.getOrgIdentifierList(), landingDashboardRequestCD.getOrgIdentifiersWithUniqueIds(),
        landingDashboardRequestCD.getRequestScope(), startInterval, endInterval));
  }
  ...
  public ResponseDTO<EnvCount> getEnvCount(
      ...
      @NotNull @QueryParam(NGResourceFilterConstants.END_TIME) long endInterval,
      @NotNull LandingDashboardRequestCD landingDashboardRequestCD) {
    return ResponseDTO.newResponse(cdLandingDashboardService.getEnvCountWithParentUniqueIdQuerying(accountIdentifier,
        landingDashboardRequestCD.getOrgProjectIdentifiers(), landingDashboardRequestCD.getOrgIdentifierList(),
        landingDashboardRequestCD.getOrgIdentifiersWithUniqueIds(), landingDashboardRequestCD.getRequestScope(),
