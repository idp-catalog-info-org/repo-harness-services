...
import io.harness.spec.server.ng.v1.ProjectCdDashboardApi;
...
public class ProjectCDDashboardApiImpl extends AbstractCDDashboardApi implements ProjectCdDashboardApi {
  @Inject
  public ProjectCDDashboardApiImpl(CDOverviewDashboardService cdOverviewDashboardService,
  ...
  @Override
  public Response getDashboardServices(String org, String project, String harnessAccount, Integer page,
    ...
    return super.getApiServices(harnessAccount, org, project, sort != null ? List.of(sort) : List.of(), repoName, page,
