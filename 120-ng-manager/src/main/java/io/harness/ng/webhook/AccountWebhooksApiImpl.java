...
import io.harness.spec.server.ng.v1.AccountWebhooksApi;
...
@Slf4j
@OwnedBy(CDC)
public class AccountWebhooksApiImpl implements AccountWebhooksApi {
  ...
  @Override
  public Response createAccountWebhooks(@Valid CreateWebhookRequest body, String harnessAccount) {
    CreateGitXWebhookResponseDTO createGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.createWebhook(harnessAccount, null, null, body);
  ...
  @Override
  public Response deleteAccountWebhook(String webhook, String harnessAccount) {
    DeleteGitXWebhookResponseDTO deleteGitXWebhookResponse =
        gitXWebhooksApiHelper.deleteGitXWebhook(harnessAccount, null, null, webhook);
  ...
  @Override
  public Response getAccountWebhook(String webhook, String harnessAccount) {
    Optional<GetGitXWebhookResponseDTO> optionalGetGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.getGitXWebhook(harnessAccount, null, null, webhook);
  ...
  @Override
  public Response listAccountWebhooks(
      @Valid ListWebhookRequest listWebhookRequest, String harnessAccount, Integer page, @Max(1000L) Integer limit) {
    Page<WebhookResponse> webhookResponse =
        webhooksHelper.listWebhooks(harnessAccount, null, null, listWebhookRequest, page, limit);
  ...
  @Override
  public Response updateAccountWebhook(String webhook, @Valid UpdateWebhookRequest body, String harnessAccount) {
    UpdateGitXWebhookResponseDTO updateGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.updateWebhook(harnessAccount, null, null, webhook, body);
