...
import io.harness.spec.server.ng.v1.ProjectWebhooksApi;
...
@Slf4j
@OwnedBy(CDC)
public class ProjectWebhooksApiImpl implements ProjectWebhooksApi {
  ...
  @Override
  public Response createProjectWebhooks(
      String org, String project, @Valid CreateWebhookRequest body, String harnessAccount) {
    CreateGitXWebhookResponseDTO createGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.createWebhook(harnessAccount, org, project, body);
  ...
  @Override
  public Response deleteProjectWebhook(String org, String project, String webhook, String harnessAccount) {
    DeleteGitXWebhookResponseDTO deleteGitXWebhookResponse =
        gitXWebhooksApiHelper.deleteGitXWebhook(harnessAccount, org, project, webhook);
  ...
  @Override
  public Response getProjectWebhook(String org, String project, String webhook, String harnessAccount) {
    Optional<GetGitXWebhookResponseDTO> optionalGetGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.getGitXWebhook(harnessAccount, org, project, webhook);
  ...
  @Override
  public Response listProjectWebhooks(String org, String project, @Valid ListWebhookRequest listWebhookRequest,
      String harnessAccount, Integer page, @Max(1000L) Integer limit) {
    Page<WebhookResponse> webhookResponse =
        webhooksHelper.listWebhooks(harnessAccount, org, project, listWebhookRequest, page, limit);
  ...
  @Override
  public Response updateProjectWebhook(
      String org, String project, String webhook, @Valid UpdateWebhookRequest body, String harnessAccount) {
    UpdateGitXWebhookResponseDTO updateGitXWebhookResponseDTO =
        gitXWebhooksApiHelper.updateWebhook(harnessAccount, org, project, webhook, body);
