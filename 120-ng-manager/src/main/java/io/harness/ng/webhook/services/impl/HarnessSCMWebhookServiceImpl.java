...
public class HarnessSCMWebhookServiceImpl implements WebhookEventService {
  ...
  @Inject
  public HarnessSCMWebhookServiceImpl(BaseUrls baseUrls, ScmClient scmClient,
      @Named("ngServiceSecret") String ngServiceSecret, HarnessCodeConnectorUtils harnessCodeConnectorUtils) {
  ...
  private ScmConnector getDummyScmConnector(
    ...
    try (GlobalContextManager.GlobalContextGuard guard = GlobalContextManager.ensureGlobalContextGuard()) {
      ...
      return harnessCodeConnectorUtils.getDummyHarnessCodeConnectorWithJwtAuth(accountId, orgIdentifier,
          projectIdentifier, repoName, ngServiceSecret, baseUrls.getScmServiceBaseUrl(),
          baseUrls.getHarnessCodeGitUrl(), null);
    }
  }
}
