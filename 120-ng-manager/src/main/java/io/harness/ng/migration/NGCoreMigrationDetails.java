...
import io.harness.ng.core.migration.CEAzureConnectorBillingTypeMigration;
import io.harness.ng.core.migration.CEIncludeDiscountSettingMigration;
...
import io.harness.ng.core.migration.EnableSSCAAirgapSettingMigration;
import io.harness.ng.core.migration.GcpSecretManagerCredentialsMigration;
...
public class NGCoreMigrationDetails implements MigrationDetails {
  ...
  public List<Pair<Integer, Class<? extends NGMigration>>> getMigrations() {
    return new ImmutableList.Builder<Pair<Integer, Class<? extends NGMigration>>>()
        ...
        .add(Pair.of(10, NoopNGCoreMigration.class))
        ...
        .add(Pair.of(14, GcpSecretManagerCredentialsMigration.class))
        .add(Pair.of(15, CEAzureConnectorBillingTypeMigration.class))
        .add(Pair.of(16, EnableSSCAAirgapSettingMigration.class))
        .add(Pair.of(17, CEIncludeDiscountSettingMigration.class))
        .build();
  }
}
