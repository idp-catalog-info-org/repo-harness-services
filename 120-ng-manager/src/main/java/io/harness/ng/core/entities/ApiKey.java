    ...
    return ImmutableList.<MongoIndex>builder()
        .add(CompoundMongoIndex.builder()
            ...
            CompoundMongoIndex.builder()
                .name("parentUniqueId_parentIdentifier_identifier_apiKeyType_idx")
                .field(ApiKeyKeys.parentUniqueId)
                .field(ApiKeyKeys.parentIdentifier)
                ...
                .build(),
            CompoundMongoIndex.builder()
                .name("accountIdentifier_parentUniqueId_parentIdentifier_identifier_apiKeyType_idx")
                .field(ApiKeyKeys.accountIdentifier)
                .field(ApiKeyKeys.parentUniqueId)
                .field(ApiKeyKeys.parentIdentifier)
                .field(ApiKeyKeys.identifier)
