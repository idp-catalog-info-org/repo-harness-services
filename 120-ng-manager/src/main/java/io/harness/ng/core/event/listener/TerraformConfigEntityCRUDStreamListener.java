...
import io.harness.ng.core.event.handler.TerraformConfigEntityCRUDEventHandler;
...
public class TerraformConfigEntityCRUDStreamListener implements MessageListener {
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(
        ...
        ? terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForAnyScope(
              accountEntityChangeDTO.getAccountId())
        : terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForAccount(
              accountEntityChangeDTO.getAccountId());
  }
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(organizationEntityChangeDTO.getAccountIdentifier(),
        ...
        : terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForOrganization(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(
        ...
        : terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForProject(
