...
import io.harness.ng.core.event.handler.CloudformationConfigEntityCRUDEventHandler;
...
public class CloudformationConfigEntityCRUDStreamListener implements MessageListener {
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(
               accountEntityChangeDTO.getAccountId(), FeatureName.PL_MOVE_PROJECTS_CLOUD_FORMATION)
        ? cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForAnyScope(
              accountEntityChangeDTO.getAccountId())
        : cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForAccount(
              accountEntityChangeDTO.getAccountId());
  }
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(
               organizationEntityChangeDTO.getAccountIdentifier(), FeatureName.PL_MOVE_PROJECTS_CLOUD_FORMATION)
        ? cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForAnyScope(
              organizationEntityChangeDTO.getUniqueId())
        : cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForOrganization(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    return pmsFeatureFlagHelper.isEnabled(
               projectEntityChangeDTO.getAccountIdentifier(), FeatureName.PL_MOVE_PROJECTS_CLOUD_FORMATION)
        ? cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForAnyScope(
              projectEntityChangeDTO.getUniqueId())
        : cloudformationConfigEntityCRUDEventHandler.deleteAssociatedCloudformationConfigForProject(
