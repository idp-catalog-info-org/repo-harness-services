...
public class AcrArtifactResource {
  ...
  private final AcrArtifactApiUtils acrArtifactService;
  ...
  public ResponseDTO<AcrRegistriesDTO> getRegistriesBySubscription(
    ...
    ScopeInfo scopeInfo = scopeInfoService.getScopeInfo(
        connectorRef.getAccountIdentifier(), connectorRef.getOrgIdentifier(), connectorRef.getProjectIdentifier());
    return ResponseDTO.newResponse(
        acrResourceService.getRegistries(connectorRef, orgIdentifier, projectIdentifier, subscriptionId, scopeInfo));
  }
  ...
  getAzureRepositories(@NotNull @QueryParam("connectorRef") String azureConnectorIdentifier,
    ...
    return ResponseDTO.newResponse(acrResourceService.getRepositories(
  ...
  public ResponseDTO<AcrResponseDTO> getBuildDetails(@QueryParam("subscriptionId") String subscriptionId,
    ...
    AcrResponseDTO buildDetails = acrArtifactService.getBuildDetails(
        accountId, orgIdentifier, projectIdentifier, subscriptionId, registry, repository, azureConnectorIdentifier);
