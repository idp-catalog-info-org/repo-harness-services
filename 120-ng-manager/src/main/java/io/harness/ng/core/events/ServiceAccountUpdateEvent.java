...
public class ServiceAccountUpdateEvent implements Event {
  ...
  public ResourceScope getResourceScope() {
    return ResourceScopeMapper.getResourceScope(
        Scope.of(newServiceAccount.getAccountIdentifier(), newServiceAccount.getOrgIdentifier(),
            newServiceAccount.getProjectIdentifier()),
        newServiceAccount.getParentUniqueId());
  }
