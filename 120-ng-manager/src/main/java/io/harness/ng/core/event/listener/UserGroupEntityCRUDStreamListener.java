...
public class UserGroupEntityCRUDStreamListener implements MessageListener {
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              ...
                              .uniqueId(stripToNull(accountEntityChangeDTO.getAccountId()))
                              .scopeType(ScopeLevel.ACCOUNT)
                              .build();
    if (action != null) {
      if (action.equals(DELETE_ACTION)) {
        return processDeleteEvent(scopeInfo);
      }
      if (action.equals(CREATE_ACTION)) {
        return processCreateEvent(scopeInfo);
      }
    }
    return true;
  }
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              ...
                              .uniqueId(stripToNull(organizationEntityChangeDTO.getUniqueId()))
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              ...
                              .uniqueId(stripToNull(projectEntityChangeDTO.getUniqueId()))
  ...
  private boolean processDeleteEvent(ScopeInfo scopeInfo) {
    try {
      userGroupService.deleteByScope(scopeInfo);
    } catch (Exception e) {
  ...
  private boolean processCreateEvent(ScopeInfo scopeInfo) {
    try {
      defaultUserGroupService.create(scopeInfo, Collections.emptyList());
