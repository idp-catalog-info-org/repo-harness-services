...
import io.harness.ng.core.event.AbstractEntityCleanupUsingScopeInfoListener;
...
@Slf4j
@Singleton
public class SettingsEventListener extends AbstractEntityCleanupUsingScopeInfoListener {
  ...
  @Override
  public boolean processDeleteEvent(ScopeInfo scopeInfo) {
    try {
      settingsService.deleteAtAllScopes(scopeInfo);
    } catch (Exception e) {
