...
public class ApiKeyDTOMapper {
  public ApiKey getApiKeyFromDTO(ApiKeyDTO dto, ScopeInfo scopeInfo) {
  ...
  public ApiKeyDTO getDTOFromApiKey(ApiKey apiKey, ScopeInfo scopeInfo) {
