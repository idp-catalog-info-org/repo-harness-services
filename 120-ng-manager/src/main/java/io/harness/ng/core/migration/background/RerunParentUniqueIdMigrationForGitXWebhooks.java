...
@Slf4j
public class RerunParentUniqueIdMigrationForGitXWebhooks implements NGMigration {
  @Inject private HPersistence persistence;

  private static final String DEBUG_LOG = "[RerunParentUniqueIdMigrationForGitXWebhooksStatus]: ";

  @Override
  public void migrate() {
    try {
      log.info(DEBUG_LOG + "Starting resetting of parentIdMigrationCompleted field for GitXWebhook to false");
      ...
      log.error(DEBUG_LOG + "Failed to reset parentIdMigrationCompleted field for GitXWebhook", e);
    }
    log.info(DEBUG_LOG
        + ("Successfully reset parentIdMigrationCompleted field for GitXWebhook to false and "
