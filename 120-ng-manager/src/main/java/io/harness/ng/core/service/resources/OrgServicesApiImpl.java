...
public class OrgServicesApiImpl extends AbstractServicesApiImpl implements OrgServicesApi {
  ...
  @ResponseMetered
  @Override
  public Response createOrgScopedService(@Valid ServiceCreateRequest serviceRequest, String org, String account) {
  ...
  public Response getOrgScopedPrimaryManifests(String service, String org, String harnessAccount) {
    return super.getPrimaryManifestList(service, org, null, null, harnessAccount);
  }

  @Timed
  @ResponseMetered
  @Override
  public Response postOrgScopedPrimaryManifests(
      String service, String org, GitEntityFindInfoDTO gitEntityFindInfoDTO, String harnessAccount) {
    return super.getPrimaryManifestList(service, org, null, gitEntityFindInfoDTO, harnessAccount);
  }
  ...
  public Response updateOrgScopedService(
      @Valid ServiceUpdateRequest serviceRequest, String org, String service, String account) {
