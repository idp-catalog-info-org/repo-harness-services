...
import io.harness.ng.core.event.handler.AzureARMConfigEntityCRUDEventHandler;
...
public class AzureARMConfigEntityCRUDStreamListener implements MessageListener {
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    if (pmsFeatureFlagHelper.isEnabled(accountEntityChangeDTO.getAccountId(), FeatureName.PL_MOVE_AZURE_ARM)) {
      return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForScope(
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    if (pmsFeatureFlagHelper.isEnabled(
            organizationEntityChangeDTO.getAccountIdentifier(), FeatureName.PL_MOVE_AZURE_ARM)) {
      return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForScope(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    if (pmsFeatureFlagHelper.isEnabled(projectEntityChangeDTO.getAccountIdentifier(), FeatureName.PL_MOVE_AZURE_ARM)) {
      return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForScope(
