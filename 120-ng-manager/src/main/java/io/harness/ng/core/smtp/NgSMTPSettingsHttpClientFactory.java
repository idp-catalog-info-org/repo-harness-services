...
public class NgSMTPSettingsHttpClientFactory
  ...
  public NgSMTPSettingsHttpClientFactory(ServiceHttpClientConfig ngManagerConfig, String serviceSecret,
      ServiceTokenGenerator tokenGenerator, KryoConverterFactory kryoConverterFactory, CircuitBreaker circuitBreaker) {
    super(
        ngManagerConfig, serviceSecret, tokenGenerator, kryoConverterFactory, "NgSMTP-settings-client", circuitBreaker);
    setTargetServiceId(NG_MANAGER.getServiceId());
  }
  @Override
