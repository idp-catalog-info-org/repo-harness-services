...
public class EnvironmentGroupEntityCrudStreamListener implements MessageListener {
  ...
  private void processDeleteEvent(ProjectEntityChangeDTO entityChangeDTO) {
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              .accountIdentifier(entityChangeDTO.getAccountIdentifier())
                              .orgIdentifier(entityChangeDTO.getOrgIdentifier())
                              .projectIdentifier(entityChangeDTO.getIdentifier())
                              .uniqueId(entityChangeDTO.getUniqueId())
                              .scopeType(ScopeLevel.PROJECT)
                              .build();
    environmentGroupService.deleteAtCurrentScope(scopeInfo);
  }
}
