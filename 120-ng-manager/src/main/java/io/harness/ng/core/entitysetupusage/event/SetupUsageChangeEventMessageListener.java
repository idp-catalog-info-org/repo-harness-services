...
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.AUDIT_STREAMING_DESTINATION;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.CERTIFICATES;
...
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.CHAOS_INFRASTRUCTURE_V2;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.CONNECTORS;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.DATA_SINK;
...
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.IDP_ENVIRONMENT_BLUEPRINT;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.INFRASTRUCTURE;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.INTEGRATION_CONFIGURATION;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.INTEGRATION_SETTING;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.NOTIFICATION_CHANNEL;
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.NOTIFICATION_RULE;
...
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.SERVICE_DISCOVERY_AGENT;
...
import static io.harness.eventsframework.schemas.entity.EntityTypeProtoEnum.USERGROUP;
...
public class SetupUsageChangeEventMessageListener implements MessageListener {
  ...
  final Set<EntityTypeProtoEnum> entityTypesSupportedByNGCore =
      Sets.newHashSet(SECRETS, CONNECTORS, SERVICE, ENVIRONMENT, ENVIRONMENT_GROUP, TEMPLATE, FILES, PIPELINES,
          INFRASTRUCTURE, TRIGGERS, CHAOS_INFRASTRUCTURE, CHAOS_HUB, CERTIFICATES, NOTIFICATION_CHANNEL,
          NOTIFICATION_RULE, CHAOS_INFRASTRUCTURE_V2, SERVICE_DISCOVERY_AGENT, DATA_SINK, IDP_ENVIRONMENT_BLUEPRINT,
          AUDIT_STREAMING_DESTINATION, USERGROUP, INTEGRATION_CONFIGURATION, INTEGRATION_SETTING);
