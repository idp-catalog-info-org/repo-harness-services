...
public class InstanceNGCRUDStreamListener implements MessageListener {
  ...
  private boolean processProjectDeleteEvent(ProjectEntityChangeDTO entityChangeDTO) {
    final String accountIdentifier = entityChangeDTO.getAccountIdentifier();
    final String orgIdentifier = entityChangeDTO.getOrgIdentifier();
    final String projIdentifier = entityChangeDTO.getIdentifier();
    final String uniqueId = entityChangeDTO.getUniqueId();
    ...
    ScopeInfo scopeInfo = ScopeInfo.builder()
                              ...
                              .build();
    return instanceService.deleteForProject(scopeInfo);
  }
}
