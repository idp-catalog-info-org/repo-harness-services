...
public class ProjectServicesApiImpl extends AbstractServicesApiImpl implements ProjectServicesApi {
  ...
  @ResponseMetered
  @Override
  public Response createService(ServiceCreateRequest serviceRequest, String org, String project, String account) {
  ...
  public Response getPrimaryManifests(String service, String org, String project, String harnessAccount) {
    return super.getPrimaryManifestList(service, org, project, null, harnessAccount);
  }

  @Timed
  @ResponseMetered
  @Override
  public Response postPrimaryManifests(
      String service, String org, String project, GitEntityFindInfoDTO gitEntityFindInfoDTO, String harnessAccount) {
    return super.getPrimaryManifestList(service, org, project, gitEntityFindInfoDTO, harnessAccount);
  }
