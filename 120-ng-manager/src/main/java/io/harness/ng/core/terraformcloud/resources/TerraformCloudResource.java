...
import io.harness.cdng.provision.terraformcloud.resources.dtos.ProjectsDTO;
...
public class TerraformCloudResource {
  ...
  @Timed
  @ResponseMetered
  @ApiOperation(value = "Gets terraform cloud projects", nickname = "getTerraformCloudProjects")
  public ResponseDTO<ProjectsDTO> getProjects(
      @NotNull @QueryParam("connectorRef") String terraformCloudConnectorIdentifier,
      @NotNull @QueryParam(NGCommonEntityConstants.ACCOUNT_KEY) String accountId,
      @QueryParam(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @QueryParam(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
    ...
    IdentifierRef connectorRef = IdentifierRefHelper.getConnectorIdentifierRef(
        terraformCloudConnectorIdentifier, accountId, orgIdentifier, projectIdentifier);
    return ResponseDTO.newResponse(
        terraformCloudResourceService.getProjects(connectorRef, orgIdentifier, projectIdentifier, organization));
  }
  ...
  public ResponseDTO<WorkspacesDTO> getWorkspaces(@QueryParam("connectorRef") String terraformCloudConnectorIdentifier,
      ...
      @QueryParam(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @QueryParam(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @NotEmpty @NotNull @QueryParam("organization") String organization, @QueryParam("projectId") String tfProjectId) {
    orgAndProjectValidationHelper.checkThatTheOrganizationAndProjectExists(orgIdentifier, projectIdentifier, accountId);
    IdentifierRef connectorRef = IdentifierRefHelper.getConnectorIdentifierRef(
        terraformCloudConnectorIdentifier, accountId, orgIdentifier, projectIdentifier);

    return ResponseDTO.newResponse(terraformCloudResourceService.getWorkspaces(
        connectorRef, orgIdentifier, projectIdentifier, organization, tfProjectId));
  }
}
