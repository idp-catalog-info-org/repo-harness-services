...
import io.harness.spec.server.ng.v1.OrgInfrastructuresApi;
...
@NextGenManagerAuth
public class OrgInfrastructuresApiImpl extends AbstractInfrastructuresApiImpl implements OrgInfrastructuresApi {
  @Inject
  OrgInfrastructuresApiImpl(InfrastructureEntityService infrastructureEntityService,
  ...
  @Override
  public Response createOrgScopedInfrastructure(
      @Valid InfrastructureCreateRequest body, String org, String environment, String harnessAccount) {
    return super.createInfrastructureEntity(body, org, null, environment, harnessAccount);
  }

  @Override
  public Response deleteOrgScopedInfrastructure(
      String org, String environment, String infrastructureDefinition, String harnessAccount, Boolean forceDelete) {
    return super.deleteInfrastructureEntity(
        org, null, environment, infrastructureDefinition, harnessAccount, forceDelete);
  }

  @Override
  public Response getOrgScopedInfrastructure(
      String org, String environment, String infrastructureDefinition, String harnessAccount) {
    return super.getInfrastructureEntity(org, null, environment, infrastructureDefinition, harnessAccount);
  }

  @Override
  public Response getOrgScopedInfrastructures(String org, String environment, String harnessAccount, Integer page,
      @Max(1000L) Integer limit, String searchTerm, List<String> infraIds, String sort, Boolean isAccessList,
      List<String> serviceRefs, String templateIdentifier, String templateVersion, String deploymentType,
      String order) {
    return super.getInfrastructureEntities(org, null, environment, harnessAccount, page, limit, searchTerm, infraIds,
        sort, isAccessList, serviceRefs, templateIdentifier, templateVersion, deploymentType, order);
  }

  @Override
  public Response updateOrgScopedInfrastructure(@Valid InfrastructureUpdateRequest body, String org, String environment,
      String infrastructureDefinition, String harnessAccount) {
    return super.updateInfrastructureEntity(body, org, null, environment, infrastructureDefinition, harnessAccount);
  }
}
