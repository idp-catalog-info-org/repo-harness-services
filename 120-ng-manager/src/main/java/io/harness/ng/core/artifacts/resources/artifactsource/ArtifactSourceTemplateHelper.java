...
package io.harness.ng.core.artifacts.resources.artifactsource;
...
public class ArtifactSourceTemplateHelper {
  ...
  public List<EntityDetailProtoDTO> getReferencesFromYaml(
    ...
    } catch (InvalidYamlRuntimeException e) {
      log.error(String.format("Error fetching references - %s", e.getMessage()), e);
