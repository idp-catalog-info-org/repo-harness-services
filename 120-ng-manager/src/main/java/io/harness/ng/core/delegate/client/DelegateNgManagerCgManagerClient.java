...
public interface DelegateNgManagerCgManagerClient {
  ...
  String DELEGATE_TOKEN_NG_API_V2 = "delegate-token-ng";
  ...
  Call<RestResponse<DelegateTokenDetails>> createToken(
      ...
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId,
  ...
  @DELETE(DELEGATE_TOKEN_NG_API)
  Call<RestResponse<Void>> deleteToken(@Query(NGCommonEntityConstants.ACCOUNT_KEY) @NotNull String accountIdentifier,
      @Query(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId,
      @Query("tokenName") @NotNull String tokenName);
  ...
  Call<RestResponse<List<DelegateTokenDetails>>> getTokens(@Query("tokenName") String tokenName,
      ...
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId,
      @Query("status") DelegateTokenStatus status, @Query("includeValue") boolean includeValue);
  ...
  // the following being called by provision service which is used by trail-signup api
  ...
  Call<RestResponse<List<DelegateGroupDTO>>> listDelegateGroupHavingTags(
      ...
      @Query(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId, @Body @NotNull DelegateGroupTags tags);
  ...
  Call<RestResponse<List<DelegateListResponse>>> getDelegates(
      ...
      @Query(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId, @Query("all") boolean all,
  ...
  Call<RestResponse<String>> overrideDelegateImage(
      ...
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId,
      @Query(NGCommonEntityConstants.TAGS_KEY) Set<String> tags, @Query("delegateTag") @NotNull String delegateTag,
      @Query("validTillNextRelease") Boolean validTillNextRelease, @Query("validForDays") int validForDays);

  @GET(DELEGATE_VERSION_OVERRIDE_API + "/delegate-tag")
  Call<RestResponse<VersionOverridesResponse>> getOverrideDelegateImages(
      @Query(NGCommonEntityConstants.ACCOUNT_KEY) @NotNull String accountIdentifier,
      @Query(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId);

  @DELETE(DELEGATE_VERSION_OVERRIDE_API + "/delegate-tag")
  Call<RestResponse<String>> deleteOverrideDelegateImage(
      @Query(NGCommonEntityConstants.ACCOUNT_KEY) @NotNull String accountIdentifier,
      @Query(NGCommonEntityConstants.ORG_KEY) String orgIdentifier,
      @Query(NGCommonEntityConstants.PROJECT_KEY) String projectIdentifier,
      @Query(NGCommonEntityConstants.PARENT_UNIQUE_ID) String parentUniqueId,
      @Query(NGCommonEntityConstants.TAGS_KEY) Set<String> tags);
