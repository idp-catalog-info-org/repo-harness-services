...
public class ServiceOutBoxEventHandler implements OutboxEventHandler, MoveConfigAuditHandler {
  ...
  public boolean handle(OutboxEvent outboxEvent) {
    ...
    try {
      switch (outboxEvent.getEventType()) {
        ...
        case OutboxEventConstants.SERVICE_MOVED_TO_REMOTE:
  ...
  public Class<? extends MoveConfigEvent> getMoveEventClass() {
    return ServiceMoveConfigEvent.class;
  }
