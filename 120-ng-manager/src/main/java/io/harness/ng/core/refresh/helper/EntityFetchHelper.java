...
public class EntityFetchHelper {
  ...
  public ServiceEntity getService(
    ...
    ScopeInfo scopeInfo = scopeResolutionHelper.getScopeInfo(serviceIdentifierRef.getAccountIdentifier(),
        serviceIdentifierRef.getOrgIdentifier(), serviceIdentifierRef.getProjectIdentifier());
    serviceEntity = serviceEntityService.get(scopeInfo, serviceIdentifierRef.getIdentifier(), false);
