...
public class NgSMTPSettingsHttpClientModule extends AbstractModule {
  public static final String CURRENT_GEN_MANAGER_CIRCUIT_BREAKER_NAME = "cg-manager";
  ...
  private NgSMTPSettingsHttpClientFactory getNgSMTPSettingsHttpClientFactory(
    ...
    return new NgSMTPSettingsHttpClientFactory(managerClientConfig, managerServiceSecret, new ServiceTokenGenerator(),
        kryoConverterFactory, getCircuitBreaker(CURRENT_GEN_MANAGER_CIRCUIT_BREAKER_NAME));
  }
}
