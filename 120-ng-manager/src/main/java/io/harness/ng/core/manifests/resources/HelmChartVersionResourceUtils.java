...
public class HelmChartVersionResourceUtils {
  ...
  String resolveExpressionWithYamlExpressionEvaluator(String accountId, String orgId, String projectId,
      String pipelineId, String runtimeInputYaml, String fieldValue, String finalFieldValue, String fqnPath,
      GitEntityFindInfoDTO gitEntityBasicInfo, String serviceRef, CDYamlExpressionEvaluator yamlExpressionEvaluator) {
    return artifactResourceUtils
        .getResolvedFieldValueWithYamlExpressionEvaluator(accountId, orgId, projectId, pipelineId, runtimeInputYaml,
            isEmpty(fieldValue) ? finalFieldValue : fieldValue, fqnPath, gitEntityBasicInfo, serviceRef,
