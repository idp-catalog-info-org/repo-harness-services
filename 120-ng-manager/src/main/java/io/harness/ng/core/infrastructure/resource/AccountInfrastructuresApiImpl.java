...
import io.harness.spec.server.ng.v1.AccountInfrastructuresApi;
...
@NextGenManagerAuth
public class AccountInfrastructuresApiImpl extends AbstractInfrastructuresApiImpl implements AccountInfrastructuresApi {
  @Inject
  AccountInfrastructuresApiImpl(InfrastructureEntityService infrastructureEntityService,
  ...
  @Override
  public Response createAccountScopedInfrastructure(
      @Valid InfrastructureCreateRequest body, String environment, String harnessAccount) {
    return super.createInfrastructureEntity(body, null, null, environment, harnessAccount);
  }

  @Override
  public Response deleteAccountScopedInfrastructure(
      String environment, String infrastructureDefinition, String harnessAccount, Boolean forceDelete) {
    return super.deleteInfrastructureEntity(
        null, null, environment, infrastructureDefinition, harnessAccount, forceDelete);
  }

  @Override
  public Response getAccountScopedInfrastructure(
      String environment, String infrastructureDefinition, String harnessAccount) {
    return super.getInfrastructureEntity(null, null, environment, infrastructureDefinition, harnessAccount);
  }

  @Override
  public Response getAccountScopedInfrastructures(String environment, String harnessAccount, Integer page,
      ...
      String order) {
    return super.getInfrastructureEntities(null, null, environment, harnessAccount, page, limit, searchTerm, infraIds,
        sort, isAccessList, serviceRefs, templateIdentifier, templateVersion, deploymentType, order);
  }

  @Override
  public Response updateAccountScopedInfrastructure(@Valid InfrastructureUpdateRequest body, String environment,
      String infrastructureDefinition, String harnessAccount) {
    return super.updateInfrastructureEntity(body, null, null, environment, infrastructureDefinition, harnessAccount);
  }
}
