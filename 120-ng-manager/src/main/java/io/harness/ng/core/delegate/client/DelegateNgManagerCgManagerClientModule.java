...
public class DelegateNgManagerCgManagerClientModule extends AbstractModule {
  ...
  private DelegateNgManagerCgManagerClientFactory delegateNgManagerCgManagerClientFactory(
    ...
    return new DelegateNgManagerCgManagerClientFactory(this.serviceHttpClientConfig, this.serviceSecret,
        new ServiceTokenGenerator(), kryoConverterFactory, clientId,
        getCircuitBreaker(CURRENT_GEN_MANAGER_CIRCUIT_BREAKER_NAME));
  }
