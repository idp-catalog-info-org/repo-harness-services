...
public class DocumentationConstants {
  ...
  public static final String OVERRIDE_REQUEST_DTO =
      "{\"orgIdentifier\":\"defaultOrgId\",\"projectIdentifier\":\"defaultProjId\",\"environmentRef\":\"defaultEnvRef\",\"serviceRef\":\"defaultServiceRef\",\"infraIdentifier\":\"defaultInfraId\",\"type\":\"ENV_SERVICE_OVERRIDE\",\"yaml\":\"overrides:\\n  variables:\\n    - name: v1\\n      type: String\\n      value: val1\\n  manifests:\\n    - manifest:\\n        identifier: manifest1\\n        type: K8sManifest\\n        spec:\\n          store:\\n            type: Github\\n            spec:\\n              connectorRef: abcdConnector\\n              gitFetchType: Branch\\n              paths:\\n                - files1\\n              repoName: abcd\\n              branch: master\\n          skipResourceVersioning: false\\n  configFiles:\\n    - configFile:\\n        identifier: configFile1\\n        spec:\\n          store:\\n            type: Harness\\n            spec:\\n              files:\\n                - /abcd\\n\"}";

  public static final String SERVICE_OVERRIDE_IMPORT_REQUEST_DTO =
      "{\"orgIdentifier\":\"defaultOrgId\",\"projectIdentifier\":\"defaultProjId\",\"environmentRef\":\"defaultEnvRef\",\"serviceRef\":\"defaultServiceRef\",\"infraIdentifier\":\"defaultInfraId\",\"type\":\"ENV_SERVICE_OVERRIDE\"}\n";
}
