...
public class NGHostValidationServiceImpl implements NGHostValidationService {
  ...
  private Optional<Secret> findSecret(
    ...
    ScopeInfo scope = scopeResolverService.getScopeInfo(secretIdentifiers.getAccountIdentifier(),
        secretIdentifiers.getOrgIdentifier(), secretIdentifiers.getProjectIdentifier());
    return ngSecretServiceV2.get(scope, secretRefData.getIdentifier());
  }
}
