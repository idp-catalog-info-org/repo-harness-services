  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        .add(CompoundMongoIndex.builder()
                 .name("unique_parentUniqueId_identifier_Index")
                 .unique(true)
                 .field(ServiceAccountKeys.parentUniqueId)
                 .field(ServiceAccountKeys.identifier)
                 .build())
        .add(CompoundMongoIndex.builder()
                 .name("accountId_parentUniqueId_identifier_Index")
        ...
        .add(CompoundMongoIndex.builder()
                 ...
                 .build())
        .add(CompoundMongoIndex.builder()
                 .name("accountId_uniqueId_index")
                 .field(ServiceAccountKeys.accountIdentifier)
                 .field(ServiceAccountKeys.uniqueId)
                 .build())
        .build();
  }
