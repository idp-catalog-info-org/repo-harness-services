...
CREATE TABLE IF NOT EXISTS public.license_usage_yearly (
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_event_yearly ON public.license_usage_yearly (
       utc_timestamp,
       account_identifier,
...
SELECT createPartitioningTable(
    param_table_name := 'license_usage_yearly',
