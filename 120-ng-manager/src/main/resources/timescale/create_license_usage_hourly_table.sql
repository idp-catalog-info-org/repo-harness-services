...
CREATE TABLE IF NOT EXISTS public.license_usage_hourly (
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_event_hourly ON public.license_usage_hourly (
       utc_timestamp,
       account_identifier,
...
SELECT createPartitioningTable(
    param_table_name := 'license_usage_hourly',
