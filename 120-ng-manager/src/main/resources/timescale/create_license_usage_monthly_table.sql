...
CREATE TABLE IF NOT EXISTS public.license_usage_monthly (
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_event_monthly ON public.license_usage_monthly (
       utc_timestamp,
       account_identifier,
...
SELECT createPartitioningTable(
    param_table_name := 'license_usage_monthly',
