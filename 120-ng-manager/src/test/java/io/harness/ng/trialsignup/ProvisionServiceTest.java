...
public class ProvisionServiceTest extends CategoryTest {
  ...
  public void generateYamlTest() {
    ...
    String s = provisionService.generateYaml("acc", "org", "proj", "id", "repo", "v0", null);
  ...
  public void generateYamlShouldThrowExceptionTest() {
    ...
    provisionService.generateYaml("acc", "org", "proj", "id", "repo", "v1", null);
  }
  ...
  public void updateUrlHarnessCodeTest() {
    ...
    String repo = GitClientHelper.convertToHarnessRepoSlug("acc", "org", "project", "repo") + ".git";
    String cloneUrl = provisionService.updateUrl(autogenInput, repo);
