...
public class AccountEnvironmentsApiImplTest extends CategoryTest {
  @Inject @InjectMocks AccountEnvironmentsApiImpl accountEnvironmentsApi;
  ...
  public void testSearchAccountScopedEnvironmentsFiltered_WithScopeInfo() {
    ScopeInfo scopeInfo =
    ...
    when(scopeInfoService.getScopeInfo(eq(ACCOUNT_ID), eq(null), eq(null))).thenReturn(scopeInfo);
    ...
    when(environmentRbacHelper.hasRequiredPermissionForAllEnvironments(
             eq(ACCOUNT_ID), eq(null), eq(null), eq(ENVIRONMENT_VIEW_PERMISSION)))
        .thenReturn(true);
    ...
    when(scopeInfoService.getScopeInfo(eq(ACCOUNT_ID), any(Set.class)))
        .thenReturn(Collections.singletonMap(ACCOUNT_ID, Optional.of(scopeInfo)));

    Response response = accountEnvironmentsApi.searchAccountScopedEnvironmentsFiltered(
        0, 10, "search", null, null, null, null, null, "filter1", false, "repo1", null, null, ACCOUNT_ID);
    ...
    verify(scopeInfoService, times(1)).getScopeInfo(eq(ACCOUNT_ID), eq(null), eq(null));
  ...
  @Owner(developers = ABOSII)
  @Category(UnitTests.class)
  public void testSearchAccountScopedEnvironmentsFiltered_WithRBACFiltering() {
    ScopeInfo scopeInfo =
        ScopeInfo.builder().accountIdentifier(ACCOUNT_ID).uniqueId(ACCOUNT_ID).scopeType(ScopeLevel.ACCOUNT).build();
    ...
    Response response = accountEnvironmentsApi.searchAccountScopedEnvironmentsFiltered(
        0, 10, null, null, null, null, null, null, null, false, null, null, null, ACCOUNT_ID);
    ...
    verify(environmentRbacHelper, times(1))
        .hasRequiredPermissionForAllEnvironments(eq(ACCOUNT_ID), eq(null), eq(null), eq(ENVIRONMENT_VIEW_PERMISSION));
  ...
  @Owner(developers = ABOSII)
  @Category(UnitTests.class)
  public void testSearchAccountScopedEnvironmentsFiltered_WithAllFilters() {
    ScopeInfo scopeInfo =
        ScopeInfo.builder().accountIdentifier(ACCOUNT_ID).uniqueId(ACCOUNT_ID).scopeType(ScopeLevel.ACCOUNT).build();
    ...
    Response response = accountEnvironmentsApi.searchAccountScopedEnvironmentsFiltered(0, 50, "testSearch",
  ...
  @Owner(developers = ABOSII)
  @Category(UnitTests.class)
  public void testSearchAccountScopedEnvironmentsFiltered_WithPagination() {
    ScopeInfo scopeInfo =
        ScopeInfo.builder().accountIdentifier(ACCOUNT_ID).uniqueId(ACCOUNT_ID).scopeType(ScopeLevel.ACCOUNT).build();
    ...
    Response response = accountEnvironmentsApi.searchAccountScopedEnvironmentsFiltered(
        2, 5, null, null, null, null, null, null, null, false, null, null, null, ACCOUNT_ID);
  ...
  @Owner(developers = ABOSII)
  @Category(UnitTests.class)
  public void testSearchAccountScopedEnvironmentsFiltered_WithIncludeAllAccessibleAtScope() {
    ScopeInfo scopeInfo =
        ScopeInfo.builder().accountIdentifier(ACCOUNT_ID).uniqueId(ACCOUNT_ID).scopeType(ScopeLevel.ACCOUNT).build();
    ...
    Response response = accountEnvironmentsApi.searchAccountScopedEnvironmentsFiltered(
        0, 10, null, null, null, null, null, null, null, true, null, null, null, ACCOUNT_ID);
