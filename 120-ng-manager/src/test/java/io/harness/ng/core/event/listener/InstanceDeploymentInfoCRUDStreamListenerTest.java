...
import io.harness.repositories.instance.InstanceDeploymentInfoV2Repository;
...
public class InstanceDeploymentInfoCRUDStreamListenerTest extends CategoryTest {
  ...
  private InstanceDeploymentInfoV2Repository instanceDeploymentInfoV2Repository;
  ...
  public void setup() {
    ...
    instanceDeploymentInfoV2Repository = mock(InstanceDeploymentInfoV2Repository.class);
    instanceDeploymentInfoCRUDStreamListener = spy(new InstanceDeploymentInfoCRUDStreamListener(
        instanceDeploymentInfoRepository, instanceDeploymentInfoV2Repository));
  }
  ...
  public void testProjectDeleteEvent() {
    ...
    when(instanceDeploymentInfoV2Repository.deleteByScope(scope)).thenReturn(true);
