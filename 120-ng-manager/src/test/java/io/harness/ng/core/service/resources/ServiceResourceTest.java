...
public class ServiceResourceTest extends CategoryTest {
  ...
  private CDOverviewDashboardService cdOverviewDashboardService;
  ...
  public void setUp() {
    ...
    serviceResource = new ServiceResource(serviceEntityService, serviceEntityManagementService,
        cdOverviewDashboardService, scopeInfoService, accessControlClient);
    ...
    serviceEntity = ServiceEntity.builder()
                        ...
                        .version(0L)
                        .build();
    serviceGovernanceDataResponse = ServiceGovernanceDataResponse.builder().service(serviceEntity).build();
  ...
  public void testGet() {
    ...
    ResponseDTO<ServiceResponseDTO> serviceResponseDTOResponseDTO =
        serviceResource.get("IDENTIFIER", "ACCOUNT_ID", "ORG_ID", "PROJECT_ID", false, null);
  ...
  public void testGetForNotFound() {
    doReturn(Optional.empty())
        ...
        .get("ACCOUNT_ID", serviceRequestDTO.getOrgIdentifier(), serviceRequestDTO.getProjectIdentifier(),
            serviceRequestDTO.getIdentifier(), false);
    assertThatThrownBy(() -> serviceResource.get("IDENTIFIER", "ACCOUNT_ID", "ORG_ID", "PROJECT_ID", false, null))
  ...
  public void testCreate() {
    doReturn(serviceGovernanceDataResponse).when(serviceEntityService).create(any(), any());
  ...
  public void testDelete() {
    doReturn(true)
        ...
        .deleteService("ACCOUNT_ID", serviceRequestDTO.getOrgIdentifier(), serviceRequestDTO.getProjectIdentifier(),
            serviceRequestDTO.getIdentifier(), null, false, null);

    Boolean data = serviceResource.delete(null, "IDENTIFIER", "ACCOUNT_ID", "ORG_ID", "PROJECT_ID", null).getData();
  ...
  public void testUpdate() {
    doReturn(serviceGovernanceDataResponse).when(serviceEntityService).update(any(), any());
  ...
  public void testUpsert() {
    doReturn(serviceGovernanceDataResponse).when(serviceEntityService).upsert(any(), eq(UpsertOptions.DEFAULT), any());
    ServiceResponseDTO response =
  ...
  public void testListServicesWithDESCSort() {
    Criteria criteria = CoreCriteriaUtils.createCriteriaForGetList(scopeInfo, false);
    ...
    List<ServiceResponseDTO> content =
        serviceResource.listServicesForProject(0, 10, "ACCOUNT_ID", "ORG_ID", "PROJECT_ID", null, null, scopeInfo)
            .getData()
            .getContent();
  ...
  public void testGetHelmCommandFlagsForHelmServiceSpec() {
    ...
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.NATIVE_HELM, HelmVersion.V2, HTTP).getData())
        .containsExactlyInAnyOrder(
            Template, Delete, Upgrade, Fetch, List, Rollback, Install, History, Version, HelmCommandFlagType.Test);
    ...
    assertThat(
        ...
        .containsExactlyInAnyOrder(
            Template, Delete, Upgrade, List, Rollback, Install, History, Version, HelmCommandFlagType.Test);
    ...
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.NATIVE_HELM, HelmVersion.V3, HTTP).getData())
        .containsExactlyInAnyOrder(Pull, Install, Upgrade, Add, Template, Update, Rollback, History, Uninstall, List,
            Version, HelmCommandFlagType.Test);
    ...
    assertThat(
        ...
        .containsExactlyInAnyOrder(
            Install, Upgrade, Template, Rollback, History, Uninstall, List, Version, HelmCommandFlagType.Test);
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.NATIVE_HELM, HelmVersion.V3, GIT).getData())
        .containsExactlyInAnyOrder(
            History, Install, List, Template, Uninstall, Rollback, Upgrade, Version, HelmCommandFlagType.Test);
  ...
  public void testGetHelmCommandFlagsForK8sServiceSpec() {
    ...
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.KUBERNETES, HelmVersion.V2, HTTP).getData())
        .containsExactlyInAnyOrder(Fetch, Template, Version, HelmCommandFlagType.Test);
    ...
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.KUBERNETES, HelmVersion.V2, CUSTOM_REMOTE).getData())
        .containsExactlyInAnyOrder(Template, Version, HelmCommandFlagType.Test);
    ...
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.KUBERNETES, HelmVersion.V3, HTTP).getData())
        .containsExactlyInAnyOrder(Add, Template, Pull, Update, Version, HelmCommandFlagType.Test);
  ...
  @Category(UnitTests.class)
  public void testHelmCommandFlags() {
    assertThat(serviceResource.getHelmCommandFlags(ServiceSpecType.NATIVE_HELM, null, null).getData())
        .containsExactlyInAnyOrder(HelmCommandFlagType.values());
  }
}
