...
public class BadRequestExceptionMapperTest extends CategoryTest {
  ...
  public void testToResponse() {
    Response response = badRequestExceptionMapper.toResponse(new BadRequestException("error"));
    ...
    assertThat(failureDTO.getMessage()).isEqualTo("BadRequestException: error");
