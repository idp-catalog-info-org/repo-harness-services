...
public class ServiceAccountEventHandlerTest extends CategoryTest {
  ...
  public void testCreate() throws JsonProcessingException {
    ...
    String eventData =
        objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(serviceAccountCreateEvent);
  ...
  public void testUpdate() throws JsonProcessingException {
    ...
    String eventData =
        objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(serviceAccountUpdateEvent);
    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .id(randomAlphabetic(10))
                                  .blocked(false)
  ...
  public void testDelete() throws JsonProcessingException {
    ...
    String eventData =
        objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(serviceAccountDeleteEvent);
