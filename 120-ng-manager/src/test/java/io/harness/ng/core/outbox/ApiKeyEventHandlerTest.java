...
public class ApiKeyEventHandlerTest extends CategoryTest {
  ...
  public void testCreate() throws JsonProcessingException {
    ...
    ApiKeyDTO apiKeyDTO = getApiKeyDTO(accountIdentifier, projectIdentifier, orgIdentifier, identifier, uniqueId);
    ApiKeyCreateEvent apiKeyCreateEvent = new ApiKeyCreateEvent(apiKeyDTO);
    String eventData = objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(apiKeyCreateEvent);
  ...
  public void testUpdate() throws JsonProcessingException {
    ...
    String identifier = randomAlphabetic(10);
    String uniqueId = randomAlphabetic(10);
    ApiKeyDTO oldApiKeyDTO = getApiKeyDTO(accountIdentifier, projectIdentifier, orgIdentifier, identifier, uniqueId);
    ApiKeyDTO newApiKeyDTO = getApiKeyDTO(accountIdentifier, projectIdentifier, orgIdentifier, identifier, uniqueId);
    ApiKeyUpdateEvent apiKeyUpdateEvent = new ApiKeyUpdateEvent(oldApiKeyDTO, newApiKeyDTO);
    String eventData = objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(apiKeyUpdateEvent);
    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .id(randomAlphabetic(10))
                                  .blocked(false)
  ...
  public void testDelete() throws JsonProcessingException {
    ...
    String eventData = objectMapper.writerWithView(JsonViews.Internal.class).writeValueAsString(apiKeyDeleteEvent);
    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .id(randomAlphabetic(10))
                                  .blocked(false)
