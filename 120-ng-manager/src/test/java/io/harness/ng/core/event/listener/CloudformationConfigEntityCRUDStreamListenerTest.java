...
public class CloudformationConfigEntityCRUDStreamListenerTest extends CategoryTest {
  ...
  public void setup() {
    ...
    cloudformationConfigEntityCRUDStreamListener = spy(new CloudformationConfigEntityCRUDStreamListener(
        cloudformationConfigEntityCRUDEventHandler, pmsFeatureFlagHelper));
  }
