...
import static io.harness.ipallowlist.IPAllowlistResourceUtils.toIPAllowlistConfig;
...
public class IPAllowlistConfigEventHandlerTest extends CategoryTest {
  ...
  String UNIQUE_ID = randomAlphabetic(10);
  ...
  public void testHandleIpAllowlistConfigCreateEvent() throws JsonProcessingException {
    ...
    IPAllowlistConfigCreateEvent ipAllowlistConfigCreateEvent =
        new IPAllowlistConfigCreateEvent(ACCOUNT_ID, ipAllowlistConfig, null);
  ...
  @Category(UnitTests.class)
  public void testHandleIpAllowlistConfigCreateEventWithScope() throws JsonProcessingException {
    IPAllowlistConfig ipAllowlistConfig = getIpAllowlistConfig();
    IPAllowlistEntity ipAllowlistEntity = getIPAllowlistEntity();
    IPAllowlistConfigCreateEvent ipAllowlistConfigCreateEvent =
        new IPAllowlistConfigCreateEvent(ACCOUNT_ID, ipAllowlistConfig, ipAllowlistEntity);
    String eventData = objectMapper.writeValueAsString(ipAllowlistConfigCreateEvent);
    GlobalContext globalContext = new GlobalContext();
    SourcePrincipalContextData sourcePrincipalContextData =
        SourcePrincipalContextData.builder()
    ...
    assertEquals(ACCOUNT_ID, ipAllowlistConfigCreateEvent.getResourceScope().getUniqueId());
    assertEquals(UNIQUE_ID, ipAllowlistConfigCreateEvent.getResource().getUniqueId());
    String newYaml =
        getYamlString(IPAllowlistDTO.builder().ipAllowlistConfig(toIPAllowlistConfig(ipAllowlistEntity)).build());
  ...
  public void testUpdate() throws JsonProcessingException {
    ...
    IPAllowlistConfigUpdateEvent ipAllowlistConfigUpdateEvent =
        new IPAllowlistConfigUpdateEvent(ACCOUNT_ID, newIpAllowlistConfig, oldIpAllowlistConfig, null, null);
  ...
  @Owner(developers = ASHISHSANODIA)
  @Category(UnitTests.class)
  public void testUpdateWithScope() throws JsonProcessingException {
    IPAllowlistConfig oldIpAllowlistConfig = getIpAllowlistConfig();
    IPAllowlistConfig newIpAllowlistConfig = getIpAllowlistConfig();
    IPAllowlistEntity newIpAllowlistEntity = getIPAllowlistEntity();
    IPAllowlistEntity oldIpAllowlistEntity = getIPAllowlistEntity();
    newIpAllowlistEntity.setEnabled(false);
    newIpAllowlistEntity.setDescription("Updated Description");
    IPAllowlistConfigUpdateEvent ipAllowlistConfigUpdateEvent = new IPAllowlistConfigUpdateEvent(
        ACCOUNT_ID, newIpAllowlistConfig, oldIpAllowlistConfig, newIpAllowlistEntity, oldIpAllowlistEntity);
    String eventData = objectMapper.writeValueAsString(ipAllowlistConfigUpdateEvent);
    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .id(randomAlphabetic(10))
                                  .blocked(false)
    ...
    assertEquals(ACCOUNT_ID, ipAllowlistConfigUpdateEvent.getResourceScope().getUniqueId());
    assertEquals(UNIQUE_ID, ipAllowlistConfigUpdateEvent.getResource().getUniqueId());

    String oldYaml =
        getYamlString(IPAllowlistDTO.builder().ipAllowlistConfig(toIPAllowlistConfig(oldIpAllowlistEntity)).build());
    String newYaml =
        getYamlString(IPAllowlistDTO.builder().ipAllowlistConfig(toIPAllowlistConfig(newIpAllowlistEntity)).build());
  ...
  public void testDelete() throws JsonProcessingException {
    ...
    IPAllowlistConfigDeleteEvent ipAllowlistConfigDeleteEvent =
        new IPAllowlistConfigDeleteEvent(ACCOUNT_ID, ipAllowlistConfig, null);
  ...
  @Owner(developers = ASHISHSANODIA)
  @Category(UnitTests.class)
  public void testDeleteWithScope() throws JsonProcessingException {
    IPAllowlistConfig ipAllowlistConfig = getIpAllowlistConfig();
    IPAllowlistEntity ipAllowlistEntity = getIPAllowlistEntity();
    IPAllowlistConfigDeleteEvent ipAllowlistConfigDeleteEvent =
        new IPAllowlistConfigDeleteEvent(ACCOUNT_ID, ipAllowlistConfig, ipAllowlistEntity);
    String eventData = objectMapper.writeValueAsString(ipAllowlistConfigDeleteEvent);
    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .id(randomAlphabetic(10))
                                  .blocked(false)
    ...
    assertEquals(ACCOUNT_ID, ipAllowlistConfigDeleteEvent.getResourceScope().getUniqueId());
    assertEquals(UNIQUE_ID, ipAllowlistConfigDeleteEvent.getResource().getUniqueId());
