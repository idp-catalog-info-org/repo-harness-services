...
import io.harness.ng.core.events.ServiceMoveConfigEvent;
...
public class ServiceOutboxEventHandlerTest extends CategoryTest {
  ...
  @Category(UnitTests.class)
  public void testServiceMovedToRemote() throws JsonProcessingException {
    String accountIdentifier = randomAlphabetic(10);
    String orgIdentifier = randomAlphabetic(10);
    String projectIdentifier = randomAlphabetic(10);
    String identifier = randomAlphabetic(10);
    ...
    Scope scope = Scope.builder()
                      ...
                      .projectIdentifier(projectIdentifier)
                      .build();
    ServiceMoveConfigEvent serviceMoveConfigEvent =
        new ServiceMoveConfigEvent(scope, identifier, "test-svc", oldYaml, newYaml);
    String eventData = objectMapper.writeValueAsString(serviceMoveConfigEvent);

    OutboxEvent outboxEvent = OutboxEvent.builder()
                                  .resource(serviceMoveConfigEvent.getResource())
                                  .resourceScope(serviceMoveConfigEvent.getResourceScope())
                                  .eventType(OutboxEventConstants.SERVICE_MOVED_TO_REMOTE)
                                  .blocked(false)
