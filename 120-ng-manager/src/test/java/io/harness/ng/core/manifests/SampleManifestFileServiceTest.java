...
public class SampleManifestFileServiceTest extends CategoryTest {
  ...
  public void setUp() throws Exception {
    ...
    doAnswer(im -> im.getArgument(0)).when(fileStoreService).create(any(FileDTO.class), any(), any(InputStream.class));
  }
  ...
  public void testCreateSampleFiles() {
    ...
    verify(fileStoreService, times(6)).create(captor.capture(), any(), inputStreamCaptor.capture());
