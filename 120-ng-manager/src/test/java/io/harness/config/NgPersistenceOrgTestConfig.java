...
@Configuration
@GuiceModule
@EnableMongoRepositories(basePackages = {"io.harness.repositories.OrganizationRepository"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class), mongoTemplateRef = "primary")

public class NgPersistenceOrgTestConfig extends SpringPersistenceConfig {
  protected final AdvancedDatastore advancedDatastore;

  public NgPersistenceOrgTestConfig(Injector injector, List<Class<? extends Converter<?, ?>>> springConverters) {
