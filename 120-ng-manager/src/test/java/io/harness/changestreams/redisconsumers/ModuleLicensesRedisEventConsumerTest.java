...
public class ModuleLicensesRedisEventConsumerTest extends CategoryTest {
  ...
  private ModuleLicensesRedisEventConsumer consumer;

  @Before
  public void setUp() {
    MockitoAnnotations.openMocks(this);
    consumer =
        new ModuleLicensesRedisEventConsumer(redisConsumer, queueController, eventHandler, eventsCache, cdcKafkaConfig);
  ...
  public void processMessage_redisShortCircuitDisabled_delegatesToParent() {
    ...
    // Parent's processMessage requires a real Message; without it we get NPE.
