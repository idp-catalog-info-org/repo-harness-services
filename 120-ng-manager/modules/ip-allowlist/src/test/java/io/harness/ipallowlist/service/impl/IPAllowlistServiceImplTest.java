...
import static io.harness.rule.OwnerRule.IMRAN_KHAN;
...
public class IPAllowlistServiceImplTest extends CategoryTest {
  ...
  public void testValidateIpAddressAllowlistedOrNot_customBlock() {
    IPAllowlistConfigValidateResponse response = ipAllowlistService.validateIpAddressAllowlistedOrNot(
        "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", ACCOUNT_IDENTIFIER, "2001:db8::/64", false);
  ...
  public void testValidateIpAddressAllowlistedOrNot_ipAllowedFromHarnessUI() {
    ...
    doReturn(List.of(ipAllowlistEntity1))
        ...
        .getAllowedIPConfigs(ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", UI, false);
    doReturn(Collections.emptyList())
        .when(ipAllowlistService)
        .getAllowedIPConfigs(ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", API, false);
    IPAllowlistConfigValidateResponse response = ipAllowlistService.validateIpAddressAllowlistedOrNot(
        "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", ACCOUNT_IDENTIFIER, "", false);
    assertThat(response.isAllowedForApi()).isEqualTo(false);
  ...
  public void testGetAllowedIpConfigs_UI() {
    ...
    List<IPAllowlistEntity> response = ipAllowlistService.getAllowedIPConfigs(
        ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", UI, false);
    assertThat(response.size()).isEqualTo(1);
    assertThat(response.get(0).getIpAddress()).isEqualTo(ipAllowlistEntity1.getIpAddress());
  }

  @Test
  @Owner(developers = IMRAN_KHAN)
  @Category(UnitTests.class)
  public void testGetAllIpConfigs_UI() {
    Pageable pageable1 = PageRequest.of(0, 1000);
    Pageable pageable2 = PageRequest.of(1, 1000);
    IPAllowlistEntity ipAllowlistEntity1 = getIPAllowlistEntity();
    IPAllowlistEntity ipAllowlistEntity2 = getIPAllowlistEntity();
    ...
    List<IPAllowlistEntity> response =
        ipAllowlistService.getAllowedIPConfigs(ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", UI, true);
    assertThat(response.size()).isEqualTo(1);
    assertThat(response.get(0).getIpAddress()).isEqualTo(ipAllowlistEntity1.getIpAddress());
  }
  ...
  public void testGetAllowedIpConfigs_API() {
    ...
    List<IPAllowlistEntity> response = ipAllowlistService.getAllowedIPConfigs(
        ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", API, false);
  ...
  @Owner(developers = IMRAN_KHAN)
  @Category(UnitTests.class)
  public void testGetAllIpConfigs_API() {
    Pageable pageable1 = PageRequest.of(0, 1000);
    Pageable pageable2 = PageRequest.of(1, 1000);
    IPAllowlistEntity ipAllowlistEntity1 = getIPAllowlistEntity();
    IPAllowlistEntity ipAllowlistEntity2 = getIPAllowlistEntity();
    ...
    List<IPAllowlistEntity> response = ipAllowlistService.getAllowedIPConfigs(
        ACCOUNT_IDENTIFIER, "2001:0db8:0000:0000:ffff:ffff:ffff:ffff", API, true);
    assertThat(response.size()).isEqualTo(0);
  }
