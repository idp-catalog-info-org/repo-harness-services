...
package io.harness.ng.core.config;
...
@Configuration
@GuiceModule
@EnableMongoRepositories(basePackages = {"io.harness.repositories.variable"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class), mongoTemplateRef = "primary")
public class NgVariablePersistenceTestConfig extends SpringPersistenceConfig {
  protected final AdvancedDatastore advancedDatastore;

  public NgVariablePersistenceTestConfig(Injector injector, List<Class<? extends Converter<?, ?>>> springConverters) {
