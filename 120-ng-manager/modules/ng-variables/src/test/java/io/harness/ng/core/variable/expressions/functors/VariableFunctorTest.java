...
public class VariableFunctorTest extends CategoryTest {
  ...
  @Captor public ArgumentCaptor<ScopeInfo> scopeInfoCaptor;
  ...
  public void testGet_getVariableValueMapAccount() {
    ...
    String uniqueId = randomAlphabetic(5);
    ...
    verify(variableService, times(1)).list(scopeInfoCaptor.capture());
    assertThat(scopeInfoCaptor.getValue().getAccountIdentifier()).isEqualTo(accountIdentifier);
    assertThat(scopeInfoCaptor.getValue().getOrgIdentifier()).isNull();
    assertThat(scopeInfoCaptor.getValue().getProjectIdentifier()).isNull();
  ...
  public void testGet_getVariableValueMapOrg() {
    ...
    verify(variableService, times(1)).list(scopeInfoCaptor.capture());
    assertThat(scopeInfoCaptor.getValue().getAccountIdentifier()).isEqualTo(accountIdentifier);
    assertThat(scopeInfoCaptor.getValue().getOrgIdentifier()).isEqualTo(orgIdentifier);
    assertThat(scopeInfoCaptor.getValue().getProjectIdentifier()).isNull();
    Map<String, Object> expectedMap = new HashMap<>();
    expectedMap.put(variableIdentifier, fixedValue);
    assertThat(variableMap).isEqualTo(expectedMap);
  ...
  public void testGet_getVariableValueAccount() {
    ...
    verify(variableService, times(1)).get(scopeInfoCaptor.capture(), variableIdentifierCaptor.capture());
    assertThat(variableIdentifierCaptor.getValue()).isEqualTo(variableIdentifier);
    assertThat(scopeInfoCaptor.getValue()).isNotNull();
    assertThat(scopeInfoCaptor.getValue().getAccountIdentifier()).isEqualTo(accountIdentifier);
    assertThat(scopeInfoCaptor.getValue().getOrgIdentifier()).isNull();
    assertThat(scopeInfoCaptor.getValue().getProjectIdentifier()).isNull();
  ...
  public void testGet_getVariableValueProject() {
    ...
    assertThat(scopeInfoCaptor.getValue().getAccountIdentifier()).isEqualTo(accountIdentifier);
    assertThat(scopeInfoCaptor.getValue().getOrgIdentifier()).isEqualTo(orgIdentifier);
    assertThat(scopeInfoCaptor.getValue().getProjectIdentifier()).isEqualTo(projectIdentifier);
    assertThat(variableValue).isEqualTo(fixedValue);
  }
