...
public class VariableUpdateEvent implements Event {
  ...
  public ResourceScope getResourceScope() {
    return ResourceScopeMapper.getResourceScope(
        Scope.of(accountIdentifier, newVariableDTO.getOrgIdentifier(), newVariableDTO.getProjectIdentifier()),
        newVariableDTO.getParentUniqueId());
  }
  ...
  public Resource getResource() {
    ...
    return Resource.builder()
        .identifier(newVariableDTO.getIdentifier())
        .uniqueId(newVariableDTO.getUniqueId())
        .type(VARIABLE)
        .labels(labels)
        .build();
  }
