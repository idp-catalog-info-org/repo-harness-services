...
public class VariableDTO {
  ...
  @Schema(hidden = true, description = "parentUniqueId of Project")
  String parentUniqueId;
  @Schema(description = "GovernanceMetadata for OPA") GovernanceMetadata governanceMetadata;

  @Builder
  public VariableDTO(String identifier, String name, String description, String orgIdentifier, String projectIdentifier,
      VariableType type, VariableConfigDTO variableConfig, String uniqueId, String parentUniqueId) {
