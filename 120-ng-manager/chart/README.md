...
| global.issuerURL | string | `""` | Canonical host for string-matched trust anchors (OIDC issuer/iss/jwks_uri and SCM OAuth redirect_uri callbacks). Falls back to loadbalancerURL when empty. Keep stable across cell-local host migrations. |
